...
public class F1502 : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F1502";
    ...
    {
        new JdeIndex("F1502_0", "Primary Key on NFDOCO, NFLNID", new[] { "NFDOCO", "NFLNID" }, isUnique: true, isPrimaryKey: true)
    };
}
