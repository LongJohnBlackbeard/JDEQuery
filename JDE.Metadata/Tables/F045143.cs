...
public class F045143 : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F045143";
    ...
    {
        new JdeIndex("F045143_0", "Primary Key on G1AN8, G1CO, G1TOR, G1ST", new[] { "G1AN8", "G1CO", "G1TOR", "G1ST" }, isUnique: true, isPrimaryKey: true)
    };
}
