...
public class F3112 : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F3112";
    ...
    {
        new JdeIndex("F3112_0", "Primary Key on WLDOCO, WLOPSQ, WLOPSC, WLMCU", new[] { "WLDOCO", "WLOPSQ", "WLOPSC", "WLMCU" }, isUnique: true, isPrimaryKey: true),
        new JdeIndex("F3112_10", "Index on WLPID", new[] { "WLPID" }),
        new JdeIndex("F3112_11", "Index on WLDOCO, SYS_NC00111$", new[] { "WLDOCO", "SYS_NC00111$" }),
        new JdeIndex("F3112_12", "Index on WLURCD, WLDRQJ, WLDOCO, WLOPSQ", new[] { "WLURCD", "WLDRQJ", "WLDOCO", "WLOPSQ" }),
        new JdeIndex("F3112_13", "Index on WLOPST", new[] { "WLOPST" }),
        new JdeIndex("F3112_14", "Index on WLMMCU, WLOPST, WLMCU, WLDCTO, WLDOCO, WLOPSQ", new[] { "WLMMCU", "WLOPST", "WLMCU", "WLDCTO", "WLDOCO", "WLOPSQ" }),
        new JdeIndex("F3112_2", "Index on WLMCU, WLSTRT, WLOPSQ, WLDOCO", new[] { "WLMCU", "WLSTRT", "WLOPSQ", "WLDOCO" }),
        new JdeIndex("F3112_3", "Index on WLMCU, WLDRQJ", new[] { "WLMCU", "WLDRQJ" }),
        new JdeIndex("F3112_4", "Index on WLMMCU, WLMCU, WLWMCU, WLOPSC, WLDOCO", new[] { "WLMMCU", "WLMCU", "WLWMCU", "WLOPSC", "WLDOCO" }),
        new JdeIndex("F3112_5", "Index on WLAN8, WLSTRT, WLDOCO, WLOPSQ", new[] { "WLAN8", "WLSTRT", "WLDOCO", "WLOPSQ" }),
        new JdeIndex("F3112_6", "Index on WLMMCU, WLKIT, WLDOCO, WLOPSQ", new[] { "WLMMCU", "WLKIT", "WLDOCO", "WLOPSQ" }),
        new JdeIndex("F3112_7", "Index on WLDOCO, WLOPSQ, WLOPSC", new[] { "WLDOCO", "WLOPSQ", "WLOPSC" }),
        new JdeIndex("F3112_8", "Index on WLDOCO, WLNXOP", new[] { "WLDOCO", "WLNXOP" }),
        new JdeIndex("F3112_9", "Index on WLDOCO, WLOPSQ", new[] { "WLDOCO", "WLOPSQ" })
    };
}
