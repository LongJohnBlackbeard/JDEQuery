...
/// F31B52Z1 - .
/// </summary>
public class F31B52Z1 : JdeTable
{
    /// <summary>
    ...
    public static class Columns
    {
        ...
        /// SZEQPNUM.
        /// </summary>
        public const string SZEQPNUM = "SZEQPNUM";

        /// <summary>
        /// SZPARTEXT.
        /// </summary>
        public const string SZPARTEXT = "SZPARTEXT";
        ...
        /// SZWACTIME.
        /// </summary>
        public const string SZWACTIME = "SZWACTIME";

        /// <summary>
        /// SZWTUOM.
        /// </summary>
        public const string SZWTUOM = "SZWTUOM";
    }

    /// <inheritdoc />
    public override string TableName => "F31B52Z1";
    ...
    public override IReadOnlyList<IJdeField> Fields { get; } = new List<IJdeField>
    {
        ...
        new JdeField("SZEQPNUM", "SZEQPNUM", JdeDataType.String, 40),
        new JdeField("SZPARTEXT", "SZPARTEXT", JdeDataType.String, 40),
        ...
        new JdeField("SZWACTIME", "SZWACTIME", JdeDataType.Numeric),
        new JdeField("SZWTUOM", "SZWTUOM", JdeDataType.String, 4)
    };

    /// <inheritdoc />
    public override IReadOnlyList<IJdeIndex> Indexes { get; } = new List<IJdeIndex>
    {
        new JdeIndex("F31B52Z1_0", "Primary Key on SZEDUS, SZEDBT, SZEDTN, SZEDLN", new[] { "SZEDUS", "SZEDBT", "SZEDTN", "SZEDLN" }, isUnique: true, isPrimaryKey: true),
        new JdeIndex("F31B52Z1_11", "Index on SZEDUS, SZEDBT, SZEDTN", new[] { "SZEDUS", "SZEDBT", "SZEDTN" }),
        new JdeIndex("F31B52Z1_13", "Index on SZEDBT, SZEDTN, SZWAPRN, SZEQPNUM", new[] { "SZEDBT", "SZEDTN", "SZWAPRN", "SZEQPNUM" }),
        new JdeIndex("F31B52Z1_14", "Index on SZEDUS, SZEDBT, SZEDTN, SYS_NC00032$", new[] { "SZEDUS", "SZEDBT", "SZEDTN", "SYS_NC00032$" }),
        new JdeIndex("F31B52Z1_15", "Index on SZWAPRN", new[] { "SZWAPRN" }),
        new JdeIndex("F31B52Z1_8", "Index on SZEDUS, SZEDBT, SZEDTN, SZEDSP", new[] { "SZEDUS", "SZEDBT", "SZEDTN", "SZEDSP" }),
        new JdeIndex("F31B52Z1_9", "Index on SZEDUS, SZEDBT, SZEDSP", new[] { "SZEDUS", "SZEDBT", "SZEDSP" })
    };
}
