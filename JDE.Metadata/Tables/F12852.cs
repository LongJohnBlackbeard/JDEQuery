...
public class F12852 : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F12852";
    ...
    {
        new JdeIndex("F12852_0", "Primary Key on LVADM, LVADLM, LVITAC, LVDIR1, LVDTFR, LVEFTB, LVLYFR, LVPISP, LVSPCN", new[] { "LVADM", "LVADLM", "LVITAC", "LVDIR1", "LVDTFR", "LVEFTB", "LVLYFR", "LVPISP", "LVSPCN" }, isUnique: true, isPrimaryKey: true),
        new JdeIndex("F12852_2", "Index on SYS_NC00024$, LVLYTO, SYS_NC00025$, LVSPCN", new[] { "SYS_NC00024$", "LVLYTO", "SYS_NC00025$", "LVSPCN" })
    };
}
