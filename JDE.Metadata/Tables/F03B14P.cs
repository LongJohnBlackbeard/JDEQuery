...
public class F03B14P : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F03B14P";
    ...
    {
        new JdeIndex("F03B14P_0", "Primary Key on RZPYID, RZRC5", new[] { "RZPYID", "RZRC5" }, isUnique: true, isPrimaryKey: true)
    };
}
