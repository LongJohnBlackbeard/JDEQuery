...
public class F078345 : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F078345";
    ...
    {
        new JdeIndex("F078345_0", "Primary Key on YFUKID", new[] { "YFUKID" }, isUnique: true, isPrimaryKey: true)
    };
}
