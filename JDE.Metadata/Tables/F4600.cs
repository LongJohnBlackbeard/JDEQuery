...
public class F4600 : JdeTable
{
    ...
    public static class Columns
    {
        ...
        /// R1LPNUF.
        /// </summary>
        public const string R1LPNUF = "R1LPNUF";
        ...
        /// R1LPNUT.
        /// </summary>
        public const string R1LPNUT = "R1LPNUT";
        ...
        /// R1VR03.
        /// </summary>
        public const string R1VR03 = "R1VR03";
        ...
        /// R1SBCK.
        /// </summary>
        public const string R1SBCK = "R1SBCK";

        /// <summary>
        /// R1EDCK.
        /// </summary>
        public const string R1EDCK = "R1EDCK";

        /// <summary>
        /// R1CMDM.
        /// </summary>
        public const string R1CMDM = "R1CMDM";

        /// <summary>
        /// R1BBCK.
        /// </summary>
        public const string R1BBCK = "R1BBCK";
    ...
    /// <inheritdoc />
    public override string TableName => "F4600";
    ...
    public override IReadOnlyList<IJdeField> Fields { get; } = new List<IJdeField>
    {
        ...
        new JdeField("R1LPNUF", "R1LPNUF", JdeDataType.String, 80),
        ...
        new JdeField("R1LPNUT", "R1LPNUT", JdeDataType.String, 80),
        ...
        new JdeField("R1VR03", "R1VR03", JdeDataType.String, 50),
        ...
        new JdeField("R1SBCK", "R1SBCK", JdeDataType.String, 2),
        new JdeField("R1EDCK", "R1EDCK", JdeDataType.String, 2),
        new JdeField("R1CMDM", "R1CMDM", JdeDataType.String, 2),
        new JdeField("R1BBCK", "R1BBCK", JdeDataType.String, 2),
    ...
    {
        new JdeIndex("F4600_0", "Primary Key on R1RQBT, R1RQSQ", new[] { "R1RQBT", "R1RQSQ" }, isUnique: true, isPrimaryKey: true),
        new JdeIndex("F4600_10", "Index on R1TYFL, R1PSTB, R1RQBT, R1RQSQ", new[] { "R1TYFL", "R1PSTB", "R1RQBT", "R1RQSQ" }),
        new JdeIndex("F4600_12", "Index on R1TYFL, R1OCDE, R1MCU, R1ITM, R1FLOC, R1FLOT, R1PSTB, R1DOCO", new[] { "R1TYFL", "R1OCDE", "R1MCU", "R1ITM", "R1FLOC", "R1FLOT", "R1PSTB", "R1DOCO" }),
        new JdeIndex("F4600_13", "Index on R1MCU, R1ITM, R1FLOC, R1FLOT", new[] { "R1MCU", "R1ITM", "R1FLOC", "R1FLOT" }),
        new JdeIndex("F4600_14", "Index on R1MCU, R1ITM, R1TLOC, R1TLOT", new[] { "R1MCU", "R1ITM", "R1TLOC", "R1TLOT" }),
        new JdeIndex("F4600_15", "Index on R1STNF", new[] { "R1STNF" }),
        new JdeIndex("F4600_16", "Index on R1LPNUF", new[] { "R1LPNUF" }),
        new JdeIndex("F4600_17", "Index on R1LPNUF, R1MCU, R1PSTB", new[] { "R1LPNUF", "R1MCU", "R1PSTB" }),
        new JdeIndex("F4600_2", "Index on R1DOCO, R1DCTO, R1KCOO, R1LNID, R1NLIN", new[] { "R1DOCO", "R1DCTO", "R1KCOO", "R1LNID", "R1NLIN" }),
        new JdeIndex("F4600_3", "Index on R1DOCO, R1DCTO, R1KCOO, R1LNID, R1PSTB", new[] { "R1DOCO", "R1DCTO", "R1KCOO", "R1LNID", "R1PSTB" }),
        new JdeIndex("F4600_5", "Index on R1TYFL, R1MCU, R1RQBT, R1RQSQ", new[] { "R1TYFL", "R1MCU", "R1RQBT", "R1RQSQ" }),
        new JdeIndex("F4600_6", "Index on R1TYFL, R1MCU, R1PSTB, R1RQBT, R1RQSQ", new[] { "R1TYFL", "R1MCU", "R1PSTB", "R1RQBT", "R1RQSQ" }),
        new JdeIndex("F4600_7", "Index on R1TYFL, R1ITM, R1PSTB, R1RQBT, R1RQSQ", new[] { "R1TYFL", "R1ITM", "R1PSTB", "R1RQBT", "R1RQSQ" }),
        new JdeIndex("F4600_8", "Index on R1TYFL, R1RQBT, R1RQSQ", new[] { "R1TYFL", "R1RQBT", "R1RQSQ" }),
        new JdeIndex("F4600_9", "Index on R1RQSQ, R1TYFL, R1ITM, R1RQBT", new[] { "R1RQSQ", "R1TYFL", "R1ITM", "R1RQBT" })
    };
}
