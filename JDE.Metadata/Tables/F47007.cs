...
public class F47007 : JdeTable
{
    ...
    public static class Columns
    {
        ...
        /// DTFILE.
        /// </summary>
        public const string DTFILE = "DTFILE";
    ...
    /// <inheritdoc />
    public override string TableName => "F47007";
    ...
    public override IReadOnlyList<IJdeField> Fields { get; } = new List<IJdeField>
    {
        ...
        new JdeField("DTFILE", "DTFILE", JdeDataType.String, 20, true, true),
    ...
    {
        new JdeIndex("F47007_0", "Primary Key on DTFILE, DTEDOC, DTEDCT, DTEKCO, DTEDLN", new[] { "DTFILE", "DTEDOC", "DTEDCT", "DTEKCO", "DTEDLN" }, isUnique: true, isPrimaryKey: true)
    };
}
