...
/// F70XMLZ2 - .
/// </summary>
public class F70XMLZ2 : JdeTable
{
    /// <summary>
    ...
    /// <inheritdoc />
    public override string TableName => "F70XMLZ2";
    ...
    {
        new JdeIndex("F70XMLZ2_0", "Primary Key on SYEDUS, SYEDBT, SYEDTN, SYEDLN", new[] { "SYEDUS", "SYEDBT", "SYEDTN", "SYEDLN" }, isUnique: true, isPrimaryKey: true)
    };
}
