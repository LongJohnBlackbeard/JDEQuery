...
/// F31B31Z1 - .
/// </summary>
public class F31B31Z1 : JdeTable
{
    /// <summary>
    ...
    public static class Columns
    {
        ...
        /// SZPERCT.
        /// </summary>
        public const string SZPERCT = "SZPERCT";
        ...
        /// SZVARCODE.
        /// </summary>
        public const string SZVARCODE = "SZVARCODE";

        /// <summary>
        /// SZAPPLLAT.
        /// </summary>
        public const string SZAPPLLAT = "SZAPPLLAT";

        /// <summary>
        /// SZWGRAR.
        /// </summary>
        public const string SZWGRAR = "SZWGRAR";

        /// <summary>
        /// SZSRCEID.
        /// </summary>
        public const string SZSRCEID = "SZSRCEID";

        /// <summary>
        /// SZSRCETYPE.
        /// </summary>
        public const string SZSRCETYPE = "SZSRCETYPE";

        /// <summary>
        /// SZCMATYPE.
        /// </summary>
        public const string SZCMATYPE = "SZCMATYPE";
    ...
    /// <inheritdoc />
    public override string TableName => "F31B31Z1";
    ...
    public override IReadOnlyList<IJdeField> Fields { get; } = new List<IJdeField>
    {
        ...
        new JdeField("SZPERCT", "SZPERCT", JdeDataType.Numeric),
        new JdeField("SZVINTAG", "SZVINTAG", JdeDataType.Numeric),
        new JdeField("SZVARCODE", "SZVARCODE", JdeDataType.String, 10),
        new JdeField("SZAPPLLAT", "SZAPPLLAT", JdeDataType.String, 16),
        new JdeField("SZWGRAR", "SZWGRAR", JdeDataType.String, 60),
        new JdeField("SZSRCEID", "SZSRCEID", JdeDataType.Numeric),
        new JdeField("SZSRCETYPE", "SZSRCETYPE", JdeDataType.String, 6),
        new JdeField("SZCMATYPE", "SZCMATYPE", JdeDataType.String, 8),
    ...
    {
        new JdeIndex("F31B31Z1_0", "Primary Key on SZEDUS, SZEDBT, SZEDTN, SZEDLN", new[] { "SZEDUS", "SZEDBT", "SZEDTN", "SZEDLN" }, isUnique: true, isPrimaryKey: true),
        new JdeIndex("F31B31Z1_11", "Index on SZEDUS, SZEDBT, SZEDTN", new[] { "SZEDUS", "SZEDBT", "SZEDTN" }),
        new JdeIndex("F31B31Z1_13", "Index on SZEDBT, SZEDTN, SZWAPRN", new[] { "SZEDBT", "SZEDTN", "SZWAPRN" }),
        new JdeIndex("F31B31Z1_14", "Index on SZEDUS, SZEDBT, SZEDTN, SYS_NC00037$", new[] { "SZEDUS", "SZEDBT", "SZEDTN", "SYS_NC00037$" }),
        new JdeIndex("F31B31Z1_15", "Index on SZWAPRN", new[] { "SZWAPRN" }),
        new JdeIndex("F31B31Z1_8", "Index on SZEDUS, SZEDBT, SZEDTN, SZEDSP", new[] { "SZEDUS", "SZEDBT", "SZEDTN", "SZEDSP" }),
        new JdeIndex("F31B31Z1_9", "Index on SZEDUS, SZEDBT, SZEDSP", new[] { "SZEDUS", "SZEDBT", "SZEDSP" })
    };
}
