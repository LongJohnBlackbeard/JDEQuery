...
public class F75I847 : JdeTable
{
    ...
    public static class Columns
    {
        ...
        /// NNI75INVSR.
        /// </summary>
        public const string NNI75INVSR = "NNI75INVSR";
    ...
    /// <inheritdoc />
    public override string TableName => "F75I847";
    ...
    public override IReadOnlyList<IJdeField> Fields { get; } = new List<IJdeField>
    {
        ...
        new JdeField("NNI75INVSR", "NNI75INVSR", JdeDataType.String, 20),
    ...
    {
        new JdeIndex("F75I847_0", "Primary Key on NNK74LECO, NNI75GSTU, NNDCT, NNI75NNED", new[] { "NNK74LECO", "NNI75GSTU", "NNDCT", "NNI75NNED" }, isUnique: true, isPrimaryKey: true)
    };
}
