...
public class F49T219 : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F49T219";
    ...
    {
        new JdeIndex("F49T219_0", "Primary Key on TPDOCO, TPDCTO, TPKCOO, TPLNID", new[] { "TPDOCO", "TPDCTO", "TPKCOO", "TPLNID" }, isUnique: true, isPrimaryKey: true),
        new JdeIndex("F49T219_2", "Index on TPOTORDRLS", new[] { "TPOTORDRLS" }),
        new JdeIndex("F49T219_3", "Index on TPDOCO, TPDCTO, TPKCOO", new[] { "TPDOCO", "TPDCTO", "TPKCOO" }),
        new JdeIndex("F49T219_4", "Index on TPOTORDRLN", new[] { "TPOTORDRLN" }),
        new JdeIndex("F49T219_5", "Index on TPOTDOMAIN, TPOTBSHPN", new[] { "TPOTDOMAIN", "TPOTBSHPN" }),
        new JdeIndex("F49T219_6", "Index on TPOTBSHPN, TPOTDOMAIN, TPOTSTATE", new[] { "TPOTBSHPN", "TPOTDOMAIN", "TPOTSTATE" }),
        new JdeIndex("F49T219_7", "Index on TPOTBSHPN, TPOTORDRLS, TPOTORDRLN", new[] { "TPOTBSHPN", "TPOTORDRLS", "TPOTORDRLN" })
    };
}
