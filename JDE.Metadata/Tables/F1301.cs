...
public class F1301 : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F1301";
    ...
    {
        new JdeIndex("F1301_0", "Primary Key on FGRTTB, FGRTGR, FGNUMB, FGEFTB, FGERC", new[] { "FGRTTB", "FGRTGR", "FGNUMB", "FGEFTB", "FGERC" }, isUnique: true, isPrimaryKey: true),
        new JdeIndex("F1301_2", "Index on FGERC, FGNUMB", new[] { "FGERC", "FGNUMB" }),
        new JdeIndex("F1301_3", "Index on FGNUMB", new[] { "FGNUMB" }),
        new JdeIndex("F1301_4", "Index on FGRTGR", new[] { "FGRTGR" }),
        new JdeIndex("F1301_5", "Index on FGRTTB, FGRTGR, FGNUMB", new[] { "FGRTTB", "FGRTGR", "FGNUMB" })
    };
}
