...
/// F76H3B40 - .
/// </summary>
public class F76H3B40 : JdeTable
{
    /// <summary>
    ...
    /// <inheritdoc />
    public override string TableName => "F76H3B40";
    ...
    {
        new JdeIndex("F76H3B40_0", "Primary Key on PIKCO, PIDCT, PIDOC, PISEQ", new[] { "PIKCO", "PIDCT", "PIDOC", "PISEQ" }, isUnique: true, isPrimaryKey: true)
    };
}
