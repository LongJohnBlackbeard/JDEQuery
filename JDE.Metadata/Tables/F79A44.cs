...
public class F79A44 : JdeTable
{
    ...
    public static class Columns
    {
        ...
        /// KLACTN.
        /// </summary>
        public const string KLACTN = "KLACTN";
    ...
    /// <inheritdoc />
    public override string TableName => "F79A44";
    ...
    public override IReadOnlyList<IJdeField> Fields { get; } = new List<IJdeField>
    {
        ...
        new JdeField("KLACTN", "KLACTN", JdeDataType.String, 2, true, true),
        ...
        new JdeField("KLUPMJ", "KLUPMJ", JdeDataType.Numeric, null, true, true),
        new JdeField("KLTDAY", "KLTDAY", JdeDataType.Numeric, null, true, true)
    };

    /// <inheritdoc />
    public override IReadOnlyList<IJdeIndex> Indexes { get; } = new List<IJdeIndex>
    {
        new JdeIndex("F79A44_0", "Primary Key on KL79AGKLID, KLUPMJ, KLTDAY, KLACTN", new[] { "KL79AGKLID", "KLUPMJ", "KLTDAY", "KLACTN" }, isUnique: true, isPrimaryKey: true),
        new JdeIndex("F79A44_2", "Index on KL79AGKPID, KL79AKLTY, KLUPMJ, KLTDAY, KLACTN", new[] { "KL79AGKPID", "KL79AKLTY", "KLUPMJ", "KLTDAY", "KLACTN" })
    };
}
