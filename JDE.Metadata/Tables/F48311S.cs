...
public class F48311S : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F48311S";
    ...
    {
        new JdeIndex("F48311S_0", "Primary Key on RATSKID", new[] { "RATSKID" }, isUnique: true, isPrimaryKey: true),
        new JdeIndex("F48311S_2", "Index on RARRTY, RARSCN, RADOCO, RAOPSQ, RAOPSC, RAMCU", new[] { "RARRTY", "RARSCN", "RADOCO", "RAOPSQ", "RAOPSC", "RAMCU" }),
        new JdeIndex("F48311S_3", "Index on RADOCO, RAOPSQ, RAOPSC, RAMCU", new[] { "RADOCO", "RAOPSQ", "RAOPSC", "RAMCU" }),
        new JdeIndex("F48311S_4", "Index on RARRTY, RARSCN, RAIAVL, RASESD, RASCHSTTIME, RASEED", new[] { "RARRTY", "RARSCN", "RAIAVL", "RASESD", "RASCHSTTIME", "RASEED" }),
        new JdeIndex("F48311S_5", "Index on RAPRJM, RADOCO, RAOPSQ, RAOPSC, RAMCU", new[] { "RAPRJM", "RADOCO", "RAOPSQ", "RAOPSC", "RAMCU" })
    };
}
