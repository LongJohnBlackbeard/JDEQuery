...
/// F76A7101 - .
/// </summary>
public class F76A7101 : JdeTable
{
    /// <summary>
    ...
    /// <inheritdoc />
    public override string TableName => "F76A7101";
    ...
    {
        new JdeIndex("F76A7101_0", "Primary Key on TAGPBT, TAGPTN", new[] { "TAGPBT", "TAGPTN" }, isUnique: true, isPrimaryKey: true)
    };
}
