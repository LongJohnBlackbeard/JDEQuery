...
public class F078305 : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F078305";
    ...
    {
        new JdeIndex("F078305_0", "Primary Key on YWUKID", new[] { "YWUKID" }, isUnique: true, isPrimaryKey: true)
    };
}
