...
public class F07440 : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F07440";
    ...
    {
        new JdeIndex("F07440_0", "Primary Key on NHUKID", new[] { "NHUKID" }, isUnique: true, isPrimaryKey: true)
    };
}
