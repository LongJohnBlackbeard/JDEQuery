...
public class F80D322 : JdeTable
{
    ...
    public static class Columns
    {
        ...
        /// MDMGRP.
        /// </summary>
        public const string MDMGRP = "MDMGRP";

        /// <summary>
        /// MDSEQ.
        /// </summary>
        public const string MDSEQ = "MDSEQ";
        ...
        /// MDVCID.
        /// </summary>
        public const string MDVCID = "MDVCID";
    ...
    /// <inheritdoc />
    public override string TableName => "F80D322";
    ...
    {
        new JdeField("MDMGRP", "MDMGRP", JdeDataType.String, 10, true, true),
        new JdeField("MDSEQ", "MDSEQ", JdeDataType.Numeric, null, true, true),
        new JdeField("MDMETRIC", "MDMETRIC", JdeDataType.Numeric),
        new JdeField("MDVCID", "MDVCID", JdeDataType.Numeric),
    ...
    {
        new JdeIndex("F80D322_0", "Primary Key on MDMGRP, MDSEQ", new[] { "MDMGRP", "MDSEQ" }, isUnique: true, isPrimaryKey: true)
    };
}
