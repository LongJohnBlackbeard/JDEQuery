...
public class F49211 : JdeTable
{
    ...
    public static class Columns
    {
        ...
        /// UDOPMG.
        /// </summary>
        public const string UDOPMG = "UDOPMG";

        /// <summary>
        /// UDOPSG.
        /// </summary>
        public const string UDOPSG = "UDOPSG";

        /// <summary>
        /// UDOPYN.
        /// </summary>
        public const string UDOPYN = "UDOPYN";

        /// <summary>
        /// UDOPSU.
        /// </summary>
        public const string UDOPSU = "UDOPSU";

        /// <summary>
        /// UDPSJOBNO.
        /// </summary>
        public const string UDPSJOBNO = "UDPSJOBNO";

        /// <summary>
        /// UDJOBSQ.
        /// </summary>
        public const string UDJOBSQ = "UDJOBSQ";

        /// <summary>
        /// UDCARDNO.
        /// </summary>
        public const string UDCARDNO = "UDCARDNO";

        /// <summary>
        /// UDDELBATCH.
        /// </summary>
        public const string UDDELBATCH = "UDDELBATCH";
    }

    /// <inheritdoc />
    public override string TableName => "F49211";
    ...
    public override IReadOnlyList<IJdeField> Fields { get; } = new List<IJdeField>
    {
        ...
        new JdeField("UDUPMJ", "UDUPMJ", JdeDataType.Numeric),
        new JdeField("UDTDAY", "UDTDAY", JdeDataType.Numeric),
        ...
        new JdeField("UDOPMG", "UDOPMG", JdeDataType.String, 60),
        new JdeField("UDOPSG", "UDOPSG", JdeDataType.String, 60),
        new JdeField("UDOPYN", "UDOPYN", JdeDataType.String, 2),
        new JdeField("UDOPSU", "UDOPSU", JdeDataType.String, 2),
        new JdeField("UDPSJOBNO", "UDPSJOBNO", JdeDataType.String, 30),
        new JdeField("UDJOBSQ", "UDJOBSQ", JdeDataType.String, 30),
        new JdeField("UDCARDNO", "UDCARDNO", JdeDataType.String, 8),
        new JdeField("UDDELBATCH", "UDDELBATCH", JdeDataType.String, 12)
    };

    /// <inheritdoc />
    public override IReadOnlyList<IJdeIndex> Indexes { get; } = new List<IJdeIndex>
    {
        new JdeIndex("F49211_0", "Primary Key on UDDOCO, UDDCTO, UDKCOO, UDLNID", new[] { "UDDOCO", "UDDCTO", "UDKCOO", "UDLNID" }, isUnique: true, isPrimaryKey: true),
        new JdeIndex("F49211_2", "Index on UDPTNR", new[] { "UDPTNR" }),
        new JdeIndex("F49211_3", "Index on UDDCTO", new[] { "UDDCTO" }),
        new JdeIndex("F49211_4", "Index on UDKCOO", new[] { "UDKCOO" })
    };
}
