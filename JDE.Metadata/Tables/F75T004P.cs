...
/// F75T004P - .
/// </summary>
public class F75T004P : JdeTable
{
    /// <summary>
    ...
    /// <inheritdoc />
    public override string TableName => "F75T004P";
    ...
    {
        new JdeIndex("F75T004P_0", "Primary Key on TH75TTNF, TH75TRAS, TH75TVTT, TH75TYMH", new[] { "TH75TTNF", "TH75TRAS", "TH75TVTT", "TH75TYMH" }, isUnique: true, isPrimaryKey: true)
    };
}
