...
/// FY5AHX04 - .
/// </summary>
public class FY5AHX04 : JdeTable
{
    /// <summary>
    ...
    /// <inheritdoc />
    public override string TableName => "FY5AHX04";
    ...
    {
        new JdeIndex("FY5AHX04_0", "Primary Key on DIMNI, DISELN, DIPTHT", new[] { "DIMNI", "DISELN", "DIPTHT" }, isUnique: true, isPrimaryKey: true),
        new JdeIndex("FY5AHX04_2", "Index on DIMNI, DIPTHT, DISELN", new[] { "DIMNI", "DIPTHT", "DISELN" }),
        new JdeIndex("FY5AHX04_3", "Index on DIPTHT, DIPTH, DIMNI", new[] { "DIPTHT", "DIPTH", "DIMNI" })
    };
}
