...
/// F40R12WF - .
/// </summary>
public class F40R12WF : JdeTable
{
    /// <summary>
    ...
    public static class Columns
    {
        ...
        /// CQJOBS.
        /// </summary>
        public const string CQJOBS = "CQJOBS";

        /// <summary>
        /// CQCTID.
        /// </summary>
        public const string CQCTID = "CQCTID";

        /// <summary>
        /// CQMATH01.
        /// </summary>
        public const string CQMATH01 = "CQMATH01";
    ...
    /// <inheritdoc />
    public override string TableName => "F40R12WF";
    ...
    {
        new JdeField("CQJOBS", "CQJOBS", JdeDataType.Numeric, null, true, true),
        new JdeField("CQCTID", "CQCTID", JdeDataType.String, 30, true, true),
        new JdeField("CQMATH01", "CQMATH01", JdeDataType.Numeric, null, true, true),
    ...
    {
        new JdeIndex("F40R12WF_0", "Primary Key on CQJOBS, CQCTID, CQMATH01, CQCUMID", new[] { "CQJOBS", "CQCTID", "CQMATH01", "CQCUMID" }, isUnique: true, isPrimaryKey: true),
        new JdeIndex("F40R12WF_2", "Index on CQMCU, CQCITM, CQAN8, CQSHAN, CQCSTPO, CQCUMUV1, CQCUMUV2, CQCUMUV3, CQCUMUT1, CQCUMUT2, CQCUMUT3, CQCUMTYPE", new[] { "CQMCU", "CQCITM", "CQAN8", "CQSHAN", "CQCSTPO", "CQCUMUV1", "CQCUMUV2", "CQCUMUV3", "CQCUMUT1", "CQCUMUT2", "CQCUMUT3", "CQCUMTYPE" })
    };
}
