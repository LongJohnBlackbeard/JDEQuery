...
public class F0911P : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F0911P";
    ...
    {
        new JdeIndex("F0911P_0", "Primary Key on GLDCT, GLDOC, GLKCO, GLDGJ, GLJELN, GLLT, GLEXTL", new[] { "GLDCT", "GLDOC", "GLKCO", "GLDGJ", "GLJELN", "GLLT", "GLEXTL" }, isUnique: true, isPrimaryKey: true)
    };
}
