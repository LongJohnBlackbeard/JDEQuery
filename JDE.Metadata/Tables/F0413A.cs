...
public class F0413A : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F0413A";
    ...
    {
        new JdeIndex("F0413A_0", "Primary Key on RMPYID", new[] { "RMPYID" }, isUnique: true, isPrimaryKey: true)
    };
}
