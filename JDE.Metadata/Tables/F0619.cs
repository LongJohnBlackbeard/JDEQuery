...
public class F0619 : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F0619";
    ...
    public override IReadOnlyList<IJdeField> Fields { get; } = new List<IJdeField>
    {
        ...
        new JdeField("Y$PPED", "Y$PPED", JdeDataType.Numeric),
    ...
    {
        new JdeIndex("F0619_0", "Primary Key on Y$AN8, Y$CKCN, Y$PDBA", new[] { "Y$AN8", "Y$CKCN", "Y$PDBA" }, isUnique: true, isPrimaryKey: true),
        new JdeIndex("F0619_2", "Index on Y$AN8, Y$PDBA, Y$HMO, Y$CKDT", new[] { "Y$AN8", "Y$PDBA", "Y$HMO", "Y$CKDT" }),
        new JdeIndex("F0619_3", "Index on Y$AN8, Y$DWK", new[] { "Y$AN8", "Y$DWK" }),
        new JdeIndex("F0619_4", "Index on Y$AN8, Y$PDBA, Y$WST", new[] { "Y$AN8", "Y$PDBA", "Y$WST" }),
        new JdeIndex("F0619_5", "Index on Y$UN, Y$PPED, Y$AN8, Y$DISO", new[] { "Y$UN", "Y$PPED", "Y$AN8", "Y$DISO" }),
        new JdeIndex("F0619_6", "Index on Y$AN8, Y$PDBA, Y$DWK", new[] { "Y$AN8", "Y$PDBA", "Y$DWK" }),
        new JdeIndex("F0619_7", "Index on Y$AN8, Y$DWK, Y$PDBA", new[] { "Y$AN8", "Y$DWK", "Y$PDBA" }),
        new JdeIndex("F0619_8", "Index on Y$AN8, Y$CKDT", new[] { "Y$AN8", "Y$CKDT" }),
        new JdeIndex("F0619_9", "Index on Y$AN8, Y$CKCN, Y$PPED, Y$PDBA", new[] { "Y$AN8", "Y$CKCN", "Y$PPED", "Y$PDBA" })
    };
}
