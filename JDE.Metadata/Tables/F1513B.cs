...
public class F1513B : JdeTable
{
    ...
    public static class Columns
    {
        ...
        /// O3URCD.
        /// </summary>
        public const string O3URCD = "O3URCD";

        /// <summary>
        /// O3URDT.
        /// </summary>
        public const string O3URDT = "O3URDT";

        /// <summary>
        /// O3URAT.
        /// </summary>
        public const string O3URAT = "O3URAT";

        /// <summary>
        /// O3URAB.
        /// </summary>
        public const string O3URAB = "O3URAB";

        /// <summary>
        /// O3URRF.
        /// </summary>
        public const string O3URRF = "O3URRF";
        ...
        /// O3ENTJ.
        /// </summary>
        public const string O3ENTJ = "O3ENTJ";

        /// <summary>
        /// O3TORG.
        /// </summary>
        public const string O3TORG = "O3TORG";

        /// <summary>
        /// O3CRCD.
        /// </summary>
        public const string O3CRCD = "O3CRCD";

        /// <summary>
        /// O3CRRM.
        /// </summary>
        public const string O3CRRM = "O3CRRM";

        /// <summary>
        /// O3CRR.
        /// </summary>
        public const string O3CRR = "O3CRR";

        /// <summary>
        /// O3EFTE.
        /// </summary>
        public const string O3EFTE = "O3EFTE";
    }

    /// <inheritdoc />
    public override string TableName => "F1513B";
    ...
    public override IReadOnlyList<IJdeField> Fields { get; } = new List<IJdeField>
    {
        ...
        new JdeField("O3URCD", "O3URCD", JdeDataType.String, 4),
        new JdeField("O3URDT", "O3URDT", JdeDataType.Numeric),
        new JdeField("O3URAT", "O3URAT", JdeDataType.Numeric),
        new JdeField("O3URAB", "O3URAB", JdeDataType.Numeric),
        new JdeField("O3URRF", "O3URRF", JdeDataType.String, 30),
        ...
        new JdeField("O3ENTJ", "O3ENTJ", JdeDataType.Numeric),
        new JdeField("O3TORG", "O3TORG", JdeDataType.String, 20),
        new JdeField("O3CRCD", "O3CRCD", JdeDataType.String, 6, true, true),
        new JdeField("O3CRRM", "O3CRRM", JdeDataType.String, 2),
        new JdeField("O3CRR", "O3CRR", JdeDataType.Numeric),
        new JdeField("O3EFTE", "O3EFTE", JdeDataType.Numeric)
    };

    /// <inheritdoc />
    public override IReadOnlyList<IJdeIndex> Indexes { get; } = new List<IJdeIndex>
    {
        new JdeIndex("F1513B_0", "Primary Key on O3ICU, O3DOCO, O3MCU, O3UNIT, O3CRCD, O3CTRY, O3YR", new[] { "O3ICU", "O3DOCO", "O3MCU", "O3UNIT", "O3CRCD", "O3CTRY", "O3YR" }, isUnique: true, isPrimaryKey: true),
        new JdeIndex("F1513B_2", "Index on O3DOCO, O3MCU, O3UNIT, O3CRCD, O3CTRY, O3YR", new[] { "O3DOCO", "O3MCU", "O3UNIT", "O3CRCD", "O3CTRY", "O3YR" }),
        new JdeIndex("F1513B_3", "Index on O3DOCO, O3MCU, O3UNIT", new[] { "O3DOCO", "O3MCU", "O3UNIT" }),
        new JdeIndex("F1513B_4", "Index on SYS_NC00071$, O3DOCO, O3MCU, O3UNIT, O3CRCD", new[] { "SYS_NC00071$", "O3DOCO", "O3MCU", "O3UNIT", "O3CRCD" })
    };
}
