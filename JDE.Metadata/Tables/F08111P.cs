...
public class F08111P : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F08111P";
    ...
    {
        new JdeIndex("F08111P_0", "Primary Key on HQHMCU, HQPOS, HQAN8, HQEFTS, HQTMDY", new[] { "HQHMCU", "HQPOS", "HQAN8", "HQEFTS", "HQTMDY" }, isUnique: true, isPrimaryKey: true)
    };
}
