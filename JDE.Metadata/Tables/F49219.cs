...
public class F49219 : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F49219";
    ...
    {
        new JdeIndex("F49219_0", "Primary Key on UDDOCO, UDDCTO, UDKCOO, UDLNID", new[] { "UDDOCO", "UDDCTO", "UDKCOO", "UDLNID" }, isUnique: true, isPrimaryKey: true)
    };
}
