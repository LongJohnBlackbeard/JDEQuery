...
/// F75T0049 - .
/// </summary>
public class F75T0049 : JdeTable
{
    /// <summary>
    ...
    /// <inheritdoc />
    public override string TableName => "F75T0049";
    ...
    {
        new JdeIndex("F75T0049_0", "Primary Key on TH75TTNF, TH75TRAS, TH75TYMH, TH75TVTT", new[] { "TH75TTNF", "TH75TRAS", "TH75TYMH", "TH75TVTT" }, isUnique: true, isPrimaryKey: true)
    };
}
