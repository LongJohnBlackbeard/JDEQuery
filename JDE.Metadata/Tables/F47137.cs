...
public class F47137 : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F47137";
    ...
    {
        new JdeIndex("F47137_0", "Primary Key on SZEDOC, SZEDCT, SZEKCO, SZEDLN", new[] { "SZEDOC", "SZEDCT", "SZEKCO", "SZEDLN" }, isUnique: true, isPrimaryKey: true)
    };
}
