...
public class F4201TX : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F4201TX";
    ...
    {
        new JdeIndex("F4201TX_0", "Primary Key on STDOCO, STDCTO, STKCOO", new[] { "STDOCO", "STDCTO", "STKCOO" }, isUnique: true, isPrimaryKey: true)
    };
}
