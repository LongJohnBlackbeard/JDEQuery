...
public class F47027T : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F47027T";
    ...
    {
        new JdeIndex("F47027T_0", "Primary Key on UZEDOC, UZEDCT, UZEKCO, UZEDLN", new[] { "UZEDOC", "UZEDCT", "UZEKCO", "UZEDLN" }, isUnique: true, isPrimaryKey: true)
    };
}
