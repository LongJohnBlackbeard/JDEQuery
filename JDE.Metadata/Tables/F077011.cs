...
public class F077011 : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F077011";
    ...
    {
        new JdeIndex("F077011_0", "Primary Key on Y$DTEY, Y$CO, Y$EKEY, Y$AN8, Y$PTAX, Y$TARA, Y$THTY, Y$TAXX", new[] { "Y$DTEY", "Y$CO", "Y$EKEY", "Y$AN8", "Y$PTAX", "Y$TARA", "Y$THTY", "Y$TAXX" }, isUnique: true, isPrimaryKey: true)
    };
}
