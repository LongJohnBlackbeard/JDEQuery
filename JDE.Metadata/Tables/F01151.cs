...
public class F01151 : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F01151";
    ...
    {
        new JdeField("EAAN8", "EAAN8", JdeDataType.Numeric, null, true, true),
        new JdeField("EAIDLN", "EAIDLN", JdeDataType.Numeric, null, true, true),
        new JdeField("EARCK7", "EARCK7", JdeDataType.Numeric, null, true, true),
    ...
    {
        new JdeIndex("F01151_0", "Primary Key on EAAN8, EAIDLN, EARCK7", new[] { "EAAN8", "EAIDLN", "EARCK7" }, isUnique: true, isPrimaryKey: true),
        new JdeIndex("F01151_3", "Index on EAAN8, EAIDLN, EAETP", new[] { "EAAN8", "EAIDLN", "EAETP" })
    };
}
