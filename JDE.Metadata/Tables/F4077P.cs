...
public class F4077P : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F4077P";
    ...
    {
        new JdeIndex("F4077P_0", "Primary Key on RTAST, RTAN8, RTITM, RTIGID, RTCGID, RTEFTJ, RTTHRV, RTTDAY, RTUKID", new[] { "RTAST", "RTAN8", "RTITM", "RTIGID", "RTCGID", "RTEFTJ", "RTTHRV", "RTTDAY", "RTUKID" }, isUnique: true, isPrimaryKey: true),
        new JdeIndex("F4077P_2", "Index on RTAST, RTAN8, RTITM, RTIGID, RTCGID, SYS_NC00033$", new[] { "RTAST", "RTAN8", "RTITM", "RTIGID", "RTCGID", "SYS_NC00033$" }),
        new JdeIndex("F4077P_3", "Index on RTAST, RTAN8, RTITM, RTMCU, RTIGID, RTCGID", new[] { "RTAST", "RTAN8", "RTITM", "RTMCU", "RTIGID", "RTCGID" }),
        new JdeIndex("F4077P_4", "Index on RTAST, RTAN8, RTITM, RTTHRV, RTMCU, RTIGID, RTCGID", new[] { "RTAST", "RTAN8", "RTITM", "RTTHRV", "RTMCU", "RTIGID", "RTCGID" }),
        new JdeIndex("F4077P_6", "Index on RTAST, RTAN8, RTITM, RTEFTJ, RTTHRV, RTPID, RTIGID, RTCGID", new[] { "RTAST", "RTAN8", "RTITM", "RTEFTJ", "RTTHRV", "RTPID", "RTIGID", "RTCGID" })
    };
}
