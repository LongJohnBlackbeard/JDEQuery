...
public class FF31K30 : JdeTable
{
    ...
    public static class Columns
    {
        ...
        /// KMDFKID1.
        /// </summary>
        public const string KMDFKID1 = "KMDFKID1";
        ...
        /// KMDFOKQTY.
        /// </summary>
        public const string KMDFOKQTY = "KMDFOKQTY";
    ...
    /// <inheritdoc />
    public override string TableName => "FF31K30";
    ...
    public override IReadOnlyList<IJdeField> Fields { get; } = new List<IJdeField>
    {
        ...
        new JdeField("KMDFKID1", "KMDFKID1", JdeDataType.Numeric, null, true, true),
        ...
        new JdeField("KMDFOKQTY", "KMDFOKQTY", JdeDataType.Numeric),
    ...
    {
        new JdeIndex("FF31K30_0", "Primary Key on KMFSCID, KMCMITM, KMBOSTR, KMDFSMCU, KMDFSLOC, KMFDCMCU, KMDFCLOC, KMSUPN, KMDFKID1", new[] { "KMFSCID", "KMCMITM", "KMBOSTR", "KMDFSMCU", "KMDFSLOC", "KMFDCMCU", "KMDFCLOC", "KMSUPN", "KMDFKID1" }, isUnique: true, isPrimaryKey: true),
        new JdeIndex("FF31K30_2", "Index on KMDFKID1", new[] { "KMDFKID1" })
    };
}
