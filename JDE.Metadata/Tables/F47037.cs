...
public class F47037 : JdeTable
{
    ...
    public static class Columns
    {
        ...
        /// SZGANS8.
        /// </summary>
        public const string SZGANS8 = "SZGANS8";
    }

    /// <inheritdoc />
    public override string TableName => "F47037";
    ...
    public override IReadOnlyList<IJdeField> Fields { get; } = new List<IJdeField>
    {
        ...
        new JdeField("SZSTPC", "SZSTPC", JdeDataType.String, 2),
        ...
        new JdeField("SZLINS", "SZLINS", JdeDataType.Numeric),
        ...
        new JdeField("SZGANS8", "SZGANS8", JdeDataType.Numeric)
    };

    /// <inheritdoc />
    public override IReadOnlyList<IJdeIndex> Indexes { get; } = new List<IJdeIndex>
    {
        new JdeIndex("F47037_0", "Primary Key on SZEDOC, SZEDCT, SZEKCO, SZEDLN", new[] { "SZEDOC", "SZEDCT", "SZEKCO", "SZEDLN" }, isUnique: true, isPrimaryKey: true)
    };
}
