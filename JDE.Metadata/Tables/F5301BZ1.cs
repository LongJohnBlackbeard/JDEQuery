...
/// F5301BZ1 - .
/// </summary>
public class F5301BZ1 : JdeTable
{
    /// <summary>
    ...
    public static class Columns
    {
        ...
        /// DIJOBS.
        /// </summary>
        public const string DIJOBS = "DIJOBS";

        /// <summary>
        /// DIACTN.
        /// </summary>
        public const string DIACTN = "DIACTN";

        /// <summary>
        /// DIEV03.
        /// </summary>
        public const string DIEV03 = "DIEV03";
    ...
    /// <inheritdoc />
    public override string TableName => "F5301BZ1";
    ...
    {
        new JdeField("DIJOBS", "DIJOBS", JdeDataType.Numeric, null, true, true),
        new JdeField("DIACTN", "DIACTN", JdeDataType.String, 2),
        new JdeField("DIEV03", "DIEV03", JdeDataType.String, 2),
        new JdeField("DIVERS", "DIVERS", JdeDataType.String, 20),
        new JdeField("DICONO", "DICONO", JdeDataType.Numeric),
    ...
    {
        new JdeIndex("F5301BZ1_0", "Primary Key on DIJOBS", new[] { "DIJOBS" }, isUnique: true, isPrimaryKey: true),
        new JdeIndex("F5301BZ1_8", "Index on DIMCU, SYS_NC00053$", new[] { "DIMCU", "SYS_NC00053$" })
    };
}
