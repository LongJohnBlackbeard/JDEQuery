...
public class F078311 : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F078311";
    ...
    {
        new JdeIndex("F078311_0", "Primary Key on YFUKID", new[] { "YFUKID" }, isUnique: true, isPrimaryKey: true)
    };
}
