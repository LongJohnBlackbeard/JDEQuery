...
/// F4713260 - .
/// </summary>
public class F4713260 : JdeTable
{
    /// <summary>
    ...
    /// <inheritdoc />
    public override string TableName => "F4713260";
    ...
    {
        new JdeIndex("F4713260_0", "Primary Key on PDDOCO, PDDCTO, PDKCOO, PDSFXO, PDLNID, PDCMLN, PDSLSM", new[] { "PDDOCO", "PDDCTO", "PDKCOO", "PDSFXO", "PDLNID", "PDCMLN", "PDSLSM" }, isUnique: true, isPrimaryKey: true)
    };
}
