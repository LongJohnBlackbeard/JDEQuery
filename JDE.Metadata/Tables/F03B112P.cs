...
/// F03B112P - .
/// </summary>
public class F03B112P : JdeTable
{
    /// <summary>
    ...
    /// <inheritdoc />
    public override string TableName => "F03B112P";
    ...
    {
        new JdeIndex("F03B112P_0", "Primary Key on RWDOC, RWDCT, RWKCO, RWSFX, RWSFXE", new[] { "RWDOC", "RWDCT", "RWKCO", "RWSFX", "RWSFXE" }, isUnique: true, isPrimaryKey: true)
    };
}
