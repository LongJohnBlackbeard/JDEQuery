...
/// F074001W - .
/// </summary>
public class F074001W : JdeTable
{
    /// <summary>
    ...
    /// <inheritdoc />
    public override string TableName => "F074001W";
    ...
    {
        new JdeIndex("F074001W_0", "Primary Key on NHSCOD, NHRTID, NHRTVE", new[] { "NHSCOD", "NHRTID", "NHRTVE" }, isUnique: true, isPrimaryKey: true)
    };
}
