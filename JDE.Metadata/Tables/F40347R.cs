...
public class F40347R : JdeTable
{
    ...
    public static class Columns
    {
        ...
        /// RIUKID.
        /// </summary>
        public const string RIUKID = "RIUKID";

        /// <summary>
        /// RIREFC.
        /// </summary>
        public const string RIREFC = "RIREFC";
    ...
    /// <inheritdoc />
    public override string TableName => "F40347R";
    ...
    {
        new JdeField("RIUKID", "RIUKID", JdeDataType.Numeric, null, true, true),
        new JdeField("RIREFC", "RIREFC", JdeDataType.Numeric),
        new JdeField("RIAN8", "RIAN8", JdeDataType.Numeric),
        new JdeField("RICS47", "RICS47", JdeDataType.String, 16),
        new JdeField("RIITM", "RIITM", JdeDataType.Numeric),
        new JdeField("RIIT47", "RIIT47", JdeDataType.String, 16),
        new JdeField("RIEFTJ", "RIEFTJ", JdeDataType.Numeric),
        new JdeField("RIEXDJ", "RIEXDJ", JdeDataType.Numeric),
        new JdeField("RIMNQ", "RIMNQ", JdeDataType.Numeric),
        new JdeField("RIMXQ", "RIMXQ", JdeDataType.Numeric),
        ...
        new JdeField("RIOSEQ", "RIOSEQ", JdeDataType.Numeric),
    ...
    {
        new JdeIndex("F40347R_0", "Primary Key on RIUKID", new[] { "RIUKID" }, isUnique: true, isPrimaryKey: true),
        new JdeIndex("F40347R_2", "Index on RIAN8, RICS47, RIITM, RIIT47, RIEXDJ, RIMXQ, RIUOM, RIUOM4, RIUPMJ, RITDAY", new[] { "RIAN8", "RICS47", "RIITM", "RIIT47", "RIEXDJ", "RIMXQ", "RIUOM", "RIUOM4", "RIUPMJ", "RITDAY" })
    };
}
