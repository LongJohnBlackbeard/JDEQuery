...
public class F03B11P : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F03B11P";
    ...
    {
        new JdeIndex("F03B11P_0", "Primary Key on RPDOC, RPDCT, RPKCO, RPSFX", new[] { "RPDOC", "RPDCT", "RPKCO", "RPSFX" }, isUnique: true, isPrimaryKey: true)
    };
}
