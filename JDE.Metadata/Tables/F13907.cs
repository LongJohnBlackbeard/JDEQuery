...
public class F13907 : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F13907";
    ...
    {
        new JdeIndex("F13907_0", "Primary Key on FCNUMB, FCSHNO, FCSRVT", new[] { "FCNUMB", "FCSHNO", "FCSRVT" }, isUnique: true, isPrimaryKey: true)
    };
}
