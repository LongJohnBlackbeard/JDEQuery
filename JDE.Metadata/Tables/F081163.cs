...
public class F081163 : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F081163";
    ...
    {
        new JdeIndex("F081163_0", "Primary Key on ASAN8, ASACAD, ASACA#, ASHMCO", new[] { "ASAN8", "ASACAD", "ASACA#", "ASHMCO" }, isUnique: true, isPrimaryKey: true)
    };
}
