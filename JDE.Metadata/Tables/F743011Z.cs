...
/// F743011Z - .
/// </summary>
public class F743011Z : JdeTable
{
    /// <summary>
    ...
    public static class Columns
    {
        ...
        /// TKK74SIGN.
        /// </summary>
        public const string TKK74SIGN = "TKK74SIGN";
    ...
    /// <inheritdoc />
    public override string TableName => "F743011Z";
    ...
    public override IReadOnlyList<IJdeField> Fields { get; } = new List<IJdeField>
    {
        ...
        new JdeField("TKK74SIGN", "TKK74SIGN", JdeDataType.String, 512),
    ...
    {
        new JdeIndex("F743011Z_0", "Primary Key on TKEDUS, TKEDBT, TKEDTN", new[] { "TKEDUS", "TKEDBT", "TKEDTN" }, isUnique: true, isPrimaryKey: true)
    };
}
