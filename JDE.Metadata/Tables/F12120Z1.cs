...
/// F12120Z1 - .
/// </summary>
public class F12120Z1 : JdeTable
{
    /// <summary>
    ...
    public static class Columns
    {
        ...
        /// SZDTHRU.
        /// </summary>
        public const string SZDTHRU = "SZDTHRU";
        ...
        /// SZMTTP.
        /// </summary>
        public const string SZMTTP = "SZMTTP";

        /// <summary>
        /// SZBALOW.
        /// </summary>
        public const string SZBALOW = "SZBALOW";

        /// <summary>
        /// SZNIOWM.
        /// </summary>
        public const string SZNIOWM = "SZNIOWM";
    ...
    /// <inheritdoc />
    public override string TableName => "F12120Z1";
    ...
    public override IReadOnlyList<IJdeField> Fields { get; } = new List<IJdeField>
    {
        ...
        new JdeField("SZDTHRU", "SZDTHRU", JdeDataType.Numeric),
        ...
        new JdeField("SZMTTP", "SZMTTP", JdeDataType.String, 8),
        new JdeField("SZBALOW", "SZBALOW", JdeDataType.Numeric),
        new JdeField("SZNIOWM", "SZNIOWM", JdeDataType.Numeric),
    ...
    {
        new JdeIndex("F12120Z1_0", "Primary Key on SZEDUS, SZEDBT, SZEDTN, SZEDLN", new[] { "SZEDUS", "SZEDBT", "SZEDTN", "SZEDLN" }, isUnique: true, isPrimaryKey: true),
        new JdeIndex("F12120Z1_2", "Index on SZDTHRU, SZEDUS, SZEDBT, SZEDTN, SZEDLN", new[] { "SZDTHRU", "SZEDUS", "SZEDBT", "SZEDTN", "SZEDLN" })
    };
}
