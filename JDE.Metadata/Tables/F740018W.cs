...
/// F740018W - .
/// </summary>
public class F740018W : JdeTable
{
    /// <summary>
    ...
    /// <inheritdoc />
    public override string TableName => "F740018W";
    ...
    {
        new JdeIndex("F740018W_0", "Primary Key on DEDOCO, DEDCTO, DEKCOO, DESFXO, DELNID", new[] { "DEDOCO", "DEDCTO", "DEKCOO", "DESFXO", "DELNID" }, isUnique: true, isPrimaryKey: true)
    };
}
