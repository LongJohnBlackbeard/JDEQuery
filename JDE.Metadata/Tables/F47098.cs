...
public class F47098 : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F47098";
    ...
    {
        new JdeIndex("F47098_0", "Primary Key on SZEDOC, SZEDCT, SZEKCO, SZEDLN, SZLNID, SZAN8", new[] { "SZEDOC", "SZEDCT", "SZEKCO", "SZEDLN", "SZLNID", "SZAN8" }, isUnique: true, isPrimaryKey: true)
    };
}
