...
/// F76AUI20 - .
/// </summary>
public class F76AUI20 : JdeTable
{
    /// <summary>
    ...
    public static class Columns
    {
        ...
        /// HFSNLN.
        /// </summary>
        public const string HFSNLN = "HFSNLN";
    }

    /// <inheritdoc />
    public override string TableName => "F76AUI20";
    ...
    public override IReadOnlyList<IJdeField> Fields { get; } = new List<IJdeField>
    {
        ...
        new JdeField("HFSNLN", "HFSNLN", JdeDataType.String, 50)
    };

    /// <inheritdoc />
    public override IReadOnlyList<IJdeIndex> Indexes { get; } = new List<IJdeIndex>
    {
        new JdeIndex("F76AUI20_0", "Primary Key on HFJOBS, HFCTID, HFDOC, HFDCT, HFKCO", new[] { "HFJOBS", "HFCTID", "HFDOC", "HFDCT", "HFKCO" }, isUnique: true, isPrimaryKey: true),
        new JdeIndex("F76AUI20_2", "Index on HFJOBS, HFCTID, HFARYO, HFINTY, HFEV01", new[] { "HFJOBS", "HFCTID", "HFARYO", "HFINTY", "HFEV01" })
    };
}
