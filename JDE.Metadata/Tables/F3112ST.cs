...
public class F3112ST : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F3112ST";
    ...
    {
        new JdeIndex("F3112ST_0", "Primary Key on WLDOCO, WLOPSQ, WLOPSC, WLMCU", new[] { "WLDOCO", "WLOPSQ", "WLOPSC", "WLMCU" }, isUnique: true, isPrimaryKey: true)
    };
}
