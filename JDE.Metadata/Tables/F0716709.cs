...
/// F0716709 - .
/// </summary>
public class F0716709 : JdeTable
{
    /// <summary>
    ...
    /// <inheritdoc />
    public override string TableName => "F0716709";
    ...
    {
        new JdeIndex("F0716709_0", "Primary Key on EATSKID", new[] { "EATSKID" }, isUnique: true, isPrimaryKey: true)
    };
}
