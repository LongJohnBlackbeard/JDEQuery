...
public class F47096 : JdeTable
{
    ...
    public static class Columns
    {
        ...
        /// SYRQQJ.
        /// </summary>
        public const string SYRQQJ = "SYRQQJ";
    ...
    /// <inheritdoc />
    public override string TableName => "F47096";
    ...
    public override IReadOnlyList<IJdeField> Fields { get; } = new List<IJdeField>
    {
        ...
        new JdeField("SYRQQJ", "SYRQQJ", JdeDataType.Numeric),
    ...
    {
        new JdeIndex("F47096_0", "Primary Key on SYEDOC, SYEDCT, SYEKCO", new[] { "SYEDOC", "SYEDCT", "SYEKCO" }, isUnique: true, isPrimaryKey: true)
    };
}
