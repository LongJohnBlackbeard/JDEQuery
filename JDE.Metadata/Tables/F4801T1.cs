...
public class F4801T1 : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F4801T1";
    ...
    {
        new JdeIndex("F4801T1_0", "Primary Key on WADOCO", new[] { "WADOCO" }, isUnique: true, isPrimaryKey: true)
    };
}
