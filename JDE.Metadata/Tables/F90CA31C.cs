...
/// F90CA31C - .
/// </summary>
public class F90CA31C : JdeTable
{
    /// <summary>
    ...
    public static class Columns
    {
        ...
        /// EXRECURID.
        /// </summary>
        public const string EXRECURID = "EXRECURID";
    ...
    /// <inheritdoc />
    public override string TableName => "F90CA31C";
    ...
    {
        new JdeField("EXRECURID", "EXRECURID", JdeDataType.String, 72, true, true),
    ...
    {
        new JdeIndex("F90CA31C_0", "Primary Key on EXRECURID", new[] { "EXRECURID" }, isUnique: true, isPrimaryKey: true)
    };
}
