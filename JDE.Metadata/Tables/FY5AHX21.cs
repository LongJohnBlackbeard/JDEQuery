...
/// FY5AHX21 - .
/// </summary>
public class FY5AHX21 : JdeTable
{
    /// <summary>
    ...
    /// <inheritdoc />
    public override string TableName => "FY5AHX21";
    ...
    {
        new JdeIndex("FY5AHX21_0", "Primary Key on SDY5AHE1RL, SDY5AHMDID", new[] { "SDY5AHE1RL", "SDY5AHMDID" }, isUnique: true, isPrimaryKey: true)
    };
}
