...
public class F40308R : JdeTable
{
    ...
    public static class Columns
    {
        ...
        /// GSREFC.
        /// </summary>
        public const string GSREFC = "GSREFC";
    ...
    /// <inheritdoc />
    public override string TableName => "F40308R";
    ...
    public override IReadOnlyList<IJdeField> Fields { get; } = new List<IJdeField>
    {
        ...
        new JdeField("GSREFC", "GSREFC", JdeDataType.Numeric),
        new JdeField("GSAN8", "GSAN8", JdeDataType.Numeric),
        new JdeField("GSCS08", "GSCS08", JdeDataType.String, 16),
        new JdeField("GSITM", "GSITM", JdeDataType.Numeric),
        new JdeField("GSIT08", "GSIT08", JdeDataType.String, 16),
        new JdeField("GSEFTJ", "GSEFTJ", JdeDataType.Numeric),
        new JdeField("GSEXDJ", "GSEXDJ", JdeDataType.Numeric),
        new JdeField("GSMNQ", "GSMNQ", JdeDataType.Numeric),
        new JdeField("GSMXQ", "GSMXQ", JdeDataType.Numeric),
    ...
    {
        new JdeIndex("F40308R_0", "Primary Key on GSUKID", new[] { "GSUKID" }, isUnique: true, isPrimaryKey: true),
        new JdeIndex("F40308R_2", "Index on GSAN8, GSCS08, GSITM, GSIT08, GSEXDJ, GSMXQ, GSUOM, GSTHGD, GSUPMJ, GSTDAY", new[] { "GSAN8", "GSCS08", "GSITM", "GSIT08", "GSEXDJ", "GSMXQ", "GSUOM", "GSTHGD", "GSUPMJ", "GSTDAY" })
    };
}
