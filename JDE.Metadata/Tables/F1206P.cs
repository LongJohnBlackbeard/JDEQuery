...
public class F1206P : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F1206P";
    ...
    {
        new JdeIndex("F1206P_0", "Primary Key on FHNUMB, FHADDS, FHLNUM", new[] { "FHNUMB", "FHADDS", "FHLNUM" }, isUnique: true, isPrimaryKey: true)
    };
}
