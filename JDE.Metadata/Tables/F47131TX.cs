...
/// F47131TX - .
/// </summary>
public class F47131TX : JdeTable
{
    /// <summary>
    ...
    /// <inheritdoc />
    public override string TableName => "F47131TX";
    ...
    {
        new JdeIndex("F47131TX_0", "Primary Key on STEDOC, STEDCT, STEKCO", new[] { "STEDOC", "STEDCT", "STEKCO" }, isUnique: true, isPrimaryKey: true)
    };
}
