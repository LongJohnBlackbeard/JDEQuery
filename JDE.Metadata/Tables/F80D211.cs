...
public class F80D211 : JdeTable
{
    ...
    public static class Columns
    {
        ...
        /// PSEYCT.
        /// </summary>
        public const string PSEYCT = "PSEYCT";

        /// <summary>
        /// PSOTCT.
        /// </summary>
        public const string PSOTCT = "PSOTCT";

        /// <summary>
        /// PSLATECT.
        /// </summary>
        public const string PSLATECT = "PSLATECT";
    ...
    /// <inheritdoc />
    public override string TableName => "F80D211";
    ...
    public override IReadOnlyList<IJdeField> Fields { get; } = new List<IJdeField>
    {
        ...
        new JdeField("PSITM", "PSITM", JdeDataType.Numeric, null, true, true),
        new JdeField("PSEYCT", "PSEYCT", JdeDataType.Numeric),
        new JdeField("PSOTCT", "PSOTCT", JdeDataType.Numeric),
        new JdeField("PSLATECT", "PSLATECT", JdeDataType.Numeric),
    ...
    {
        new JdeIndex("F80D211_0", "Primary Key on PSPRDJ, PSMCU, PSAN8, PSITM", new[] { "PSPRDJ", "PSMCU", "PSAN8", "PSITM" }, isUnique: true, isPrimaryKey: true)
    };
}
