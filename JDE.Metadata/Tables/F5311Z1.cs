...
public class F5311Z1 : JdeTable
{
    ...
    public static class Columns
    {
        ...
        /// DKJOBS.
        /// </summary>
        public const string DKJOBS = "DKJOBS";

        /// <summary>
        /// DKACTN.
        /// </summary>
        public const string DKACTN = "DKACTN";
        ...
        /// DKCPY.
        /// </summary>
        public const string DKCPY = "DKCPY";
        ...
        /// DKCO3.
        /// </summary>
        public const string DKCO3 = "DKCO3";
        ...
        /// DKCO4.
        /// </summary>
        public const string DKCO4 = "DKCO4";
    ...
    /// <inheritdoc />
    public override string TableName => "F5311Z1";
    ...
    {
        new JdeField("DKJOBS", "DKJOBS", JdeDataType.Numeric),
        new JdeField("DKACTN", "DKACTN", JdeDataType.String, 2),
        ...
        new JdeField("DKCPY", "DKCPY", JdeDataType.String, 10),
        ...
        new JdeField("DKCO3", "DKCO3", JdeDataType.String, 10),
        ...
        new JdeField("DKCO4", "DKCO4", JdeDataType.String, 10),
    ...
    {
        new JdeIndex("F5311Z1_0", "Primary Key on DKMCU, DKCONO, DKLNID, DKREQB", new[] { "DKMCU", "DKCONO", "DKLNID", "DKREQB" }, isUnique: true, isPrimaryKey: true),
        new JdeIndex("F5311Z1_12", "Index on DKJOBS, SYS_NC00161$", new[] { "DKJOBS", "SYS_NC00161$" }),
        new JdeIndex("F5311Z1_13", "Index on DKJOBS, DKMCU, DKLNID", new[] { "DKJOBS", "DKMCU", "DKLNID" })
    };
}
