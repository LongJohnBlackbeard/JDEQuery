...
public class F12853 : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F12853";
    ...
    {
        new JdeIndex("F12853_0", "Primary Key on LWFORI", new[] { "LWFORI" }, isUnique: true, isPrimaryKey: true)
    };
}
