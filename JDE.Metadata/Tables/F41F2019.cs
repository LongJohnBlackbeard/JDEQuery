...
/// F41F2019 - .
/// </summary>
public class F41F2019 : JdeTable
{
    /// <summary>
    ...
    /// <inheritdoc />
    public override string TableName => "F41F2019";
    ...
    {
        new JdeIndex("F41F2019_0", "Primary Key on APDOCO, APDCTO, APKCOO", new[] { "APDOCO", "APDCTO", "APKCOO" }, isUnique: true, isPrimaryKey: true)
    };
}
