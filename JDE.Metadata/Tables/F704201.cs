...
public class F704201 : JdeTable
{
    ...
    public static class Columns
    {
        ...
        /// LAKCOO.
        /// </summary>
        public const string LAKCOO = "LAKCOO";

        /// <summary>
        /// LADOCO.
        /// </summary>
        public const string LADOCO = "LADOCO";

        /// <summary>
        /// LADCTO.
        /// </summary>
        public const string LADCTO = "LADCTO";
    ...
    /// <inheritdoc />
    public override string TableName => "F704201";
    ...
    {
        new JdeField("LAKCOO", "LAKCOO", JdeDataType.String, 10, true, true),
        new JdeField("LADOCO", "LADOCO", JdeDataType.Numeric, null, true, true),
        new JdeField("LADCTO", "LADCTO", JdeDataType.String, 4, true, true),
    ...
    {
        new JdeIndex("F704201_0", "Primary Key on LAKCOO, LADOCO, LADCTO, LALCTR, LAK70ADSTR", new[] { "LAKCOO", "LADOCO", "LADCTO", "LALCTR", "LAK70ADSTR" }, isUnique: true, isPrimaryKey: true)
    };
}
