...
public class F07436 : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F07436";
    ...
    {
        new JdeIndex("F07436_0", "Primary Key on NHUKID", new[] { "NHUKID" }, isUnique: true, isPrimaryKey: true)
    };
}
