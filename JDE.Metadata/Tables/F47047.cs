...
public class F47047 : JdeTable
{
    ...
    public static class Columns
    {
        ...
        /// SZKAMTDOM.
        /// </summary>
        public const string SZKAMTDOM = "SZKAMTDOM";

        /// <summary>
        /// SZKAMTFOR.
        /// </summary>
        public const string SZKAMTFOR = "SZKAMTFOR";
    ...
    /// <inheritdoc />
    public override string TableName => "F47047";
    ...
    public override IReadOnlyList<IJdeField> Fields { get; } = new List<IJdeField>
    {
        ...
        new JdeField("SZKAMTDOM", "SZKAMTDOM", JdeDataType.Numeric),
        new JdeField("SZKAMTFOR", "SZKAMTFOR", JdeDataType.Numeric),
    ...
    {
        new JdeIndex("F47047_0", "Primary Key on SZEDOC, SZEDCT, SZEKCO, SZEDLN", new[] { "SZEDOC", "SZEDCT", "SZEKCO", "SZEDLN" }, isUnique: true, isPrimaryKey: true),
        new JdeIndex("F47047_2", "Index on SZSHPN", new[] { "SZSHPN" })
    };
}
