...
public class F40309 : JdeTable
{
    ...
    public static class Columns
    {
        ...
        /// DYEDWD.
        /// </summary>
        public const string DYEDWD = "DYEDWD";
    }

    /// <inheritdoc />
    public override string TableName => "F40309";
    ...
    {
        new JdeField("DYAN8", "DYAN8", JdeDataType.Numeric, null, true, true),
        new JdeField("DYCS09", "DYCS09", JdeDataType.String, 16, true, true),
        new JdeField("DYITM", "DYITM", JdeDataType.Numeric, null, true, true),
        new JdeField("DYIT09", "DYIT09", JdeDataType.String, 16, true, true),
        new JdeField("DYEFTJ", "DYEFTJ", JdeDataType.Numeric),
        new JdeField("DYEXDJ", "DYEXDJ", JdeDataType.Numeric, null, true, true),
        new JdeField("DYMNQ", "DYMNQ", JdeDataType.Numeric),
        new JdeField("DYMXQ", "DYMXQ", JdeDataType.Numeric, null, true, true),
        new JdeField("DYUOM", "DYUOM", JdeDataType.String, 4, true, true),
        new JdeField("DYTXID", "DYTXID", JdeDataType.Numeric),
        new JdeField("DYSTPR", "DYSTPR", JdeDataType.String, 2),
        new JdeField("DYOSEQ", "DYOSEQ", JdeDataType.Numeric, null, true, true),
        ...
        new JdeField("DYEDWD", "DYEDWD", JdeDataType.String, 2)
    };

    /// <inheritdoc />
    public override IReadOnlyList<IJdeIndex> Indexes { get; } = new List<IJdeIndex>
    {
        new JdeIndex("F40309_0", "Primary Key on DYAN8, DYCS09, DYITM, DYIT09, DYEXDJ, DYUOM, DYMXQ, DYOSEQ", new[] { "DYAN8", "DYCS09", "DYITM", "DYIT09", "DYEXDJ", "DYUOM", "DYMXQ", "DYOSEQ" }, isUnique: true, isPrimaryKey: true)
    };
}
