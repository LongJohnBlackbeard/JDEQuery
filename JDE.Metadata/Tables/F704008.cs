...
public class F704008 : JdeTable
{
    ...
    public static class Columns
    {
        ...
        /// LATXA1.
        /// </summary>
        public const string LATXA1 = "LATXA1";
        ...
        /// LAEFDJ.
        /// </summary>
        public const string LAEFDJ = "LAEFDJ";
    ...
    /// <inheritdoc />
    public override string TableName => "F704008";
    ...
    {
        new JdeField("LATXA1", "LATXA1", JdeDataType.String, 20, true, true),
        new JdeField("LAITM", "LAITM", JdeDataType.Numeric, null, true, true),
        new JdeField("LAEFDJ", "LAEFDJ", JdeDataType.Numeric, null, true, true),
    ...
    {
        new JdeIndex("F704008_0", "Primary Key on LATXA1, LAITM, LAEFDJ, LALCTR, LAK70ADSTR", new[] { "LATXA1", "LAITM", "LAEFDJ", "LALCTR", "LAK70ADSTR" }, isUnique: true, isPrimaryKey: true)
    };
}
