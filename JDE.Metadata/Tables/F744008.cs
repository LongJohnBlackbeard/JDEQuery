...
public class F744008 : JdeTable
{
    ...
    public static class Columns
    {
        ...
        /// TAIVFL.
        /// </summary>
        public const string TAIVFL = "TAIVFL";
    ...
    /// <inheritdoc />
    public override string TableName => "F744008";
    ...
    public override IReadOnlyList<IJdeField> Fields { get; } = new List<IJdeField>
    {
        ...
        new JdeField("TAIVFL", "TAIVFL", JdeDataType.String, 2),
    ...
    {
        new JdeIndex("F744008_0", "Primary Key on TATXA1, TAITM, TAEFDJ", new[] { "TATXA1", "TAITM", "TAEFDJ" }, isUnique: true, isPrimaryKey: true)
    };
}
