...
/// F0713SAV - .
/// </summary>
public class F0713SAV : JdeTable
{
    /// <summary>
    ...
    /// <inheritdoc />
    public override string TableName => "F0713SAV";
    ...
    {
        new JdeIndex("F0713SAV_0", "Primary Key on YZAN8, YZTHTY, YZTARA, YZPTAX, YZDTEY, YZTAXX, YZHMCO, YZWST, YZWCNT, YZWCTY", new[] { "YZAN8", "YZTHTY", "YZTARA", "YZPTAX", "YZDTEY", "YZTAXX", "YZHMCO", "YZWST", "YZWCNT", "YZWCTY" }, isUnique: true, isPrimaryKey: true)
    };
}
