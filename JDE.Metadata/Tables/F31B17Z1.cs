...
/// F31B17Z1 - .
/// </summary>
public class F31B17Z1 : JdeTable
{
    /// <summary>
    ...
    public static class Columns
    {
        ...
        /// SZEURSCD.
        /// </summary>
        public const string SZEURSCD = "SZEURSCD";

        /// <summary>
        /// SZBFLG.
        /// </summary>
        public const string SZBFLG = "SZBFLG";

        /// <summary>
        /// SZLTQNTY.
        /// </summary>
        public const string SZLTQNTY = "SZLTQNTY";
    ...
    /// <inheritdoc />
    public override string TableName => "F31B17Z1";
    ...
    public override IReadOnlyList<IJdeField> Fields { get; } = new List<IJdeField>
    {
        ...
        new JdeField("SZEURSCD", "SZEURSCD", JdeDataType.String, 20),
        new JdeField("SZBFLG", "SZBFLG", JdeDataType.String, 2),
        new JdeField("SZLTQNTY", "SZLTQNTY", JdeDataType.Numeric),
    ...
    {
        new JdeIndex("F31B17Z1_0", "Primary Key on SZEDUS, SZEDBT, SZEDTN, SZEDLN", new[] { "SZEDUS", "SZEDBT", "SZEDTN", "SZEDLN" }, isUnique: true, isPrimaryKey: true),
        new JdeIndex("F31B17Z1_2", "Index on SZWAPRN", new[] { "SZWAPRN" })
    };
}
