...
/// F31B34Z1 - .
/// </summary>
public class F31B34Z1 : JdeTable
{
    /// <summary>
    ...
    public static class Columns
    {
        ...
        /// SZSITEM.
        /// </summary>
        public const string SZSITEM = "SZSITEM";

        /// <summary>
        /// SZSVALUE.
        /// </summary>
        public const string SZSVALUE = "SZSVALUE";
    ...
    /// <inheritdoc />
    public override string TableName => "F31B34Z1";
    ...
    public override IReadOnlyList<IJdeField> Fields { get; } = new List<IJdeField>
    {
        ...
        new JdeField("SZSITEM", "SZSITEM", JdeDataType.String, 24),
        new JdeField("SZSVALUE", "SZSVALUE", JdeDataType.Numeric),
    ...
    {
        new JdeIndex("F31B34Z1_0", "Primary Key on SZEDUS, SZEDBT, SZEDTN, SZEDLN", new[] { "SZEDUS", "SZEDBT", "SZEDTN", "SZEDLN" }, isUnique: true, isPrimaryKey: true),
        new JdeIndex("F31B34Z1_11", "Index on SZEDUS, SZEDBT, SZEDTN", new[] { "SZEDUS", "SZEDBT", "SZEDTN" }),
        new JdeIndex("F31B34Z1_13", "Index on SZEDBT, SZEDTN, SZWAPRN, SZSITEM", new[] { "SZEDBT", "SZEDTN", "SZWAPRN", "SZSITEM" }),
        new JdeIndex("F31B34Z1_14", "Index on SZEDUS, SZEDBT, SZEDTN, SYS_NC00032$", new[] { "SZEDUS", "SZEDBT", "SZEDTN", "SYS_NC00032$" }),
        new JdeIndex("F31B34Z1_15", "Index on SZWAPRN", new[] { "SZWAPRN" }),
        new JdeIndex("F31B34Z1_8", "Index on SZEDUS, SZEDBT, SZEDTN, SZEDSP", new[] { "SZEDUS", "SZEDBT", "SZEDTN", "SZEDSP" }),
        new JdeIndex("F31B34Z1_9", "Index on SZEDUS, SZEDBT, SZEDSP", new[] { "SZEDUS", "SZEDBT", "SZEDSP" })
    };
}
