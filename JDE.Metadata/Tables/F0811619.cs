...
/// F0811619 - .
/// </summary>
public class F0811619 : JdeTable
{
    /// <summary>
    ...
    /// <inheritdoc />
    public override string TableName => "F0811619";
    ...
    public override IReadOnlyList<IJdeField> Fields { get; } = new List<IJdeField>
    {
        ...
        new JdeField("ADACAF", "ADACAF", JdeDataType.String, 2, true, true),
    ...
    {
        new JdeIndex("F0811619_0", "Primary Key on ADAN8, ADACAD, ADACA#, ADACAF", new[] { "ADAN8", "ADACAD", "ADACA#", "ADACAF" }, isUnique: true, isPrimaryKey: true)
    };
}
