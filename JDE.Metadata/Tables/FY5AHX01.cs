...
/// FY5AHX01 - .
/// </summary>
public class FY5AHX01 : JdeTable
{
    /// <summary>
    ...
    /// <inheritdoc />
    public override string TableName => "FY5AHX01";
    ...
    {
        new JdeIndex("FY5AHX01_0", "Primary Key on DIMNI", new[] { "DIMNI" }, isUnique: true, isPrimaryKey: true)
    };
}
