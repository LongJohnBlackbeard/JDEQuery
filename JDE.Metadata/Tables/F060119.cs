...
public class F060119 : JdeTable
{
    ...
    public static class Columns
    {
        ...
        /// YESEQ#.
        /// </summary>
        public const string YESEQ_ = "YESEQ#";
    ...
    /// <inheritdoc />
    public override string TableName => "F060119";
    ...
    public override IReadOnlyList<IJdeField> Fields { get; } = new List<IJdeField>
    {
        ...
        new JdeField("YESEQ#", "YESEQ#", JdeDataType.Numeric, null, true, true),
        ...
        new JdeField("YEPTDT", "YEPTDT", JdeDataType.Numeric),
        ...
        new JdeField("YETRS", "YETRS", JdeDataType.String, 6, true, true),
        ...
        new JdeField("YEEFTO", "YEEFTO", JdeDataType.Numeric, null, true, true)
    };

    /// <inheritdoc />
    public override IReadOnlyList<IJdeIndex> Indexes { get; } = new List<IJdeIndex>
    {
        new JdeIndex("F060119_0", "Primary Key on YEAN8, YEHMCU, YEJBCD, YEJBST, YEEFTO, YETRS, YESEQ#", new[] { "YEAN8", "YEHMCU", "YEJBCD", "YEJBST", "YEEFTO", "YETRS", "YESEQ#" }, isUnique: true, isPrimaryKey: true),
        new JdeIndex("F060119_2", "Index on YEAN8, SYS_NC00061$", new[] { "YEAN8", "SYS_NC00061$" }),
        new JdeIndex("F060119_3", "Index on YEAN8, YEHMCU, YEJBCD, YEJBST, YEPTDT", new[] { "YEAN8", "YEHMCU", "YEJBCD", "YEJBST", "YEPTDT" }),
        new JdeIndex("F060119_4", "Index on YEAN8, SYS_NC00061$, YEHMCU, YEJBCD, YEJBST, SYS_NC00062$", new[] { "YEAN8", "SYS_NC00061$", "YEHMCU", "YEJBCD", "YEJBST", "SYS_NC00062$" }),
        new JdeIndex("F060119_6", "Index on YEAN8, YEEFTO, SYS_NC00063$", new[] { "YEAN8", "YEEFTO", "SYS_NC00063$" })
    };
}
