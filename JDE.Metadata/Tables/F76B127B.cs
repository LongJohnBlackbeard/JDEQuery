...
/// F76B127B - .
/// </summary>
public class F76B127B : JdeTable
{
    /// <summary>
    ...
    public static class Columns
    {
        ...
        /// TCBRNOP.
        /// </summary>
        public const string TCBRNOP = "TCBRNOP";

        /// <summary>
        /// TCBSOP.
        /// </summary>
        public const string TCBSOP = "TCBSOP";
    ...
    /// <inheritdoc />
    public override string TableName => "F76B127B";
    ...
    public override IReadOnlyList<IJdeField> Fields { get; } = new List<IJdeField>
    {
        ...
        new JdeField("TCBRNOP", "TCBRNOP", JdeDataType.String, 10, true, true),
        new JdeField("TCBSOP", "TCBSOP", JdeDataType.String, 4, true, true),
    ...
    {
        new JdeIndex("F76B127B_0", "Primary Key on TCGIDBC, TCBRNOP, TCBSOP", new[] { "TCGIDBC", "TCBRNOP", "TCBSOP" }, isUnique: true, isPrimaryKey: true),
        new JdeIndex("F76B127B_2", "Index on TCBRNOP, TCBSOP", new[] { "TCBRNOP", "TCBSOP" })
    };
}
