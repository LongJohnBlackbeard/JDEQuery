...
/// F03B41Z1 - .
/// </summary>
public class F03B41Z1 : JdeTable
{
    /// <summary>
    ...
    public static class Columns
    {
        ...
        /// SZDCID.
        /// </summary>
        public const string SZDCID = "SZDCID";

        /// <summary>
        /// SZDDSC.
        /// </summary>
        public const string SZDDSC = "SZDDSC";

        /// <summary>
        /// SZTDDA.
        /// </summary>
        public const string SZTDDA = "SZTDDA";
        ...
        /// SZDRSC.
        /// </summary>
        public const string SZDRSC = "SZDRSC";

        /// <summary>
        /// SZDMEC.
        /// </summary>
        public const string SZDMEC = "SZDMEC";
    ...
    /// <inheritdoc />
    public override string TableName => "F03B41Z1";
    ...
    public override IReadOnlyList<IJdeField> Fields { get; } = new List<IJdeField>
    {
        ...
        new JdeField("SZDCID", "SZDCID", JdeDataType.Numeric),
        new JdeField("SZDDSC", "SZDDSC", JdeDataType.String, 4),
        new JdeField("SZTDDA", "SZTDDA", JdeDataType.Numeric),
        new JdeField("SZTCRC", "SZTCRC", JdeDataType.String, 6),
        new JdeField("SZDGJ", "SZDGJ", JdeDataType.Numeric),
        new JdeField("SZDRSC", "SZDRSC", JdeDataType.String, 20),
        new JdeField("SZDMEC", "SZDMEC", JdeDataType.String, 20),
    ...
    {
        new JdeIndex("F03B41Z1_0", "Primary Key on SZEDUS, SZEDBT, SZEDTN, SZEDLN", new[] { "SZEDUS", "SZEDBT", "SZEDTN", "SZEDLN" }, isUnique: true, isPrimaryKey: true),
        new JdeIndex("F03B41Z1_2", "Index on SZDCID, SZEDTN", new[] { "SZDCID", "SZEDTN" })
    };
}
