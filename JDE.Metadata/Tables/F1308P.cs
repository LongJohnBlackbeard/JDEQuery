...
public class F1308P : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F1308P";
    ...
    {
        new JdeIndex("F1308P_0", "Primary Key on F0NUMB, F0SRVT, F0AAID", new[] { "F0NUMB", "F0SRVT", "F0AAID" }, isUnique: true, isPrimaryKey: true)
    };
}
