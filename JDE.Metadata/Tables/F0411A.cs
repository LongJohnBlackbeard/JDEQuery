...
public class F0411A : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F0411A";
    ...
    {
        new JdeIndex("F0411A_0", "Primary Key on RPAN8, RPDCT, RPDOC, RPKCO, RPSFX, RPSFXE", new[] { "RPAN8", "RPDCT", "RPDOC", "RPKCO", "RPSFX", "RPSFXE" }, isUnique: true, isPrimaryKey: true)
    };
}
