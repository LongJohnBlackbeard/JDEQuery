...
public class F078310 : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F078310";
    ...
    {
        new JdeIndex("F078310_0", "Primary Key on YFUKID", new[] { "YFUKID" }, isUnique: true, isPrimaryKey: true)
    };
}
