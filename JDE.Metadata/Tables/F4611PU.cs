...
public class F4611PU : JdeTable
{
    ...
    public static class Columns
    {
        ...
        /// R2DTE.
        /// </summary>
        public const string R2DTE = "R2DTE";

        /// <summary>
        /// R2TICU.
        /// </summary>
        public const string R2TICU = "R2TICU";

        /// <summary>
        /// R2SCHUSER.
        /// </summary>
        public const string R2SCHUSER = "R2SCHUSER";
    ...
    /// <inheritdoc />
    public override string TableName => "F4611PU";
    ...
    public override IReadOnlyList<IJdeField> Fields { get; } = new List<IJdeField>
    {
        ...
        new JdeField("R2DTE", "R2DTE", JdeDataType.Numeric),
        new JdeField("R2TICU", "R2TICU", JdeDataType.Numeric),
        new JdeField("R2SCHUSER", "R2SCHUSER", JdeDataType.String, 20),
    ...
    {
        new JdeIndex("F4611PU_0", "Primary Key on R2SGBT, R2SGSQ", new[] { "R2SGBT", "R2SGSQ" }, isUnique: true, isPrimaryKey: true)
    };
}
