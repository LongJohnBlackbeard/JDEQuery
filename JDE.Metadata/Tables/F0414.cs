...
public class F0414 : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F0414";
    ...
    {
        new JdeIndex("F0414_0", "Primary Key on RNPYID, RNRC5", new[] { "RNPYID", "RNRC5" }, isUnique: true, isPrimaryKey: true),
        new JdeIndex("F0414_2", "Index on RNPYID, RNPOST", new[] { "RNPYID", "RNPOST" }),
        new JdeIndex("F0414_3", "Index on RNDCT, RNDOC, RNKCO, RNSFX, RNSFXE", new[] { "RNDCT", "RNDOC", "RNKCO", "RNSFX", "RNSFXE" }),
        new JdeIndex("F0414_5", "Index on RNPYID, RNDCTM, RNDOC, RNDCT, RNKCO, RNSFX, RNSFXE", new[] { "RNPYID", "RNDCTM", "RNDOC", "RNDCT", "RNKCO", "RNSFX", "RNSFXE" }),
        new JdeIndex("F0414_6", "Index on RNAN8, RNDCT, RNDOC, RNKCO, RNSFX, RNSFXE", new[] { "RNAN8", "RNDCT", "RNDOC", "RNKCO", "RNSFX", "RNSFXE" }),
        new JdeIndex("F0414_7", "Index on RNDOC, RNDCT, RNKCO, RNSFX, RNSFXE, RNPYID", new[] { "RNDOC", "RNDCT", "RNKCO", "RNSFX", "RNSFXE", "RNPYID" }),
        new JdeIndex("F0414_8", "Index on RNNETTCID, RNNETDOC, RNNETRC5", new[] { "RNNETTCID", "RNNETDOC", "RNNETRC5" }),
        new JdeIndex("F0414_9", "Index on RNPYID, RNSFX, RNRC5", new[] { "RNPYID", "RNSFX", "RNRC5" })
    };
}
