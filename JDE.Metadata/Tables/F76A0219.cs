...
/// F76A0219 - .
/// </summary>
public class F76A0219 : JdeTable
{
    /// <summary>
    ...
    /// <inheritdoc />
    public override string TableName => "F76A0219";
    ...
    {
        new JdeIndex("F76A0219_0", "Primary Key on DLJOBS, DLCTID, DLDOC, DLDCT, DLKCO, DLSEQ", new[] { "DLJOBS", "DLCTID", "DLDOC", "DLDCT", "DLKCO", "DLSEQ" }, isUnique: true, isPrimaryKey: true)
    };
}
