...
public class F47077 : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F47077";
    ...
    {
        new JdeIndex("F47077_0", "Primary Key on SZEDOC, SZEDCT, SZEKCO, SZEDLN", new[] { "SZEDOC", "SZEDCT", "SZEKCO", "SZEDLN" }, isUnique: true, isPrimaryKey: true)
    };
}
