...
public class F1201 : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F1201";
    ...
    {
        new JdeIndex("F1201_0", "Primary Key on FANUMB", new[] { "FANUMB" }, isUnique: true, isPrimaryKey: true),
        new JdeIndex("F1201_11", "Index on FAKIT, FANUMB", new[] { "FAKIT", "FANUMB" }),
        new JdeIndex("F1201_12", "Index on FAAAID, FAASID", new[] { "FAAAID", "FAASID" }),
        new JdeIndex("F1201_13", "Index on FAACL1, FAACL2, FAACL3, FAACL4, FAACL5, FAACL6, FAACL7, FAACL8, FAACL9, FAACL0", new[] { "FAACL1", "FAACL2", "FAACL3", "FAACL4", "FAACL5", "FAACL6", "FAACL7", "FAACL8", "FAACL9", "FAACL0" }),
        new JdeIndex("F1201_14", "Index on FADL01", new[] { "FADL01" }),
        new JdeIndex("F1201_2", "Index on FAAPID", new[] { "FAAPID" }),
        new JdeIndex("F1201_3", "Index on FAASID", new[] { "FAASID" }),
        new JdeIndex("F1201_4", "Index on FAACL1, FAACL2, FANUMB", new[] { "FAACL1", "FAACL2", "FANUMB" }),
        new JdeIndex("F1201_5", "Index on FAAAID, FASEQ, FANUMB", new[] { "FAAAID", "FASEQ", "FANUMB" }),
        new JdeIndex("F1201_6", "Index on FAAAID", new[] { "FAAAID" }),
        new JdeIndex("F1201_7", "Index on FADSCC, FANUMB", new[] { "FADSCC", "FANUMB" }),
        new JdeIndex("F1201_8", "Index on FAMCU, FANUMB", new[] { "FAMCU", "FANUMB" }),
        new JdeIndex("F1201_9", "Index on FALOC, FANUMB", new[] { "FALOC", "FANUMB" })
    };
}
