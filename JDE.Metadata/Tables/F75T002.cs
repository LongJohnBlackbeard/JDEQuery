...
public class F75T002 : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F75T002";
    ...
    {
        new JdeIndex("F75T002_0", "Primary Key on NR75TUIP, NR75TGRF", new[] { "NR75TUIP", "NR75TGRF" }, isUnique: true, isPrimaryKey: true),
        new JdeIndex("F75T002_2", "Index on NRCO, NR75TDSI", new[] { "NRCO", "NR75TDSI" }),
        new JdeIndex("F75T002_3", "Index on NR75TUIP", new[] { "NR75TUIP" })
    };
}
