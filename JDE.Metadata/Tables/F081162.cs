...
public class F081162 : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F081162";
    ...
    {
        new JdeIndex("F081162_0", "Primary Key on APACAD", new[] { "APACAD" }, isUnique: true, isPrimaryKey: true)
    };
}
