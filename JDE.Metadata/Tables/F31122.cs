...
public class F31122 : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F31122";
    ...
    {
        new JdeIndex("F31122_0", "Primary Key on WTUKID", new[] { "WTUKID" }, isUnique: true, isPrimaryKey: true),
        new JdeIndex("F31122_1", "Index on WTYST, WTAN8, WTDGL", new[] { "WTYST", "WTAN8", "WTDGL" }),
        new JdeIndex("F31122_10", "Index on WTDOCO, WTOPSQ, WTTYR, WTPID", new[] { "WTDOCO", "WTOPSQ", "WTTYR", "WTPID" }),
        new JdeIndex("F31122_11", "Index on WTAN8, WTURDT, WTDOCO, WTOPSQ, WTTYR", new[] { "WTAN8", "WTURDT", "WTDOCO", "WTOPSQ", "WTTYR" }),
        new JdeIndex("F31122_2", "Index on WTYST, WTUSER, WTUPMJ, WTPBDT", new[] { "WTYST", "WTUSER", "WTUPMJ", "WTPBDT" }),
        new JdeIndex("F31122_3", "Index on WTYST, WTDOCO, WTDGL, WTOPSQ, WTTYR", new[] { "WTYST", "WTDOCO", "WTDGL", "WTOPSQ", "WTTYR" }),
        new JdeIndex("F31122_4", "Index on WTPRTR, WTYST, WTTYR", new[] { "WTPRTR", "WTYST", "WTTYR" }),
        new JdeIndex("F31122_5", "Index on WTYST, WTSUMR, WTDOCO, WTDCTO, WTOPSQ, WTTYR", new[] { "WTYST", "WTSUMR", "WTDOCO", "WTDCTO", "WTOPSQ", "WTTYR" }),
        new JdeIndex("F31122_7", "Index on WTDOCO, WTYST, WTOPSQ, WTTYR", new[] { "WTDOCO", "WTYST", "WTOPSQ", "WTTYR" }),
        new JdeIndex("F31122_8", "Index on WTYST, WTDOCO, WTDCTO, WTDGL, WTSHFT, WTOPSQ, WTTYR", new[] { "WTYST", "WTDOCO", "WTDCTO", "WTDGL", "WTSHFT", "WTOPSQ", "WTTYR" }),
        new JdeIndex("F31122_9", "Index on WTAN8, WTYST, WTOPSQ, WTTYR", new[] { "WTAN8", "WTYST", "WTOPSQ", "WTTYR" })
    };
}
