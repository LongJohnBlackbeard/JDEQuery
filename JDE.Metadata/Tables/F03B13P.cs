...
public class F03B13P : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F03B13P";
    ...
    {
        new JdeIndex("F03B13P_0", "Primary Key on RYPYID", new[] { "RYPYID" }, isUnique: true, isPrimaryKey: true)
    };
}
