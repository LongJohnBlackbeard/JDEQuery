...
/// FY5AFX05 - .
/// </summary>
public class FY5AFX05 : JdeTable
{
    /// <summary>
    ...
    public static class Columns
    {
        ...
        /// DIY5AFOTID.
        /// </summary>
        public const string DIY5AFOTID = "DIY5AFOTID";
    }

    /// <inheritdoc />
    public override string TableName => "FY5AFX05";
    ...
    public override IReadOnlyList<IJdeField> Fields { get; } = new List<IJdeField>
    {
        ...
        new JdeField("DIY5AFOTID", "DIY5AFOTID", JdeDataType.String, 72)
    };

    /// <inheritdoc />
    public override IReadOnlyList<IJdeIndex> Indexes { get; } = new List<IJdeIndex>
    {
        new JdeIndex("FY5AFX05_0", "Primary Key on DITASKID", new[] { "DITASKID" }, isUnique: true, isPrimaryKey: true),
        new JdeIndex("FY5AFX05_10", "Index on DIY5AFOTID", new[] { "DIY5AFOTID" }),
        new JdeIndex("FY5AFX05_2", "Index on DITASKNM", new[] { "DITASKNM" }),
        new JdeIndex("FY5AFX05_3", "Index on DIOBNM, DIVER, DIFMNM", new[] { "DIOBNM", "DIVER", "DIFMNM" }),
        new JdeIndex("FY5AFX05_4", "Index on DITASKTYPE", new[] { "DITASKTYPE" }),
        new JdeIndex("FY5AFX05_5", "Index on DIRULEID", new[] { "DIRULEID" }),
        new JdeIndex("FY5AFX05_6", "Index on DIFUFTASK4", new[] { "DIFUFTASK4" }),
        new JdeIndex("FY5AFX05_7", "Index on DIFUFTASK4, DIFUFTASK6", new[] { "DIFUFTASK4", "DIFUFTASK6" }),
        new JdeIndex("FY5AFX05_8", "Index on DIFUFTASK7", new[] { "DIFUFTASK7" }),
        new JdeIndex("FY5AFX05_9", "Index on DISY, DITASCKACT, DITASKID", new[] { "DISY", "DITASCKACT", "DITASKID" })
    };
}
