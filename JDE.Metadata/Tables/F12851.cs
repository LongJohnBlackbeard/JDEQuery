...
public class F12851 : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F12851";
    ...
    {
        new JdeIndex("F12851_0", "Primary Key on LUADM, LUADLM, LUITAC, LUDIR1, LUDTFR, LUEFTB", new[] { "LUADM", "LUADLM", "LUITAC", "LUDIR1", "LUDTFR", "LUEFTB" }, isUnique: true, isPrimaryKey: true)
    };
}
