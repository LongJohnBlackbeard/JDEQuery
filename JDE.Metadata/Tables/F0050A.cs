...
public class F0050A : JdeTable
{
    ...
    public static class Columns
    {
        ...
        /// MAOSNM.
        /// </summary>
        public const string MAOSNM = "MAOSNM";
    ...
    /// <inheritdoc />
    public override string TableName => "F0050A";
    ...
    {
        new JdeField("MAOSNM", "MAOSNM", JdeDataType.String, 20, true, true),
    ...
    {
        new JdeIndex("F0050A_0", "Primary Key on MAOSNM", new[] { "MAOSNM" }, isUnique: true, isPrimaryKey: true)
    };
}
