...
/// F75I396A - .
/// </summary>
public class F75I396A : JdeTable
{
    /// <summary>
    ...
    /// <inheritdoc />
    public override string TableName => "F75I396A";
    ...
    {
        new JdeIndex("F75I396A_0", "Primary Key on ESITM, ESSTRX", new[] { "ESITM", "ESSTRX" }, isUnique: true, isPrimaryKey: true)
    };
}
