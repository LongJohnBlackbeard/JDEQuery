...
public class F47123 : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F47123";
    ...
    {
        new JdeIndex("F47123_0", "Primary Key on MKEDOC, MKEDCT, MKEKCO, MKEDLN, MKUITM, MKSEQN", new[] { "MKEDOC", "MKEDCT", "MKEKCO", "MKEDLN", "MKUITM", "MKSEQN" }, isUnique: true, isPrimaryKey: true)
    };
}
