...
/// F7400001 - .
/// </summary>
public class F7400001 : JdeTable
{
    /// <summary>
    ...
    /// <inheritdoc />
    public override string TableName => "F7400001";
    ...
    {
        new JdeIndex("F7400001_0", "Primary Key on NNK74LECO, NNK74LEDT, NNK74ISPL", new[] { "NNK74LECO", "NNK74LEDT", "NNK74ISPL" }, isUnique: true, isPrimaryKey: true)
    };
}
