...
public class F0116T : JdeTable
{
    ...
    public static class Columns
    {
        ...
        /// ALUOID.
        /// </summary>
        public const string ALUOID = "ALUOID";

        /// <summary>
        /// ALALPH.
        /// </summary>
        public const string ALALPH = "ALALPH";
    }

    /// <inheritdoc />
    public override string TableName => "F0116T";
    ...
    public override IReadOnlyList<IJdeField> Fields { get; } = new List<IJdeField>
    {
        ...
        new JdeField("ALUOID", "ALUOID", JdeDataType.String, 100),
        new JdeField("ALALPH", "ALALPH", JdeDataType.String, 80)
    };

    /// <inheritdoc />
    public override IReadOnlyList<IJdeIndex> Indexes { get; } = new List<IJdeIndex>
    {
        new JdeIndex("F0116T_0", "Primary Key on ALAN8, ALEFTB", new[] { "ALAN8", "ALEFTB" }, isUnique: true, isPrimaryKey: true),
        new JdeIndex("F0116T_2", "Index on ALUOID", new[] { "ALUOID" })
    };
}
