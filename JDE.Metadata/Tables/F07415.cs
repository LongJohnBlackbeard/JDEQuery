...
public class F07415 : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F07415";
    ...
    {
        new JdeIndex("F07415_0", "Primary Key on NHUKID", new[] { "NHUKID" }, isUnique: true, isPrimaryKey: true)
    };
}
