...
/// FY5AGX03 - .
/// </summary>
public class FY5AGX03 : JdeTable
{
    /// <summary>
    ...
    /// <inheritdoc />
    public override string TableName => "FY5AGX03";
    ...
    {
        new JdeIndex("FY5AGX03_0", "Primary Key on DIMNI, DISELN, DILNGP", new[] { "DIMNI", "DISELN", "DILNGP" }, isUnique: true, isPrimaryKey: true),
        new JdeIndex("FY5AGX03_2", "Unique Index on DIMNI, DILNGP, DISELN", new[] { "DIMNI", "DILNGP", "DISELN" }, isUnique: true)
    };
}
