...
public class F15016B : JdeTable
{
    ...
    public static class Columns
    {
        ...
        /// NULSVR.
        /// </summary>
        public const string NULSVR = "NULSVR";
        ...
        /// NUSUDT.
        /// </summary>
        public const string NUSUDT = "NUSUDT";
        ...
        /// NUBCI3.
        /// </summary>
        public const string NUBCI3 = "NUBCI3";
        ...
        /// NUVRSC.
        /// </summary>
        public const string NUVRSC = "NUVRSC";

        /// <summary>
        /// NUURCD.
        /// </summary>
        public const string NUURCD = "NUURCD";

        /// <summary>
        /// NUURDT.
        /// </summary>
        public const string NUURDT = "NUURDT";

        /// <summary>
        /// NUURAT.
        /// </summary>
        public const string NUURAT = "NUURAT";

        /// <summary>
        /// NUURAB.
        /// </summary>
        public const string NUURAB = "NUURAB";

        /// <summary>
        /// NUURRF.
        /// </summary>
        public const string NUURRF = "NUURRF";
        ...
        /// NUENTJ.
        /// </summary>
        public const string NUENTJ = "NUENTJ";

        /// <summary>
        /// NUTORG.
        /// </summary>
        public const string NUTORG = "NUTORG";

        /// <summary>
        /// NUCRR.
        /// </summary>
        public const string NUCRR = "NUCRR";

        /// <summary>
        /// NUNUMB.
        /// </summary>
        public const string NUNUMB = "NUNUMB";

        /// <summary>
        /// NULZNPA.
        /// </summary>
        public const string NULZNPA = "NULZNPA";
    }

    /// <inheritdoc />
    public override string TableName => "F15016B";
    ...
    public override IReadOnlyList<IJdeField> Fields { get; } = new List<IJdeField>
    {
        ...
        new JdeField("NULSVR", "NULSVR", JdeDataType.Numeric),
        ...
        new JdeField("NUSUDT", "NUSUDT", JdeDataType.Numeric),
        ...
        new JdeField("NUBCI3", "NUBCI3", JdeDataType.Numeric),
        ...
        new JdeField("NUVRSC", "NUVRSC", JdeDataType.String, 2),
        new JdeField("NUURCD", "NUURCD", JdeDataType.String, 4),
        new JdeField("NUURDT", "NUURDT", JdeDataType.Numeric),
        new JdeField("NUURAT", "NUURAT", JdeDataType.Numeric),
        new JdeField("NUURAB", "NUURAB", JdeDataType.Numeric),
        new JdeField("NUURRF", "NUURRF", JdeDataType.String, 30),
        ...
        new JdeField("NUENTJ", "NUENTJ", JdeDataType.Numeric),
        new JdeField("NUTORG", "NUTORG", JdeDataType.String, 20),
        new JdeField("NUCRR", "NUCRR", JdeDataType.Numeric),
        new JdeField("NUNUMB", "NUNUMB", JdeDataType.Numeric),
        new JdeField("NULZNPA", "NULZNPA", JdeDataType.String, 2)
    };

    /// <inheritdoc />
    public override IReadOnlyList<IJdeIndex> Indexes { get; } = new List<IJdeIndex>
    {
        new JdeIndex("F15016B_0", "Primary Key on NUDOCO, NUBCI", new[] { "NUDOCO", "NUBCI" }, isUnique: true, isPrimaryKey: true),
        new JdeIndex("F15016B_2", "Index on NUMCU", new[] { "NUMCU" }),
        new JdeIndex("F15016B_3", "Index on NUBLFC", new[] { "NUBLFC" }),
        new JdeIndex("F15016B_4", "Index on NUDOCO, NUMCU, NUUNIT", new[] { "NUDOCO", "NUMCU", "NUUNIT" })
    };
}
