...
public class F47147T : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F47147T";
    ...
    {
        new JdeIndex("F47147T_0", "Primary Key on UZEDOC, UZEDCT, UZEKCO, UZEDLN", new[] { "UZEDOC", "UZEDCT", "UZEKCO", "UZEDLN" }, isUnique: true, isPrimaryKey: true)
    };
}
