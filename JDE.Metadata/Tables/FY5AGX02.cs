...
/// FY5AGX02 - .
/// </summary>
public class FY5AGX02 : JdeTable
{
    /// <summary>
    ...
    /// <inheritdoc />
    public override string TableName => "FY5AGX02";
    ...
    {
        new JdeIndex("FY5AGX02_0", "Primary Key on DIMNI, DISELN", new[] { "DIMNI", "DISELN" }, isUnique: true, isPrimaryKey: true),
        new JdeIndex("FY5AGX02_2", "Index on DIJTOE, DIMNI, DISLTY", new[] { "DIJTOE", "DIMNI", "DISLTY" }),
        new JdeIndex("FY5AGX02_3", "Index on DIMNI, DIMTOE, DISLTY", new[] { "DIMNI", "DIMTOE", "DISLTY" }),
        new JdeIndex("FY5AGX02_4", "Index on DIMNI, DISLTY", new[] { "DIMNI", "DISLTY" }),
        new JdeIndex("FY5AGX02_5", "Index on DIOPKY, DIVER, DIMNI, DISLTY", new[] { "DIOPKY", "DIVER", "DIMNI", "DISLTY" }),
        new JdeIndex("FY5AGX02_6", "Index on DIOBNM, DIVER, DIMNI, DISLTY", new[] { "DIOBNM", "DIVER", "DIMNI", "DISLTY" })
    };
}
