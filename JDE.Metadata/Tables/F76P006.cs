...
public class F76P006 : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F76P006";
    ...
    {
        new JdeIndex("F76P006_0", "Primary Key on LRDCT, LRH76CC02", new[] { "LRDCT", "LRH76CC02" }, isUnique: true, isPrimaryKey: true)
    };
}
