...
public class F4011Z : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F4011Z";
    ...
    {
        new JdeIndex("F4011Z_0", "Primary Key on SZEDOC, SZEDCT, SZEKCO, SZEDLN", new[] { "SZEDOC", "SZEDCT", "SZEKCO", "SZEDLN" }, isUnique: true, isPrimaryKey: true)
    };
}
