...
public class F5301B : JdeTable
{
    ...
    public static class Columns
    {
        ...
        /// DIPPCO.
        /// </summary>
        public const string DIPPCO = "DIPPCO";
        ...
        /// DIEXTD.
        /// </summary>
        public const string DIEXTD = "DIEXTD";

        /// <summary>
        /// DIRQDD.
        /// </summary>
        public const string DIRQDD = "DIRQDD";

        /// <summary>
        /// DICSCH.
        /// </summary>
        public const string DICSCH = "DICSCH";

        /// <summary>
        /// DICRRM.
        /// </summary>
        public const string DICRRM = "DICRRM";

        /// <summary>
        /// DICRCD.
        /// </summary>
        public const string DICRCD = "DICRCD";

        /// <summary>
        /// DICRR.
        /// </summary>
        public const string DICRR = "DICRR";
    ...
    /// <inheritdoc />
    public override string TableName => "F5301B";
    ...
    public override IReadOnlyList<IJdeField> Fields { get; } = new List<IJdeField>
    {
        ...
        new JdeField("DIPPCO", "DIPPCO", JdeDataType.Numeric),
        ...
        new JdeField("DIEXTD", "DIEXTD", JdeDataType.Numeric),
        new JdeField("DIRQDD", "DIRQDD", JdeDataType.Numeric),
        new JdeField("DICSCH", "DICSCH", JdeDataType.String, 2),
        new JdeField("DICRRM", "DICRRM", JdeDataType.String, 2),
        new JdeField("DICRCD", "DICRCD", JdeDataType.String, 6),
        new JdeField("DICRR", "DICRR", JdeDataType.Numeric),
    ...
    {
        new JdeIndex("F5301B_0", "Primary Key on DIMCU, DICONO", new[] { "DIMCU", "DICONO" }, isUnique: true, isPrimaryKey: true),
        new JdeIndex("F5301B_2", "Index on DIMCU, DICONO, DITYPB, DIPRTC", new[] { "DIMCU", "DICONO", "DITYPB", "DIPRTC" }),
        new JdeIndex("F5301B_3", "Index on DIANO, DICONO, DIBSTC, DIPRTC", new[] { "DIANO", "DICONO", "DIBSTC", "DIPRTC" }),
        new JdeIndex("F5301B_4", "Index on DICRFC, DICONO, DIBSTC, DIPRTC", new[] { "DICRFC", "DICONO", "DIBSTC", "DIPRTC" }),
        new JdeIndex("F5301B_5", "Index on DIAPRV, DICONO, DIBSTC, DIPRTC", new[] { "DIAPRV", "DICONO", "DIBSTC", "DIPRTC" }),
        new JdeIndex("F5301B_6", "Index on DICRF3, DICONO, DIBSTC, DIPRTC", new[] { "DICRF3", "DICONO", "DIBSTC", "DIPRTC" }),
        new JdeIndex("F5301B_7", "Index on DIMCU, DIPPCO, DICONO", new[] { "DIMCU", "DIPPCO", "DICONO" }),
        new JdeIndex("F5301B_8", "Index on DIMCU, SYS_NC00049$", new[] { "DIMCU", "SYS_NC00049$" })
    };
}
