...
/// F7420011 - .
/// </summary>
public class F7420011 : JdeTable
{
    /// <summary>
    ...
    /// <inheritdoc />
    public override string TableName => "F7420011";
    ...
    {
        new JdeIndex("F7420011_0", "Primary Key on SLKCOO, SLDCTO, SLDOCO, SLLNID, SLKCO, SLDCT, SLDOC", new[] { "SLKCOO", "SLDCTO", "SLDOCO", "SLLNID", "SLKCO", "SLDCT", "SLDOC" }, isUnique: true, isPrimaryKey: true),
        new JdeIndex("F7420011_2", "Index on SLKCO, SLDCT, SLDOC", new[] { "SLKCO", "SLDCT", "SLDOC" })
    };
}
