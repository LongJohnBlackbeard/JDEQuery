...
public class F470563 : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F470563";
    ...
    {
        new JdeIndex("F470563_0", "Primary Key on D5EDTY, D5EDSQ, D5EKCO, D5EDOC, D5EDCT, D5EDLN", new[] { "D5EDTY", "D5EDSQ", "D5EKCO", "D5EDOC", "D5EDCT", "D5EDLN" }, isUnique: true, isPrimaryKey: true)
    };
}
