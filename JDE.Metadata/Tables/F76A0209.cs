...
/// F76A0209 - .
/// </summary>
public class F76A0209 : JdeTable
{
    /// <summary>
    ...
    /// <inheritdoc />
    public override string TableName => "F76A0209";
    ...
    {
        new JdeIndex("F76A0209_0", "Primary Key on HFJOBS, HFCTID, HFDOC, HFDCT, HFKCO", new[] { "HFJOBS", "HFCTID", "HFDOC", "HFDCT", "HFKCO" }, isUnique: true, isPrimaryKey: true),
        new JdeIndex("F76A0209_2", "Index on HFJOBS, HFCTID, HFARYO, HFINTY, HFEV01", new[] { "HFJOBS", "HFCTID", "HFARYO", "HFINTY", "HFEV01" })
    };
}
