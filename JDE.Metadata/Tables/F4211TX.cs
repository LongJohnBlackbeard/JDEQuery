...
public class F4211TX : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F4211TX";
    ...
    {
        new JdeIndex("F4211TX_0", "Primary Key on DTDOCO, DTDCTO, DTKCOO, DTLNID", new[] { "DTDOCO", "DTDCTO", "DTKCOO", "DTLNID" }, isUnique: true, isPrimaryKey: true)
    };
}
