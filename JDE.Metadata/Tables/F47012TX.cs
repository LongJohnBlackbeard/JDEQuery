...
/// F47012TX - .
/// </summary>
public class F47012TX : JdeTable
{
    /// <summary>
    ...
    /// <inheritdoc />
    public override string TableName => "F47012TX";
    ...
    {
        new JdeIndex("F47012TX_0", "Primary Key on DTEDOC, DTEDCT, DTEKCO, DTEDLN", new[] { "DTEDOC", "DTEDCT", "DTEKCO", "DTEDLN" }, isUnique: true, isPrimaryKey: true)
    };
}
