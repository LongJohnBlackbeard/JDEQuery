...
public class F07490 : JdeTable
{
    ...
    public static class Columns
    {
        ...
        /// JRPAYD.
        /// </summary>
        public const string JRPAYD = "JRPAYD";
        ...
        /// JRUKID.
        /// </summary>
        public const string JRUKID = "JRUKID";
    }

    /// <inheritdoc />
    public override string TableName => "F07490";
    ...
    {
        new JdeField("JRPAYD", "JRPAYD", JdeDataType.String, 20, true, true),
        new JdeField("JRICU", "JRICU", JdeDataType.Numeric, null, true, true),
        new JdeField("JRANN8", "JRANN8", JdeDataType.Numeric),
        new JdeField("JRAPTF", "JRAPTF", JdeDataType.String, 2),
        new JdeField("JRCTL2", "JRCTL2", JdeDataType.String, 62),
        ...
        new JdeField("JRUKID", "JRUKID", JdeDataType.Numeric, null, true, true)
    };

    /// <inheritdoc />
    public override IReadOnlyList<IJdeIndex> Indexes { get; } = new List<IJdeIndex>
    {
        new JdeIndex("F07490_0", "Primary Key on JRPAYD, JRICU, JRUKID", new[] { "JRPAYD", "JRICU", "JRUKID" }, isUnique: true, isPrimaryKey: true),
        new JdeIndex("F07490_5", "Index on JRPAYD, JRICU, JRANN8, JRAPTF, JRCTL2, JRAN8", new[] { "JRPAYD", "JRICU", "JRANN8", "JRAPTF", "JRCTL2", "JRAN8" }),
        new JdeIndex("F07490_6", "Index on JRAN8, JRCO, JRPAYD, JRAPTF, JRCTL2", new[] { "JRAN8", "JRCO", "JRPAYD", "JRAPTF", "JRCTL2" }),
        new JdeIndex("F07490_7", "Index on JRPAYD, JRICU, JRANN8, JRAPTF, JRCTL2, JRANI", new[] { "JRPAYD", "JRICU", "JRANN8", "JRAPTF", "JRCTL2", "JRANI" })
    };
}
