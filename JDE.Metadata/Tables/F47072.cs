...
public class F47072 : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F47072";
    ...
    {
        new JdeIndex("F47072_0", "Primary Key on SZEDOC, SZEDCT, SZEKCO, SZEDLN", new[] { "SZEDOC", "SZEDCT", "SZEKCO", "SZEDLN" }, isUnique: true, isPrimaryKey: true)
    };
}
