...
/// F75I810T - .
/// </summary>
public class F75I810T : JdeTable
{
    /// <summary>
    ...
    public static class Columns
    {
        ...
        /// GTSFXE.
        /// </summary>
        public const string GTSFXE = "GTSFXE";
    ...
    /// <inheritdoc />
    public override string TableName => "F75I810T";
    ...
    public override IReadOnlyList<IJdeField> Fields { get; } = new List<IJdeField>
    {
        ...
        new JdeField("GTSFXE", "GTSFXE", JdeDataType.Numeric, null, true, true),
    ...
    {
        new JdeIndex("F75I810T_0", "Primary Key on GTKCO, GTDOC, GTDCT, GTSFX, GTSFXE", new[] { "GTKCO", "GTDOC", "GTDCT", "GTSFX", "GTSFXE" }, isUnique: true, isPrimaryKey: true)
    };
}
