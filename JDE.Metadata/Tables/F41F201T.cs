...
/// F41F201T - .
/// </summary>
public class F41F201T : JdeTable
{
    /// <summary>
    ...
    /// <inheritdoc />
    public override string TableName => "F41F201T";
    ...
    {
        new JdeIndex("F41F201T_0", "Primary Key on APDOCO, APDCTO, APKCOO", new[] { "APDOCO", "APDCTO", "APKCOO" }, isUnique: true, isPrimaryKey: true)
    };
}
