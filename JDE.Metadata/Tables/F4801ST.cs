...
public class F4801ST : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F4801ST";
    ...
    {
        new JdeIndex("F4801ST_0", "Primary Key on WADOCO", new[] { "WADOCO" }, isUnique: true, isPrimaryKey: true)
    };
}
