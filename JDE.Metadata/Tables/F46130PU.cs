...
/// F46130PU - .
/// </summary>
public class F46130PU : JdeTable
{
    /// <summary>
    ...
    public static class Columns
    {
        ...
        /// R3DTE.
        /// </summary>
        public const string R3DTE = "R3DTE";

        /// <summary>
        /// R3TICU.
        /// </summary>
        public const string R3TICU = "R3TICU";

        /// <summary>
        /// R3SCHUSER.
        /// </summary>
        public const string R3SCHUSER = "R3SCHUSER";
    }

    /// <inheritdoc />
    public override string TableName => "F46130PU";
    ...
    public override IReadOnlyList<IJdeField> Fields { get; } = new List<IJdeField>
    {
        ...
        new JdeField("R3DTE", "R3DTE", JdeDataType.Numeric),
        new JdeField("R3TICU", "R3TICU", JdeDataType.Numeric),
        new JdeField("R3SCHUSER", "R3SCHUSER", JdeDataType.String, 20)
    };

    /// <inheritdoc />
    public override IReadOnlyList<IJdeIndex> Indexes { get; } = new List<IJdeIndex>
    {
        new JdeIndex("F46130PU_0", "Primary Key on R3DOCO, R3DCTO, R3KCOO, R3LNID, R3SEQ", new[] { "R3DOCO", "R3DCTO", "R3KCOO", "R3LNID", "R3SEQ" }, isUnique: true, isPrimaryKey: true)
    };
}
