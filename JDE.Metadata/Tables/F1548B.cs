...
public class F1548B : JdeTable
{
    ...
    public static class Columns
    {
        ...
        /// N1LSVR.
        /// </summary>
        public const string N1LSVR = "N1LSVR";
        ...
        /// N1BCI3.
        /// </summary>
        public const string N1BCI3 = "N1BCI3";
        ...
        /// N1PPUP.
        /// </summary>
        public const string N1PPUP = "N1PPUP";
        ...
        /// N1CRCD.
        /// </summary>
        public const string N1CRCD = "N1CRCD";

        /// <summary>
        /// N1CRR.
        /// </summary>
        public const string N1CRR = "N1CRR";

        /// <summary>
        /// N1CRRM.
        /// </summary>
        public const string N1CRRM = "N1CRRM";

        /// <summary>
        /// N1NUMB.
        /// </summary>
        public const string N1NUMB = "N1NUMB";

        /// <summary>
        /// N1LZNPA.
        /// </summary>
        public const string N1LZNPA = "N1LZNPA";
    }

    /// <inheritdoc />
    public override string TableName => "F1548B";
    ...
    public override IReadOnlyList<IJdeField> Fields { get; } = new List<IJdeField>
    {
        ...
        new JdeField("N1LSVR", "N1LSVR", JdeDataType.Numeric),
        new JdeField("N1ICU", "N1ICU", JdeDataType.Numeric, null, true, true),
        ...
        new JdeField("N1BCI", "N1BCI", JdeDataType.Numeric, null, true, true),
        new JdeField("N1BCI3", "N1BCI3", JdeDataType.Numeric),
        ...
        new JdeField("N1PPUP", "N1PPUP", JdeDataType.String, 2),
        ...
        new JdeField("N1CRCD", "N1CRCD", JdeDataType.String, 6),
        new JdeField("N1CRR", "N1CRR", JdeDataType.Numeric),
        new JdeField("N1CRRM", "N1CRRM", JdeDataType.String, 2),
        new JdeField("N1NUMB", "N1NUMB", JdeDataType.Numeric),
        new JdeField("N1LZNPA", "N1LZNPA", JdeDataType.String, 2)
    };

    /// <inheritdoc />
    public override IReadOnlyList<IJdeIndex> Indexes { get; } = new List<IJdeIndex>
    {
        new JdeIndex("F1548B_0", "Primary Key on N1ICU, N1DOCO, N1BCI", new[] { "N1ICU", "N1DOCO", "N1BCI" }, isUnique: true, isPrimaryKey: true)
    };
}
