...
public class F0006Z1 : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F0006Z1";
    ...
    {
        new JdeIndex("F0006Z1_0", "Primary Key on SZEDUS, SZEDBT, SZEDTN, SZEDLN", new[] { "SZEDUS", "SZEDBT", "SZEDTN", "SZEDLN" }, isUnique: true, isPrimaryKey: true)
    };
}
