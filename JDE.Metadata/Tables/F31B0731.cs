...
/// F31B0731 - .
/// </summary>
public class F31B0731 : JdeTable
{
    /// <summary>
    ...
    public static class Columns
    {
        ...
        /// WSWSLOSS.
        /// </summary>
        public const string WSWSLOSS = "WSWSLOSS";

        /// <summary>
        /// WSCYIELD.
        /// </summary>
        public const string WSCYIELD = "WSCYIELD";

        /// <summary>
        /// WSYIELDP.
        /// </summary>
        public const string WSYIELDP = "WSYIELDP";
    ...
    /// <inheritdoc />
    public override string TableName => "F31B0731";
    ...
    public override IReadOnlyList<IJdeField> Fields { get; } = new List<IJdeField>
    {
        ...
        new JdeField("WSWSLOSS", "WSWSLOSS", JdeDataType.Numeric),
        new JdeField("WSCYIELD", "WSCYIELD", JdeDataType.Numeric),
        new JdeField("WSYIELDP", "WSYIELDP", JdeDataType.Numeric),
    ...
    {
        new JdeIndex("F31B0731_0", "Primary Key on WSEURID, WSWISSC", new[] { "WSEURID", "WSWISSC" }, isUnique: true, isPrimaryKey: true)
    };
}
