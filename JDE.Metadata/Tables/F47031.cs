...
public class F47031 : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F47031";
    ...
    {
        new JdeIndex("F47031_0", "Primary Key on SYEDOC, SYEDCT, SYEKCO", new[] { "SYEDOC", "SYEDCT", "SYEKCO" }, isUnique: true, isPrimaryKey: true)
    };
}
