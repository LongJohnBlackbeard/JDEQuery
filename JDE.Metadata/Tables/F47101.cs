...
public class F47101 : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F47101";
    ...
    {
        new JdeIndex("F47101_0", "Primary Key on SYEDOC, SYEDCT, SYEKCO", new[] { "SYEDOC", "SYEDCT", "SYEKCO" }, isUnique: true, isPrimaryKey: true)
    };
}
