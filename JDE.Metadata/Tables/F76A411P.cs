...
/// F76A411P - .
/// </summary>
public class F76A411P : JdeTable
{
    /// <summary>
    ...
    /// <inheritdoc />
    public override string TableName => "F76A411P";
    ...
    {
        new JdeIndex("F76A411P_0", "Primary Key on B2DOC, B2DCT, B2KCO, B2SFX, B2SFXE", new[] { "B2DOC", "B2DCT", "B2KCO", "B2SFX", "B2SFXE" }, isUnique: true, isPrimaryKey: true)
    };
}
