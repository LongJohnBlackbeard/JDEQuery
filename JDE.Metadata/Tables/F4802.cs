...
public class F4802 : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F4802";
    ...
    {
        new JdeIndex("F4802_0", "Primary Key on WBDOCO, WBDCTO, WBSFXO, WBTYPR, WBLINS", new[] { "WBDOCO", "WBDCTO", "WBSFXO", "WBTYPR", "WBLINS" }, isUnique: true, isPrimaryKey: true),
        new JdeIndex("F4802_2", "Index on WBDOCO, WBTYPR", new[] { "WBDOCO", "WBTYPR" }),
        new JdeIndex("F4802_3", "Index on WBDOCO, WBDCTO, WBTYPR, WBLINS", new[] { "WBDOCO", "WBDCTO", "WBTYPR", "WBLINS" })
    };
}
