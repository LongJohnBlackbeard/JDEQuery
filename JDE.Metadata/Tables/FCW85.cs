...
public class FCW85 : JdeTable
{
    ...
    public static class Columns
    {
        ...
        /// IEEV01.
        /// </summary>
        public const string IEEV01 = "IEEV01";
    ...
    /// <inheritdoc />
    public override string TableName => "FCW85";
    ...
    public override IReadOnlyList<IJdeField> Fields { get; } = new List<IJdeField>
    {
        ...
        new JdeField("IEEV01", "IEEV01", JdeDataType.String, 2, true, true),
    ...
    {
        new JdeIndex("FCW85_0", "Primary Key on IEITM, IEEV01, IEMMCU, IELOCN, IELOTN, IELEDG, IECOST", new[] { "IEITM", "IEEV01", "IEMMCU", "IELOCN", "IELOTN", "IELEDG", "IECOST" }, isUnique: true, isPrimaryKey: true),
        new JdeIndex("FCW85_2", "Index on IEITM, IEEV01, IEMMCU, IELOCN, IELEDG, IECOST", new[] { "IEITM", "IEEV01", "IEMMCU", "IELOCN", "IELEDG", "IECOST" })
    };
}
