...
public class F75I402 : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F75I402";
    ...
    {
        new JdeIndex("F75I402_0", "Primary Key on PTKCOO, PTDOCO, PTDCTO, PTLNID, PTNLIN, PTDOC", new[] { "PTKCOO", "PTDOCO", "PTDCTO", "PTLNID", "PTNLIN", "PTDOC" }, isUnique: true, isPrimaryKey: true),
        new JdeIndex("F75I402_2", "Index on PTUSER, PTJOBN, PTPID, PTUPMJ, PTTDAY, PTEF01", new[] { "PTUSER", "PTJOBN", "PTPID", "PTUPMJ", "PTTDAY", "PTEF01" }),
        new JdeIndex("F75I402_3", "Index on PTKCOO, PTDOCO, PTDCTO, PTLNID, PTDOC", new[] { "PTKCOO", "PTDOCO", "PTDCTO", "PTLNID", "PTDOC" })
    };
}
