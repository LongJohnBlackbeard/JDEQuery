...
/// FY5AHX11 - .
/// </summary>
public class FY5AHX11 : JdeTable
{
    /// <summary>
    ...
    /// <inheritdoc />
    public override string TableName => "FY5AHX11";
    ...
    public override IReadOnlyList<IJdeField> Fields { get; } = new List<IJdeField>
    {
        ...
        new JdeField("SDY5AHOBNM", "SDY5AHOBNM", JdeDataType.String, 20),
    ...
    {
        new JdeIndex("FY5AHX11_0", "Primary Key on SDY5AHE1RL, SDY5AHMDID, SDY5AHDTID, SDY5AHITEM, SDY5AHVSNM", new[] { "SDY5AHE1RL", "SDY5AHMDID", "SDY5AHDTID", "SDY5AHITEM", "SDY5AHVSNM" }, isUnique: true, isPrimaryKey: true)
    };
}
