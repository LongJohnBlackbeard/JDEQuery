...
public class F078329 : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F078329";
    ...
    {
        new JdeIndex("F078329_0", "Primary Key on YFUKID", new[] { "YFUKID" }, isUnique: true, isPrimaryKey: true)
    };
}
