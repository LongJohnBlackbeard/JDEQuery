...
/// F74R3B14 - .
/// </summary>
public class F74R3B14 : JdeTable
{
    /// <summary>
    ...
    public static class Columns
    {
        ...
        /// TFCKNU.
        /// </summary>
        public const string TFCKNU = "TFCKNU";
    ...
    /// <inheritdoc />
    public override string TableName => "F74R3B14";
    ...
    public override IReadOnlyList<IJdeField> Fields { get; } = new List<IJdeField>
    {
        ...
        new JdeField("TFCKNU", "TFCKNU", JdeDataType.String, 50),
    ...
    {
        new JdeIndex("F74R3B14_0", "Primary Key on TFPYID, TFRC5", new[] { "TFPYID", "TFRC5" }, isUnique: true, isPrimaryKey: true)
    };
}
