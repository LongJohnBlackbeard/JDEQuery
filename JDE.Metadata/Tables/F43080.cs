...
public class F43080 : JdeTable
{
    ...
    public static class Columns
    {
        ...
        /// PDSPR.
        /// </summary>
        public const string PDSPR = "PDSPR";
    }

    /// <inheritdoc />
    public override string TableName => "F43080";
    ...
    public override IReadOnlyList<IJdeField> Fields { get; } = new List<IJdeField>
    {
        ...
        new JdeField("PDKCOO", "PDKCOO", JdeDataType.String, 10),
        new JdeField("PDDOCO", "PDDOCO", JdeDataType.Numeric),
        new JdeField("PDSFXO", "PDSFXO", JdeDataType.String, 6),
        ...
        new JdeField("PDSPR", "PDSPR", JdeDataType.String, 2)
    };

    /// <inheritdoc />
    public override IReadOnlyList<IJdeIndex> Indexes { get; } = new List<IJdeIndex>
    {
        new JdeIndex("F43080_0", "Primary Key on PDDCTO", new[] { "PDDCTO" }, isUnique: true, isPrimaryKey: true)
    };
}
