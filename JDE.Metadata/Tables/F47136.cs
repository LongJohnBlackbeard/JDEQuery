...
public class F47136 : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F47136";
    ...
    {
        new JdeIndex("F47136_0", "Primary Key on SYEDOC, SYEDCT, SYEKCO", new[] { "SYEDOC", "SYEDCT", "SYEKCO" }, isUnique: true, isPrimaryKey: true)
    };
}
