...
public class F76A22 : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F76A22";
    ...
    {
        new JdeIndex("F76A22_0", "Primary Key on IDKCO, IDDCT, IDDOC, IDPNO", new[] { "IDKCO", "IDDCT", "IDDOC", "IDPNO" }, isUnique: true, isPrimaryKey: true)
    };
}
