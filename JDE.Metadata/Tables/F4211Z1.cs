...
public class F4211Z1 : JdeTable
{
    ...
    public static class Columns
    {
        ...
        /// SZSO16.
        /// </summary>
        public const string SZSO16 = "SZSO16";

        /// <summary>
        /// SZSO17.
        /// </summary>
        public const string SZSO17 = "SZSO17";

        /// <summary>
        /// SZSO18.
        /// </summary>
        public const string SZSO18 = "SZSO18";

        /// <summary>
        /// SZSO19.
        /// </summary>
        public const string SZSO19 = "SZSO19";

        /// <summary>
        /// SZSO20.
        /// </summary>
        public const string SZSO20 = "SZSO20";
        ...
        /// SZXPTY.
        /// </summary>
        public const string SZXPTY = "SZXPTY";
        ...
        /// SZPEND.
        /// </summary>
        public const string SZPEND = "SZPEND";
        ...
        /// SZMCLN.
        /// </summary>
        public const string SZMCLN = "SZMCLN";
        ...
        /// SZOSEQ.
        /// </summary>
        public const string SZOSEQ = "SZOSEQ";
        ...
        /// SZODLN.
        /// </summary>
        public const string SZODLN = "SZODLN";
        ...
        /// SZAAID.
        /// </summary>
        public const string SZAAID = "SZAAID";
    }

    /// <inheritdoc />
    public override string TableName => "F4211Z1";
    ...
    public override IReadOnlyList<IJdeField> Fields { get; } = new List<IJdeField>
    {
        ...
        new JdeField("SZSO16", "SZSO16", JdeDataType.String, 2),
        new JdeField("SZSO17", "SZSO17", JdeDataType.String, 2),
        new JdeField("SZSO18", "SZSO18", JdeDataType.String, 2),
        new JdeField("SZSO19", "SZSO19", JdeDataType.String, 2),
        new JdeField("SZSO20", "SZSO20", JdeDataType.String, 2),
        ...
        new JdeField("SZXPTY", "SZXPTY", JdeDataType.Numeric),
        ...
        new JdeField("SZPEND", "SZPEND", JdeDataType.String, 2),
        new JdeField("SZRFRV", "SZRFRV", JdeDataType.String, 6),
        new JdeField("SZMCLN", "SZMCLN", JdeDataType.Numeric),
        ...
        new JdeField("SZOSEQ", "SZOSEQ", JdeDataType.Numeric),
        ...
        new JdeField("SZODLN", "SZODLN", JdeDataType.Numeric),
        ...
        new JdeField("SZAAID", "SZAAID", JdeDataType.Numeric)
    };

    /// <inheritdoc />
    public override IReadOnlyList<IJdeIndex> Indexes { get; } = new List<IJdeIndex>
    {
        new JdeIndex("F4211Z1_0", "Primary Key on SZEDUS, SZEDBT, SZEDTN, SZEDLN", new[] { "SZEDUS", "SZEDBT", "SZEDTN", "SZEDLN" }, isUnique: true, isPrimaryKey: true),
        new JdeIndex("F4211Z1_2", "Index on SZDOCO, SZDCTO, SZKCOO, SZEDUS, SZLNID", new[] { "SZDOCO", "SZDCTO", "SZKCOO", "SZEDUS", "SZLNID" }),
        new JdeIndex("F4211Z1_3", "Index on SZDOCO, SZDCTO, SZKCOO, SZLNID, SZEDUS", new[] { "SZDOCO", "SZDCTO", "SZKCOO", "SZLNID", "SZEDUS" })
    };
}
