...
/// F90CA31A - .
/// </summary>
public class F90CA31A : JdeTable
{
    /// <summary>
    ...
    /// <inheritdoc />
    public override string TableName => "F90CA31A";
    ...
    {
        new JdeIndex("F90CA31A_0", "Primary Key on EXAPLNID", new[] { "EXAPLNID" }, isUnique: true, isPrimaryKey: true)
    };
}
