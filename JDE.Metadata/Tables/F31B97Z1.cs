...
/// F31B97Z1 - .
/// </summary>
public class F31B97Z1 : JdeTable
{
    /// <summary>
    ...
    public static class Columns
    {
        ...
        /// SZSFNB.
        /// </summary>
        public const string SZSFNB = "SZSFNB";

        /// <summary>
        /// SZWGID.
        /// </summary>
        public const string SZWGID = "SZWGID";
    ...
    /// <inheritdoc />
    public override string TableName => "F31B97Z1";
    ...
    public override IReadOnlyList<IJdeField> Fields { get; } = new List<IJdeField>
    {
        ...
        new JdeField("SZSFNB", "SZSFNB", JdeDataType.Numeric),
        new JdeField("SZWGID", "SZWGID", JdeDataType.String, 16),
    ...
    {
        new JdeIndex("F31B97Z1_0", "Primary Key on SZEDUS, SZEDBT, SZEDTN, SZEDLN", new[] { "SZEDUS", "SZEDBT", "SZEDTN", "SZEDLN" }, isUnique: true, isPrimaryKey: true),
        new JdeIndex("F31B97Z1_11", "Index on SZEDUS, SZEDBT, SZEDTN", new[] { "SZEDUS", "SZEDBT", "SZEDTN" }),
        new JdeIndex("F31B97Z1_13", "Index on SZEDBT, SZEDTN, SZWAPRN, SZSFNB", new[] { "SZEDBT", "SZEDTN", "SZWAPRN", "SZSFNB" }),
        new JdeIndex("F31B97Z1_14", "Index on SZEDUS, SZEDBT, SZEDTN, SYS_NC00031$", new[] { "SZEDUS", "SZEDBT", "SZEDTN", "SYS_NC00031$" }),
        new JdeIndex("F31B97Z1_15", "Index on SZWAPRN", new[] { "SZWAPRN" }),
        new JdeIndex("F31B97Z1_8", "Index on SZEDUS, SZEDBT, SZEDTN, SZEDSP", new[] { "SZEDUS", "SZEDBT", "SZEDTN", "SZEDSP" }),
        new JdeIndex("F31B97Z1_9", "Index on SZEDUS, SZEDBT, SZEDSP", new[] { "SZEDUS", "SZEDBT", "SZEDSP" })
    };
}
