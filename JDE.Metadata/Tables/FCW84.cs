...
public class FCW84 : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "FCW84";
    ...
    {
        new JdeIndex("FCW84_0", "Primary Key on TRCRCD, TREFT, TRCRDC", new[] { "TRCRCD", "TREFT", "TRCRDC" }, isUnique: true, isPrimaryKey: true),
        new JdeIndex("FCW84_2", "Index on TRCRCD, TRCRDC, TREFT", new[] { "TRCRCD", "TRCRDC", "TREFT" }),
        new JdeIndex("FCW84_3", "Index on TRCRCD, TRCRDC, SYS_NC00006$", new[] { "TRCRCD", "TRCRDC", "SYS_NC00006$" })
    };
}
