...
public class F76B429 : JdeTable
{
    ...
    public static class Columns
    {
        ...
        /// SNSEQN.
        /// </summary>
        public const string SNSEQN = "SNSEQN";
        ...
        /// SNCRCD.
        /// </summary>
        public const string SNCRCD = "SNCRCD";
        ...
        /// SNCENTYR.
        /// </summary>
        public const string SNCENTYR = "SNCENTYR";

        /// <summary>
        /// SNMNTH.
        /// </summary>
        public const string SNMNTH = "SNMNTH";
    ...
    /// <inheritdoc />
    public override string TableName => "F76B429";
    ...
    public override IReadOnlyList<IJdeField> Fields { get; } = new List<IJdeField>
    {
        ...
        new JdeField("SNSEQN", "SNSEQN", JdeDataType.Numeric, null, true, true),
        ...
        new JdeField("SNCRCD", "SNCRCD", JdeDataType.String, 6),
        ...
        new JdeField("SNCENTYR", "SNCENTYR", JdeDataType.Numeric),
        new JdeField("SNMNTH", "SNMNTH", JdeDataType.Numeric),
    ...
    {
        new JdeIndex("F76B429_0", "Primary Key on SNBNNF, SNBSER, SNN001, SNDCT, SNUKID, SNBRTX, SNSEQN", new[] { "SNBNNF", "SNBSER", "SNN001", "SNDCT", "SNUKID", "SNBRTX", "SNSEQN" }, isUnique: true, isPrimaryKey: true),
        new JdeIndex("F76B429_2", "Index on SNBRTX, SNCENTYR, SNMNTH", new[] { "SNBRTX", "SNCENTYR", "SNMNTH" }),
        new JdeIndex("F76B429_3", "Index on SNBRTX, SNCALCDJ", new[] { "SNBRTX", "SNCALCDJ" })
    };
}
