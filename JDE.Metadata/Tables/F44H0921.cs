...
/// F44H0921 - .
/// </summary>
public class F44H0921 : JdeTable
{
    /// <summary>
    ...
    public static class Columns
    {
        ...
        /// EHEDHCOL.
        /// </summary>
        public const string EHEDHCOL = "EHEDHCOL";
        ...
        /// EHHBOPID.
        /// </summary>
        public const string EHHBOPID = "EHHBOPID";
    ...
    /// <inheritdoc />
    public override string TableName => "F44H0921";
    ...
    public override IReadOnlyList<IJdeField> Fields { get; } = new List<IJdeField>
    {
        ...
        new JdeField("EHEDHCOL", "EHEDHCOL", JdeDataType.String, 2),
        ...
        new JdeField("EHHBOPID", "EHHBOPID", JdeDataType.String, 20),
    ...
    {
        new JdeIndex("F44H0921_0", "Primary Key on EHSDTYP, EHSDKY, EHHBAREA, EHEXDTA", new[] { "EHSDTYP", "EHSDKY", "EHHBAREA", "EHEXDTA" }, isUnique: true, isPrimaryKey: true)
    };
}
