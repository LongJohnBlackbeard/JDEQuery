...
public class F4575 : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F4575";
    ...
    {
        new JdeIndex("F4575_0", "Primary Key on AHPA04, AHDOCO, AHDCTO, AHKCOO, AHSFXO, AHLNID, AHOSEQ", new[] { "AHPA04", "AHDOCO", "AHDCTO", "AHKCOO", "AHSFXO", "AHLNID", "AHOSEQ" }, isUnique: true, isPrimaryKey: true)
    };
}
