...
public class F0414P : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F0414P";
    ...
    {
        new JdeIndex("F0414P_0", "Primary Key on RNPYID, RNRC5", new[] { "RNPYID", "RNRC5" }, isUnique: true, isPrimaryKey: true)
    };
}
