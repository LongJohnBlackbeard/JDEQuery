...
public class F40316 : JdeTable
{
    ...
    public static class Columns
    {
        ...
        /// OPEDWD.
        /// </summary>
        public const string OPEDWD = "OPEDWD";
    }

    /// <inheritdoc />
    public override string TableName => "F40316";
    ...
    {
        new JdeField("OPAN8", "OPAN8", JdeDataType.Numeric, null, true, true),
        new JdeField("OPCS16", "OPCS16", JdeDataType.String, 16, true, true),
        new JdeField("OPITM", "OPITM", JdeDataType.Numeric, null, true, true),
        new JdeField("OPIT16", "OPIT16", JdeDataType.String, 16, true, true),
        new JdeField("OPEFTJ", "OPEFTJ", JdeDataType.Numeric),
        new JdeField("OPEXDJ", "OPEXDJ", JdeDataType.Numeric, null, true, true),
        new JdeField("OPMNQ", "OPMNQ", JdeDataType.Numeric),
        new JdeField("OPMXQ", "OPMXQ", JdeDataType.Numeric, null, true, true),
        new JdeField("OPUOM", "OPUOM", JdeDataType.String, 4, true, true),
        new JdeField("OPTXID", "OPTXID", JdeDataType.Numeric),
        new JdeField("OPSTPR", "OPSTPR", JdeDataType.String, 2),
        new JdeField("OPOSEQ", "OPOSEQ", JdeDataType.Numeric, null, true, true),
        ...
        new JdeField("OPEDWD", "OPEDWD", JdeDataType.String, 2)
    };

    /// <inheritdoc />
    public override IReadOnlyList<IJdeIndex> Indexes { get; } = new List<IJdeIndex>
    {
        new JdeIndex("F40316_0", "Primary Key on OPAN8, OPCS16, OPITM, OPIT16, OPEXDJ, OPUOM, OPMXQ, OPOSEQ", new[] { "OPAN8", "OPCS16", "OPITM", "OPIT16", "OPEXDJ", "OPUOM", "OPMXQ", "OPOSEQ" }, isUnique: true, isPrimaryKey: true)
    };
}
