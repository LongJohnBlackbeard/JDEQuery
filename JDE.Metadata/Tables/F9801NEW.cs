...
/// F9801NEW - .
/// </summary>
public class F9801NEW : JdeTable
{
    /// <summary>
    ...
    /// <inheritdoc />
    public override string TableName => "F9801NEW";
    ...
    {
        new JdeIndex("F9801NEW_0", "Primary Key on AAAN8", new[] { "AAAN8" }, isUnique: true, isPrimaryKey: true)
    };
}
