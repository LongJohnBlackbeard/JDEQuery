...
public class F75T003 : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F75T003";
    ...
    {
        new JdeIndex("F75T003_0", "Primary Key on NS75TUIP, NS75TGRF, NS75TGSF", new[] { "NS75TUIP", "NS75TGRF", "NS75TGSF" }, isUnique: true, isPrimaryKey: true)
    };
}
