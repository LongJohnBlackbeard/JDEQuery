...
public class F4576 : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F4576";
    ...
    {
        new JdeIndex("F4576_0", "Primary Key on ACDOCO, ACDCTO, ACKCOO, ACSFXO, ACLNID, ACOSEQ", new[] { "ACDOCO", "ACDCTO", "ACKCOO", "ACSFXO", "ACLNID", "ACOSEQ" }, isUnique: true, isPrimaryKey: true)
    };
}
