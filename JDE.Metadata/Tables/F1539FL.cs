...
public class F1539FL : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F1539FL";
    ...
    {
        new JdeIndex("F1539FL_0", "Primary Key on AUICU, AUDOCO, AULSVR, AUEPCL, AUBCI, AULNID", new[] { "AUICU", "AUDOCO", "AULSVR", "AUEPCL", "AUBCI", "AULNID" }, isUnique: true, isPrimaryKey: true)
    };
}
