...
public class F04514 : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F04514";
    ...
    {
        new JdeIndex("F04514_0", "Primary Key on G1AN8, G1CO, G1TOR, G1ST", new[] { "G1AN8", "G1CO", "G1TOR", "G1ST" }, isUnique: true, isPrimaryKey: true)
    };
}
