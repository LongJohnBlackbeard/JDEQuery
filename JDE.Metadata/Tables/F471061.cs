...
public class F471061 : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F471061";
    ...
    {
        new JdeIndex("F471061_0", "Primary Key on S3EDOC, S3EDCT, S3EKCO", new[] { "S3EDOC", "S3EDCT", "S3EKCO" }, isUnique: true, isPrimaryKey: true)
    };
}
