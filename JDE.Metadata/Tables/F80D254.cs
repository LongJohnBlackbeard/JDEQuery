...
public class F80D254 : JdeTable
{
    ...
    public static class Columns
    {
        ...
        /// DIAADSA.
        /// </summary>
        public const string DIAADSA = "DIAADSA";

        /// <summary>
        /// DIAADL.
        /// </summary>
        public const string DIAADL = "DIAADL";

        /// <summary>
        /// DIATPV.
        /// </summary>
        public const string DIATPV = "DIATPV";
    ...
    /// <inheritdoc />
    public override string TableName => "F80D254";
    ...
    public override IReadOnlyList<IJdeField> Fields { get; } = new List<IJdeField>
    {
        ...
        new JdeField("DIAADSA", "DIAADSA", JdeDataType.Numeric),
        new JdeField("DIAADL", "DIAADL", JdeDataType.Numeric),
        new JdeField("DIATPV", "DIATPV", JdeDataType.Numeric),
    ...
    {
        new JdeIndex("F80D254_0", "Primary Key on DIPRDJ, DIMCU", new[] { "DIPRDJ", "DIMCU" }, isUnique: true, isPrimaryKey: true)
    };
}
