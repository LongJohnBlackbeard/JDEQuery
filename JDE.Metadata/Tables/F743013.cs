...
public class F743013 : JdeTable
{
    ...
    public static class Columns
    {
        ...
        /// PEK74SSIGN.
        /// </summary>
        public const string PEK74SSIGN = "PEK74SSIGN";
    ...
    /// <inheritdoc />
    public override string TableName => "F743013";
    ...
    public override IReadOnlyList<IJdeField> Fields { get; } = new List<IJdeField>
    {
        ...
        new JdeField("PEK74SSIGN", "PEK74SSIGN", JdeDataType.String, 2000),
    ...
    {
        new JdeIndex("F743013_0", "Primary Key on PEDOC, PEDCT, PEKCO", new[] { "PEDOC", "PEDCT", "PEKCO" }, isUnique: true, isPrimaryKey: true)
    };
}
