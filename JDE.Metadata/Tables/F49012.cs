...
public class F49012 : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F49012";
    ...
    {
        new JdeIndex("F49012_0", "Primary Key on VOVEHI, VOCMPN", new[] { "VOVEHI", "VOCMPN" }, isUnique: true, isPrimaryKey: true)
    };
}
