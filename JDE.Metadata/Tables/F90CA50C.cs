...
/// F90CA50C - .
/// </summary>
public class F90CA50C : JdeTable
{
    /// <summary>
    ...
    /// <inheritdoc />
    public override string TableName => "F90CA50C";
    ...
    public override IReadOnlyList<IJdeField> Fields { get; } = new List<IJdeField>
    {
        ...
        new JdeField("MEEGRPID", "MEEGRPID", JdeDataType.Numeric, null, true, true),
    ...
    {
        new JdeIndex("F90CA50C_0", "Primary Key on MEMEMBERID, MEEGRPID", new[] { "MEMEMBERID", "MEEGRPID" }, isUnique: true, isPrimaryKey: true)
    };
}
