...
public class F47147 : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F47147";
    ...
    {
        new JdeIndex("F47147_0", "Primary Key on SZEDOC, SZEDCT, SZEKCO, SZEDLN", new[] { "SZEDOC", "SZEDCT", "SZEKCO", "SZEDLN" }, isUnique: true, isPrimaryKey: true)
    };
}
