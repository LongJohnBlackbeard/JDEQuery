...
public class F4211UR : JdeTable
{
    ...
    public static class Columns
    {
        ...
        /// URSTSUDT.
        /// </summary>
        public const string URSTSUDT = "URSTSUDT";

        /// <summary>
        /// URACTIND.
        /// </summary>
        public const string URACTIND = "URACTIND";
    ...
    /// <inheritdoc />
    public override string TableName => "F4211UR";
    ...
    public override IReadOnlyList<IJdeField> Fields { get; } = new List<IJdeField>
    {
        ...
        new JdeField("URDCTO", "URDCTO", JdeDataType.String, 4, true, true),
        new JdeField("URKCOO", "URKCOO", JdeDataType.String, 10, true, true),
        new JdeField("URLNID", "URLNID", JdeDataType.Numeric, null, true, true),
        ...
        new JdeField("URSTSUDT", "URSTSUDT", JdeDataType.Date),
        new JdeField("URACTIND", "URACTIND", JdeDataType.String, 2),
    ...
    {
        new JdeIndex("F4211UR_0", "Primary Key on URDOCO, URDCTO, URKCOO, URLNID", new[] { "URDOCO", "URDCTO", "URKCOO", "URLNID" }, isUnique: true, isPrimaryKey: true)
    };
}
