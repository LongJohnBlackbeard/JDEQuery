...
/// F42199TX - .
/// </summary>
public class F42199TX : JdeTable
{
    /// <summary>
    ...
    /// <inheritdoc />
    public override string TableName => "F42199TX";
    ...
    public override IReadOnlyList<IJdeField> Fields { get; } = new List<IJdeField>
    {
        ...
        new JdeField("DTUPMJ", "DTUPMJ", JdeDataType.Numeric, null, true, true),
        new JdeField("DTUPMT", "DTUPMT", JdeDataType.Numeric, null, true, true)
    };

    /// <inheritdoc />
    public override IReadOnlyList<IJdeIndex> Indexes { get; } = new List<IJdeIndex>
    {
        new JdeIndex("F42199TX_0", "Primary Key on DTDOCO, DTDCTO, DTKCOO, DTLNID, DTUPMJ, DTUPMT", new[] { "DTDOCO", "DTDCTO", "DTKCOO", "DTLNID", "DTUPMJ", "DTUPMT" }, isUnique: true, isPrimaryKey: true)
    };
}
