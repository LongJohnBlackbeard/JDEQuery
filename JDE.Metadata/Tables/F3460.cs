...
public class F3460 : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F3460";
    ...
    public override IReadOnlyList<IJdeField> Fields { get; } = new List<IJdeField>
    {
        ...
        new JdeField("MFUPMJ", "MFUPMJ", JdeDataType.Numeric),
        ...
        new JdeField("MFTDAY", "MFTDAY", JdeDataType.Numeric),
    ...
    {
        new JdeIndex("F3460_0", "Primary Key on MFITM, MFMCU, MFTYPF, MFDRQJ, MFYR, MFAN8", new[] { "MFITM", "MFMCU", "MFTYPF", "MFDRQJ", "MFYR", "MFAN8" }, isUnique: true, isPrimaryKey: true),
        new JdeIndex("F3460_2", "Index on MFITM, MFMCU, MFDRQJ", new[] { "MFITM", "MFMCU", "MFDRQJ" }),
        new JdeIndex("F3460_3", "Index on MFITM, MFMCU", new[] { "MFITM", "MFMCU" }),
        new JdeIndex("F3460_4", "Index on MFITM, MFMCU, SYS_NC00023$, MFDRQJ", new[] { "MFITM", "MFMCU", "SYS_NC00023$", "MFDRQJ" }),
        new JdeIndex("F3460_5", "Index on MFMCU, MFITM, MFTYPF, MFDRQJ, MFYR, MFAN8", new[] { "MFMCU", "MFITM", "MFTYPF", "MFDRQJ", "MFYR", "MFAN8" })
    };
}
