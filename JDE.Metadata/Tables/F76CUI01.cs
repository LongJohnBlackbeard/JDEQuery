...
/// F76CUI01 - .
/// </summary>
public class F76CUI01 : JdeTable
{
    /// <summary>
    ...
    /// <inheritdoc />
    public override string TableName => "F76CUI01";
    ...
    {
        new JdeIndex("F76CUI01_0", "Primary Key on GMMCU, GMOBJ, GMSUB", new[] { "GMMCU", "GMOBJ", "GMSUB" }, isUnique: true, isPrimaryKey: true),
        new JdeIndex("F76CUI01_2", "Index on GMMCU, GMR021", new[] { "GMMCU", "GMR021" })
    };
}
