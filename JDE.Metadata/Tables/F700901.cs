...
public class F700901 : JdeTable
{
    ...
    public static class Columns
    {
        ...
        /// LAAID.
        /// </summary>
        public const string LAAID = "LAAID";
    ...
    /// <inheritdoc />
    public override string TableName => "F700901";
    ...
    {
        new JdeField("LAAID", "LAAID", JdeDataType.String, 16, true, true),
    ...
    {
        new JdeIndex("F700901_0", "Primary Key on LAAID, LALCTR, LAK70ADSTR", new[] { "LAAID", "LALCTR", "LAK70ADSTR" }, isUnique: true, isPrimaryKey: true)
    };
}
