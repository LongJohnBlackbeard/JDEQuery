...
/// FY5AGX05 - .
/// </summary>
public class FY5AGX05 : JdeTable
{
    /// <summary>
    ...
    public static class Columns
    {
        ...
        /// DIY5AGOTID.
        /// </summary>
        public const string DIY5AGOTID = "DIY5AGOTID";
    }

    /// <inheritdoc />
    public override string TableName => "FY5AGX05";
    ...
    public override IReadOnlyList<IJdeField> Fields { get; } = new List<IJdeField>
    {
        ...
        new JdeField("DIY5AGOTID", "DIY5AGOTID", JdeDataType.String, 72)
    };

    /// <inheritdoc />
    public override IReadOnlyList<IJdeIndex> Indexes { get; } = new List<IJdeIndex>
    {
        new JdeIndex("FY5AGX05_0", "Primary Key on DITASKID", new[] { "DITASKID" }, isUnique: true, isPrimaryKey: true),
        new JdeIndex("FY5AGX05_10", "Index on DIY5AGOTID", new[] { "DIY5AGOTID" }),
        new JdeIndex("FY5AGX05_2", "Index on DITASKNM", new[] { "DITASKNM" }),
        new JdeIndex("FY5AGX05_3", "Index on DIOBNM, DIVER, DIFMNM", new[] { "DIOBNM", "DIVER", "DIFMNM" }),
        new JdeIndex("FY5AGX05_4", "Index on DITASKTYPE", new[] { "DITASKTYPE" }),
        new JdeIndex("FY5AGX05_5", "Index on DIRULEID", new[] { "DIRULEID" }),
        new JdeIndex("FY5AGX05_6", "Index on DIFUFTASK4", new[] { "DIFUFTASK4" }),
        new JdeIndex("FY5AGX05_7", "Index on DIFUFTASK4, DIFUFTASK6", new[] { "DIFUFTASK4", "DIFUFTASK6" }),
        new JdeIndex("FY5AGX05_8", "Index on DIFUFTASK7", new[] { "DIFUFTASK7" }),
        new JdeIndex("FY5AGX05_9", "Index on DISY, DITASCKACT, DITASKID", new[] { "DISY", "DITASCKACT", "DITASKID" })
    };
}
