...
public class F47092T : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F47092T";
    ...
    {
        new JdeIndex("F47092T_0", "Primary Key on UZEDOC, UZEDCT, UZEKCO, UZEDLN", new[] { "UZEDOC", "UZEDCT", "UZEKCO", "UZEDLN" }, isUnique: true, isPrimaryKey: true)
    };
}
