...
public class F75I732 : JdeTable
{
    ...
    public static class Columns
    {
        ...
        /// STI75TLOC.
        /// </summary>
        public const string STI75TLOC = "STI75TLOC";
    ...
    /// <inheritdoc />
    public override string TableName => "F75I732";
    ...
    public override IReadOnlyList<IJdeField> Fields { get; } = new List<IJdeField>
    {
        ...
        new JdeField("STI75TLOC", "STI75TLOC", JdeDataType.String, 2),
    ...
    {
        new JdeIndex("F75I732_0", "Primary Key on STDOC, STDCT, STKCO, STSFX, STLNID", new[] { "STDOC", "STDCT", "STKCO", "STSFX", "STLNID" }, isUnique: true, isPrimaryKey: true)
    };
}
