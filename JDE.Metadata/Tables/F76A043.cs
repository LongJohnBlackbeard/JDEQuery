...
public class F76A043 : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F76A043";
    ...
    {
        new JdeIndex("F76A043_0", "Primary Key on RGAN8, RGADGI1, RGACEM1, RGACAI, RGEFTJ, RGADGI, RGACEM", new[] { "RGAN8", "RGADGI1", "RGACEM1", "RGACAI", "RGEFTJ", "RGADGI", "RGACEM" }, isUnique: true, isPrimaryKey: true)
    };
}
