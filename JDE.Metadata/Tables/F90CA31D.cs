...
/// F90CA31D - .
/// </summary>
public class F90CA31D : JdeTable
{
    /// <summary>
    ...
    public static class Columns
    {
        ...
        /// EXRECURIDX.
        /// </summary>
        public const string EXRECURIDX = "EXRECURIDX";
    ...
    /// <inheritdoc />
    public override string TableName => "F90CA31D";
    ...
    {
        new JdeField("EXRECURIDX", "EXRECURIDX", JdeDataType.String, 72, true, true),
    ...
    {
        new JdeIndex("F90CA31D_0", "Primary Key on EXRECURIDX", new[] { "EXRECURIDX" }, isUnique: true, isPrimaryKey: true)
    };
}
