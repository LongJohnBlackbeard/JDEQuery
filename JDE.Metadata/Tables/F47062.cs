...
public class F47062 : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F47062";
    ...
    {
        new JdeIndex("F47062_0", "Primary Key on MYEDOC, MYEDCT, MYEKCO, MYEDLN", new[] { "MYEDOC", "MYEDCT", "MYEKCO", "MYEDLN" }, isUnique: true, isPrimaryKey: true)
    };
}
