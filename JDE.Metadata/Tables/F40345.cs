...
public class F40345 : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F40345";
    ...
    public override IReadOnlyList<IJdeField> Fields { get; } = new List<IJdeField>
    {
        ...
        new JdeField("CRCS45", "CRCS45", JdeDataType.String, 16, true, true),
        new JdeField("CRITM", "CRITM", JdeDataType.Numeric, null, true, true),
        new JdeField("CRIT45", "CRIT45", JdeDataType.String, 16, true, true),
        new JdeField("CREFTJ", "CREFTJ", JdeDataType.Numeric),
        new JdeField("CREXDJ", "CREXDJ", JdeDataType.Numeric, null, true, true),
        new JdeField("CRMNQ", "CRMNQ", JdeDataType.Numeric),
        new JdeField("CRMXQ", "CRMXQ", JdeDataType.Numeric, null, true, true),
        new JdeField("CRUOM", "CRUOM", JdeDataType.String, 4, true, true),
        new JdeField("CRTXID", "CRTXID", JdeDataType.Numeric),
        new JdeField("CRSTPR", "CRSTPR", JdeDataType.String, 2),
        new JdeField("CROSEQ", "CROSEQ", JdeDataType.Numeric, null, true, true),
    ...
    {
        new JdeIndex("F40345_0", "Primary Key on CRAN8, CRCS45, CRITM, CRIT45, CREXDJ, CRUOM, CRMXQ, CROSEQ", new[] { "CRAN8", "CRCS45", "CRITM", "CRIT45", "CREXDJ", "CRUOM", "CRMXQ", "CROSEQ" }, isUnique: true, isPrimaryKey: true)
    };
}
