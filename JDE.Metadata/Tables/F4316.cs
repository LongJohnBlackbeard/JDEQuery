...
public class F4316 : JdeTable
{
    ...
    public static class Columns
    {
        ...
        /// P3UCHG.
        /// </summary>
        public const string P3UCHG = "P3UCHG";

        /// <summary>
        /// P3UOPN.
        /// </summary>
        public const string P3UOPN = "P3UOPN";

        /// <summary>
        /// P3UREC.
        /// </summary>
        public const string P3UREC = "P3UREC";
        ...
        /// P3ACHG.
        /// </summary>
        public const string P3ACHG = "P3ACHG";

        /// <summary>
        /// P3AOPN.
        /// </summary>
        public const string P3AOPN = "P3AOPN";

        /// <summary>
        /// P3AREC.
        /// </summary>
        public const string P3AREC = "P3AREC";
        ...
        /// P3FTN1.
        /// </summary>
        public const string P3FTN1 = "P3FTN1";

        /// <summary>
        /// P3TRLV.
        /// </summary>
        public const string P3TRLV = "P3TRLV";
        ...
        /// P3FCHG.
        /// </summary>
        public const string P3FCHG = "P3FCHG";

        /// <summary>
        /// P3FAP.
        /// </summary>
        public const string P3FAP = "P3FAP";

        /// <summary>
        /// P3FREC.
        /// </summary>
        public const string P3FREC = "P3FREC";

        /// <summary>
        /// P3CTAM.
        /// </summary>
        public const string P3CTAM = "P3CTAM";

        /// <summary>
        /// P3FTRL.
        /// </summary>
        public const string P3FTRL = "P3FTRL";
        ...
        /// P3SRQTY.
        /// </summary>
        public const string P3SRQTY = "P3SRQTY";

        /// <summary>
        /// P3JBCD.
        /// </summary>
        public const string P3JBCD = "P3JBCD";
    }

    /// <inheritdoc />
    public override string TableName => "F4316";
    ...
    public override IReadOnlyList<IJdeField> Fields { get; } = new List<IJdeField>
    {
        ...
        new JdeField("P3UCHG", "P3UCHG", JdeDataType.Numeric),
        new JdeField("P3UOPN", "P3UOPN", JdeDataType.Numeric),
        new JdeField("P3UREC", "P3UREC", JdeDataType.Numeric),
        new JdeField("P3URLV", "P3URLV", JdeDataType.Numeric),
        new JdeField("P3AEXP", "P3AEXP", JdeDataType.Numeric),
        new JdeField("P3ACHG", "P3ACHG", JdeDataType.Numeric),
        new JdeField("P3AOPN", "P3AOPN", JdeDataType.Numeric),
        new JdeField("P3AREC", "P3AREC", JdeDataType.Numeric),
        new JdeField("P3ARLV", "P3ARLV", JdeDataType.Numeric),
        new JdeField("P3FTN1", "P3FTN1", JdeDataType.Numeric),
        new JdeField("P3TRLV", "P3TRLV", JdeDataType.Numeric),
        new JdeField("P3CRCD", "P3CRCD", JdeDataType.String, 6),
        new JdeField("P3FEA", "P3FEA", JdeDataType.Numeric),
        new JdeField("P3FCHG", "P3FCHG", JdeDataType.Numeric),
        new JdeField("P3FAP", "P3FAP", JdeDataType.Numeric),
        new JdeField("P3FREC", "P3FREC", JdeDataType.Numeric),
        new JdeField("P3CTAM", "P3CTAM", JdeDataType.Numeric),
        new JdeField("P3FTRL", "P3FTRL", JdeDataType.Numeric),
        ...
        new JdeField("P3SRQTY", "P3SRQTY", JdeDataType.Numeric),
        new JdeField("P3JBCD", "P3JBCD", JdeDataType.String, 12)
    };

    /// <inheritdoc />
    public override IReadOnlyList<IJdeIndex> Indexes { get; } = new List<IJdeIndex>
    {
        new JdeIndex("F4316_0", "Primary Key on P3DOCO, P3DCTO, P3KCOO, P3SFXO, P3LNID, P3DLNID", new[] { "P3DOCO", "P3DCTO", "P3KCOO", "P3SFXO", "P3LNID", "P3DLNID" }, isUnique: true, isPrimaryKey: true),
        new JdeIndex("F4316_1", "Index on P3DOCO, P3DCTO, P3KCOO, P3SFXO, P3LNID, P3AID, P3SBLT, P3SBL, P3DGL", new[] { "P3DOCO", "P3DCTO", "P3KCOO", "P3SFXO", "P3LNID", "P3AID", "P3SBLT", "P3SBL", "P3DGL" }),
        new JdeIndex("F4316_4", "Unique Index on P3DOCO, P3DCTO, P3KCOO, P3SFXO, P3LNID, SYS_NC00058$", new[] { "P3DOCO", "P3DCTO", "P3KCOO", "P3SFXO", "P3LNID", "SYS_NC00058$" }, isUnique: true),
        new JdeIndex("F4316_5", "Index on P3AID, P3DOCO, P3DCTO, P3KCOO, P3SFXO, P3LNID, P3DLNID", new[] { "P3AID", "P3DOCO", "P3DCTO", "P3KCOO", "P3SFXO", "P3LNID", "P3DLNID" })
    };
}
