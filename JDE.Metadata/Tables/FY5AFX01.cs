...
/// FY5AFX01 - .
/// </summary>
public class FY5AFX01 : JdeTable
{
    /// <summary>
    ...
    /// <inheritdoc />
    public override string TableName => "FY5AFX01";
    ...
    {
        new JdeIndex("FY5AFX01_0", "Primary Key on DIMNI", new[] { "DIMNI" }, isUnique: true, isPrimaryKey: true),
        new JdeIndex("FY5AFX01_2", "Index on DISY", new[] { "DISY" })
    };
}
