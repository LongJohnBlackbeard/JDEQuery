...
public class F4073P : JdeTable
{
    ...
    public static class Columns
    {
        ...
        /// FGUKID.
        /// </summary>
        public const string FGUKID = "FGUKID";
    ...
    /// <inheritdoc />
    public override string TableName => "F4073P";
    ...
    {
        new JdeField("FGUKID", "FGUKID", JdeDataType.Numeric, null, true, true),
    ...
    {
        new JdeIndex("F4073P_0", "Primary Key on FGAST, FGATID, FGLITM, FGUKID", new[] { "FGAST", "FGATID", "FGLITM", "FGUKID" }, isUnique: true, isPrimaryKey: true),
        new JdeIndex("F4073P_2", "Index on FGAST, FGATID, FGLITM, SYS_NC00025$, SYS_NC00026$", new[] { "FGAST", "FGATID", "FGLITM", "SYS_NC00025$", "SYS_NC00026$" }),
        new JdeIndex("F4073P_3", "Index on FGAST, FGATID, FGLITM, FGPID", new[] { "FGAST", "FGATID", "FGLITM", "FGPID" })
    };
}
