...
/// FY5AHX10 - .
/// </summary>
public class FY5AHX10 : JdeTable
{
    /// <summary>
    ...
    /// <inheritdoc />
    public override string TableName => "FY5AHX10";
    ...
    {
        new JdeIndex("FY5AHX10_0", "Primary Key on SDY5AHE1RL, SDY5AHMDID, SDY5AHDTID", new[] { "SDY5AHE1RL", "SDY5AHMDID", "SDY5AHDTID" }, isUnique: true, isPrimaryKey: true)
    };
}
