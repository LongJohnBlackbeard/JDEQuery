...
public class F1207 : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F1207";
    ...
    {
        new JdeIndex("F1207_0", "Primary Key on FWUKID", new[] { "FWUKID" }, isUnique: true, isPrimaryKey: true),
        new JdeIndex("F1207_3", "Index on FWAPID, FWMSTS, FWSRVT, SYS_NC00067$", new[] { "FWAPID", "FWMSTS", "FWSRVT", "SYS_NC00067$" }),
        new JdeIndex("F1207_4", "Index on FWNUMB, FWMSTS, FWSRVT, SYS_NC00067$", new[] { "FWNUMB", "FWMSTS", "FWSRVT", "SYS_NC00067$" }),
        new JdeIndex("F1207_5", "Index on FWNUMB, FWSRVT", new[] { "FWNUMB", "FWSRVT" }),
        new JdeIndex("F1207_6", "Index on FWNUMB, FWSRVT, SYS_NC00067$", new[] { "FWNUMB", "FWSRVT", "SYS_NC00067$" }),
        new JdeIndex("F1207_7", "Index on FWWONA, FWNUMB", new[] { "FWWONA", "FWNUMB" })
    };
}
