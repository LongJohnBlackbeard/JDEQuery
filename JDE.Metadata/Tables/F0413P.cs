...
public class F0413P : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F0413P";
    ...
    {
        new JdeIndex("F0413P_0", "Primary Key on RMPYID", new[] { "RMPYID" }, isUnique: true, isPrimaryKey: true)
    };
}
