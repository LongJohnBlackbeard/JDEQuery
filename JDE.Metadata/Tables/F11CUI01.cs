...
/// F11CUI01 - .
/// </summary>
public class F11CUI01 : JdeTable
{
    /// <summary>
    ...
    /// <inheritdoc />
    public override string TableName => "F11CUI01";
    ...
    {
        new JdeIndex("F11CUI01_0", "Primary Key on CBJOBS, CBICU, CBICUT", new[] { "CBJOBS", "CBICU", "CBICUT" }, isUnique: true, isPrimaryKey: true)
    };
}
