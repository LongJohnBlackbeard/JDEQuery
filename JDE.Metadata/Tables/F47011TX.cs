...
/// F47011TX - .
/// </summary>
public class F47011TX : JdeTable
{
    /// <summary>
    ...
    /// <inheritdoc />
    public override string TableName => "F47011TX";
    ...
    {
        new JdeIndex("F47011TX_0", "Primary Key on STEDOC, STEDCT, STEKCO", new[] { "STEDOC", "STEDCT", "STEKCO" }, isUnique: true, isPrimaryKey: true)
    };
}
