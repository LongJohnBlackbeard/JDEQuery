...
public class F4812HS : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F4812HS";
    ...
    {
        new JdeIndex("F4812HS_0", "Primary Key on WDBCI, WDDGL, WDPRSQ, WDSBSQ, WDSCSQ, WDSLNK, WDCLNK, WDCCOD", new[] { "WDBCI", "WDDGL", "WDPRSQ", "WDSBSQ", "WDSCSQ", "WDSLNK", "WDCLNK", "WDCCOD" }, isUnique: true, isPrimaryKey: true),
        new JdeIndex("F4812HS_10", "Index on WDDOCO, WDDCTO, WDKCOO, WDCOCH, WDLNID, WDMCU, WDOBJ, WDSUB", new[] { "WDDOCO", "WDDCTO", "WDKCOO", "WDCOCH", "WDLNID", "WDMCU", "WDOBJ", "WDSUB" }),
        new JdeIndex("F4812HS_11", "Index on WDDOCZ, WDDCTI, WDKCOI, WDSFX, WDMCU, WDOBJ, WDSUB", new[] { "WDDOCZ", "WDDCTI", "WDKCOI", "WDSFX", "WDMCU", "WDOBJ", "WDSUB" }),
        new JdeIndex("F4812HS_12", "Index on WDSLNK, WDCLNK, WDCCOD", new[] { "WDSLNK", "WDCLNK", "WDCCOD" }),
        new JdeIndex("F4812HS_13", "Index on WDAN8, WDPRTR, WDPDBA, WDPTAX", new[] { "WDAN8", "WDPRTR", "WDPDBA", "WDPTAX" }),
        new JdeIndex("F4812HS_14", "Index on WDCLNK, WDCCOD", new[] { "WDCLNK", "WDCCOD" }),
        new JdeIndex("F4812HS_16", "Index on WDSBL, WDSBLT, WDMCU, WDOBJ, WDSUB, WDDGL, WDJBCD, WDJBST", new[] { "WDSBL", "WDSBLT", "WDMCU", "WDOBJ", "WDSUB", "WDDGL", "WDJBCD", "WDJBST" }),
        new JdeIndex("F4812HS_17", "Index on WDDOCO, WDDCTO, WDKCOO, WDCOCH, WDOPIM", new[] { "WDDOCO", "WDDCTO", "WDKCOO", "WDCOCH", "WDOPIM" }),
        new JdeIndex("F4812HS_18", "Index on WDCLNK, WDSLNK, WDCCOD", new[] { "WDCLNK", "WDSLNK", "WDCCOD" }),
        new JdeIndex("F4812HS_2", "Index on WDBCI, WDDGL, WDSBSQ, WDSLNK, WDCLNK", new[] { "WDBCI", "WDDGL", "WDSBSQ", "WDSLNK", "WDCLNK" }),
        new JdeIndex("F4812HS_21", "Index on WDICU, WDDOCZ, WDDCTI, WDKCOI", new[] { "WDICU", "WDDOCZ", "WDDCTI", "WDKCOI" }),
        new JdeIndex("F4812HS_22", "Index on WDDCT, WDPRTR, WDAN8, WDLSSQ", new[] { "WDDCT", "WDPRTR", "WDAN8", "WDLSSQ" }),
        new JdeIndex("F4812HS_23", "Index on SYS_NC00204$, SYS_NC00205$, WDDCTO, WDKCOO, WDCOCH, WDLNID, WDCCR", new[] { "SYS_NC00204$", "SYS_NC00205$", "WDDCTO", "WDKCOO", "WDCOCH", "WDLNID", "WDCCR" }),
        new JdeIndex("F4812HS_3", "Index on WDBCI, WDSBSQ, WDSCSQ", new[] { "WDBCI", "WDSBSQ", "WDSCSQ" }),
        new JdeIndex("F4812HS_4", "Index on WDICUA", new[] { "WDICUA" }),
        new JdeIndex("F4812HS_5", "Index on WDICU, WDDOCZ, WDDCTI, WDKCOI, WDSFX", new[] { "WDICU", "WDDOCZ", "WDDCTI", "WDKCOI", "WDSFX" }),
        new JdeIndex("F4812HS_6", "Index on WDMCU, WDLSSQ", new[] { "WDMCU", "WDLSSQ" }),
        new JdeIndex("F4812HS_7", "Index on WDAN8, WDPRTR, WDDSVJ, WDTCLS", new[] { "WDAN8", "WDPRTR", "WDDSVJ", "WDTCLS" }),
        new JdeIndex("F4812HS_8", "Index on WDMCU, WDOBJ, WDSUB, WDDGL, WDSBL, WDSBLT, WDJBCD, WDJBST", new[] { "WDMCU", "WDOBJ", "WDSUB", "WDDGL", "WDSBL", "WDSBLT", "WDJBCD", "WDJBST" }),
        new JdeIndex("F4812HS_9", "Index on WDAN8O, WDMCU, WDOBJ, WDSUB, WDSBL, WDSBLT, WDJBCD, WDJBST, WDDGL", new[] { "WDAN8O", "WDMCU", "WDOBJ", "WDSUB", "WDSBL", "WDSBLT", "WDJBCD", "WDJBST", "WDDGL" })
    };
}
