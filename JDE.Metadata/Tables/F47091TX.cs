...
/// F47091TX - .
/// </summary>
public class F47091TX : JdeTable
{
    /// <summary>
    ...
    /// <inheritdoc />
    public override string TableName => "F47091TX";
    ...
    {
        new JdeIndex("F47091TX_0", "Primary Key on STEDOC, STEDCT, STEKCO", new[] { "STEDOC", "STEDCT", "STEKCO" }, isUnique: true, isPrimaryKey: true)
    };
}
