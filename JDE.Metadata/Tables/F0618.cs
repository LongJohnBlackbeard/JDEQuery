...
public class F0618 : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F0618";
    ...
    {
        new JdeIndex("F0618_0", "Primary Key on YTAN8, YTDWK, YTPRTR", new[] { "YTAN8", "YTDWK", "YTPRTR" }, isUnique: true, isPrimaryKey: true),
        new JdeIndex("F0618_10", "Index on YTMCUO, YTPPED, YTPALF, YTAN8", new[] { "YTMCUO", "YTPPED", "YTPALF", "YTAN8" }),
        new JdeIndex("F0618_11", "Index on YTMCU, YTPPED", new[] { "YTMCU", "YTPPED" }),
        new JdeIndex("F0618_12", "Index on YTUN, YTPPED, YTAN8", new[] { "YTUN", "YTPPED", "YTAN8" }),
        new JdeIndex("F0618_13", "Index on YTAN8, YTCKCN, YTDWK", new[] { "YTAN8", "YTCKCN", "YTDWK" }),
        new JdeIndex("F0618_14", "Index on YTMCU, YTOBJ, YTSUB, YTSBL", new[] { "YTMCU", "YTOBJ", "YTSUB", "YTSBL" }),
        new JdeIndex("F0618_15", "Index on YTPRTR", new[] { "YTPRTR" }),
        new JdeIndex("F0618_16", "Index on YTAN8, YTCKDT", new[] { "YTAN8", "YTCKDT" }),
        new JdeIndex("F0618_18", "Index on YTGMCU, YTGOBJ, YTGSUB, YTSBL, YTSBLT, YTDGL, YTGICU, YTPDBA, YTJBCD, YTJBST", new[] { "YTGMCU", "YTGOBJ", "YTGSUB", "YTSBL", "YTSBLT", "YTDGL", "YTGICU", "YTPDBA", "YTJBCD", "YTJBST" }),
        new JdeIndex("F0618_19", "Index on YTMCU, YTOBJ, YTSUB, YTSBL, YTSBLT, YTDGL, YTGICU, YTPDBA, YTJBCD, YTJBST", new[] { "YTMCU", "YTOBJ", "YTSUB", "YTSBL", "YTSBLT", "YTDGL", "YTGICU", "YTPDBA", "YTJBCD", "YTJBST" }),
        new JdeIndex("F0618_2", "Index on YTAN8, YTCKCN, YTPDBA, YTPHRT", new[] { "YTAN8", "YTCKCN", "YTPDBA", "YTPHRT" }),
        new JdeIndex("F0618_20", "Index on YTMCU, YTQOBJ, YTSUB, YTSBL, YTSBLT, YTDGL, YTGICU", new[] { "YTMCU", "YTQOBJ", "YTSUB", "YTSBL", "YTSBLT", "YTDGL", "YTGICU" }),
        new JdeIndex("F0618_21", "Index on YTSBL, YTSBLT, YTOPSQ", new[] { "YTSBL", "YTSBLT", "YTOPSQ" }),
        new JdeIndex("F0618_22", "Index on YTGMCU, YTQOBJ, YTGSUB, YTSBL, YTSBLT, YTDGL, YTGICU", new[] { "YTGMCU", "YTQOBJ", "YTGSUB", "YTSBL", "YTSBLT", "YTDGL", "YTGICU" }),
        new JdeIndex("F0618_23", "Index on YTAN8, YTCKCN, YTPDBA, YTPRTR", new[] { "YTAN8", "YTCKCN", "YTPDBA", "YTPRTR" }),
        new JdeIndex("F0618_24", "Index on YTAN8, YTTSKID", new[] { "YTAN8", "YTTSKID" }),
        new JdeIndex("F0618_25", "Index on YTTSKID", new[] { "YTTSKID" }),
        new JdeIndex("F0618_26", "Index on YTOTRULECD, YTAN8", new[] { "YTOTRULECD", "YTAN8" }),
        new JdeIndex("F0618_27", "Index on YTLTTP", new[] { "YTLTTP" }),
        new JdeIndex("F0618_28", "Index on YTAN8, YTBPTX", new[] { "YTAN8", "YTBPTX" }),
        new JdeIndex("F0618_3", "Index on YTMCU, YTDWK, YTAN8, YTJBCD", new[] { "YTMCU", "YTDWK", "YTAN8", "YTJBCD" }),
        new JdeIndex("F0618_4", "Index on YTGMCU, YTDWK", new[] { "YTGMCU", "YTDWK" }),
        new JdeIndex("F0618_5", "Index on YTAN8, YTPDBA, YTHMO, YTCKDT", new[] { "YTAN8", "YTPDBA", "YTHMO", "YTCKDT" }),
        new JdeIndex("F0618_6", "Index on YTMCU, YTAN8, YTDWK, YTPDBA", new[] { "YTMCU", "YTAN8", "YTDWK", "YTPDBA" }),
        new JdeIndex("F0618_7", "Index on YTMCU, YTSUB, YTAN8, YTDWK", new[] { "YTMCU", "YTSUB", "YTAN8", "YTDWK" }),
        new JdeIndex("F0618_8", "Index on YTMCUO, YTJBCD, YTJBST, YTAN8", new[] { "YTMCUO", "YTJBCD", "YTJBST", "YTAN8" }),
        new JdeIndex("F0618_9", "Index on YTAN8, YTPPED, YTUN, YTPDBA", new[] { "YTAN8", "YTPPED", "YTUN", "YTPDBA" })
    };
}
