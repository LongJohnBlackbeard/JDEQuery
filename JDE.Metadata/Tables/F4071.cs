...
public class F4071 : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F4071";
    ...
    {
        new JdeIndex("F4071_0", "Primary Key on ATAST", new[] { "ATAST" }, isUnique: true, isPrimaryKey: true),
        new JdeIndex("F4071_2", "Index on ATAST, ATPID", new[] { "ATAST", "ATPID" })
    };
}
