...
public class F470471 : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F470471";
    ...
    {
        new JdeIndex("F470471_0", "Primary Key on S4EDOC, S4EDCT, S4EKCO, S4EDLN", new[] { "S4EDOC", "S4EDCT", "S4EKCO", "S4EDLN" }, isUnique: true, isPrimaryKey: true)
    };
}
