...
public class F4301Z1 : JdeTable
{
    ...
    public static class Columns
    {
        ...
        /// SYCUKID.
        /// </summary>
        public const string SYCUKID = "SYCUKID";
    ...
    /// <inheritdoc />
    public override string TableName => "F4301Z1";
    ...
    public override IReadOnlyList<IJdeField> Fields { get; } = new List<IJdeField>
    {
        ...
        new JdeField("SYCUKID", "SYCUKID", JdeDataType.Numeric),
    ...
    {
        new JdeIndex("F4301Z1_0", "Primary Key on SYEDUS, SYEDBT, SYEDTN, SYEDLN", new[] { "SYEDUS", "SYEDBT", "SYEDTN", "SYEDLN" }, isUnique: true, isPrimaryKey: true)
    };
}
