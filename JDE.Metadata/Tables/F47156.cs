...
public class F47156 : JdeTable
{
    ...
    public static class Columns
    {
        ...
        /// SYSTQC.
        /// </summary>
        public const string SYSTQC = "SYSTQC";
    ...
    /// <inheritdoc />
    public override string TableName => "F47156";
    ...
    public override IReadOnlyList<IJdeField> Fields { get; } = new List<IJdeField>
    {
        ...
        new JdeField("SYSTQC", "SYSTQC", JdeDataType.String, 4),
    ...
    {
        new JdeIndex("F47156_0", "Primary Key on SYEDOC, SYEDCT, SYEKCO, SYEDLN", new[] { "SYEDOC", "SYEDCT", "SYEKCO", "SYEDLN" }, isUnique: true, isPrimaryKey: true),
        new JdeIndex("F47156_2", "Index on SYDOCO, SYDCTO, SYKCOO, SYSFXO", new[] { "SYDOCO", "SYDCTO", "SYKCOO", "SYSFXO" }),
        new JdeIndex("F47156_3", "Index on SYEDST", new[] { "SYEDST" })
    };
}
