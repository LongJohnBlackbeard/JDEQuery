...
public class F47102 : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F47102";
    ...
    {
        new JdeIndex("F47102_0", "Primary Key on SZEDOC, SZEDCT, SZEKCO, SZEDLN", new[] { "SZEDOC", "SZEDCT", "SZEKCO", "SZEDLN" }, isUnique: true, isPrimaryKey: true)
    };
}
