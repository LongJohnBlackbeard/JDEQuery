...
/// F09UI015 - .
/// </summary>
public class F09UI015 : JdeTable
{
    /// <summary>
    ...
    public static class Columns
    {
        ...
        /// GLYST.
        /// </summary>
        public const string GLYST = "GLYST";
    }

    /// <inheritdoc />
    public override string TableName => "F09UI015";
    ...
    public override IReadOnlyList<IJdeField> Fields { get; } = new List<IJdeField>
    {
        ...
        new JdeField("GLYST", "GLYST", JdeDataType.String, 2)
    };

    /// <inheritdoc />
    public override IReadOnlyList<IJdeIndex> Indexes { get; } = new List<IJdeIndex>
    {
        new JdeIndex("F09UI015_0", "Primary Key on GLDCT, GLDOC, GLKCO, GLDGJ, GLLT, GLEXTL, GLJELN", new[] { "GLDCT", "GLDOC", "GLKCO", "GLDGJ", "GLLT", "GLEXTL", "GLJELN" }, isUnique: true, isPrimaryKey: true),
        new JdeIndex("F09UI015_2", "Index on GLICU", new[] { "GLICU" })
    };
}
