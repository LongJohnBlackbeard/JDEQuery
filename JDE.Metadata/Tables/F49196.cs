...
public class F49196 : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F49196";
    ...
    {
        new JdeIndex("F49196_0", "Primary Key on DUDSET, DUDCCD", new[] { "DUDSET", "DUDCCD" }, isUnique: true, isPrimaryKey: true),
        new JdeIndex("F49196_2", "Index on DUDCCD, DUDSET", new[] { "DUDCCD", "DUDSET" })
    };
}
