...
public class F47022 : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F47022";
    ...
    {
        new JdeIndex("F47022_0", "Primary Key on SZEDOC, SZEDCT, SZEKCO, SZEDLN", new[] { "SZEDOC", "SZEDCT", "SZEKCO", "SZEDLN" }, isUnique: true, isPrimaryKey: true)
    };
}
