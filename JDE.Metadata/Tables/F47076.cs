...
public class F47076 : JdeTable
{
    ...
    public static class Columns
    {
        ...
        /// SYRATY.
        /// </summary>
        public const string SYRATY = "SYRATY";
    ...
    /// <inheritdoc />
    public override string TableName => "F47076";
    ...
    public override IReadOnlyList<IJdeField> Fields { get; } = new List<IJdeField>
    {
        ...
        new JdeField("SYRATY", "SYRATY", JdeDataType.String, 2),
    ...
    {
        new JdeIndex("F47076_0", "Primary Key on SYEDOC, SYEDCT, SYEKCO", new[] { "SYEDOC", "SYEDCT", "SYEKCO" }, isUnique: true, isPrimaryKey: true)
    };
}
