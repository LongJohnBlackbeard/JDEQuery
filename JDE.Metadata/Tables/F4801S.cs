...
public class F4801S : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F4801S";
    ...
    {
        new JdeIndex("F4801S_0", "Primary Key on WADOCO", new[] { "WADOCO" }, isUnique: true, isPrimaryKey: true)
    };
}
