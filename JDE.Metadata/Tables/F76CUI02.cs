...
/// F76CUI02 - .
/// </summary>
public class F76CUI02 : JdeTable
{
    /// <summary>
    ...
    public static class Columns
    {
        ...
        /// TDDOCM.
        /// </summary>
        public const string TDDOCM = "TDDOCM";
        ...
        /// TDOSFX.
        /// </summary>
        public const string TDOSFX = "TDOSFX";
    }

    /// <inheritdoc />
    public override string TableName => "F76CUI02";
    ...
    public override IReadOnlyList<IJdeField> Fields { get; } = new List<IJdeField>
    {
        ...
        new JdeField("TDSFXE", "TDSFXE", JdeDataType.Numeric, null, true, true),
        new JdeField("TDDOCM", "TDDOCM", JdeDataType.Numeric, null, true, true),
        ...
        new JdeField("TDOSFX", "TDOSFX", JdeDataType.String, 6)
    };

    /// <inheritdoc />
    public override IReadOnlyList<IJdeIndex> Indexes { get; } = new List<IJdeIndex>
    {
        new JdeIndex("F76CUI02_0", "Primary Key on TDDOC, TDDCT, TDKCO, TDSFX, TDLNID, TDSFXE, TDDOCM", new[] { "TDDOC", "TDDCT", "TDKCO", "TDSFX", "TDLNID", "TDSFXE", "TDDOCM" }, isUnique: true, isPrimaryKey: true),
        new JdeIndex("F76CUI02_2", "Index on TDDOC, TDKCO, TDDCT, TDOSFX", new[] { "TDDOC", "TDKCO", "TDDCT", "TDOSFX" })
    };
}
