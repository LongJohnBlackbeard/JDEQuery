...
/// FY5AHX08 - .
/// </summary>
public class FY5AHX08 : JdeTable
{
    /// <summary>
    ...
    /// <inheritdoc />
    public override string TableName => "FY5AHX08";
    ...
    {
        new JdeIndex("FY5AHX08_0", "Primary Key on SDY5AHE1RL, SDY5AHMDID, SDY5AHRLID", new[] { "SDY5AHE1RL", "SDY5AHMDID", "SDY5AHRLID" }, isUnique: true, isPrimaryKey: true)
    };
}
