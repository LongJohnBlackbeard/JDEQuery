...
public class F0018 : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F0018";
    ...
    {
        new JdeIndex("F0018_0", "Primary Key on TDDOCO, TDDCTO, TDKCOO, TDSFXO, TDLNID, TDUPMJ, TDUPMT", new[] { "TDDOCO", "TDDCTO", "TDKCOO", "TDSFXO", "TDLNID", "TDUPMJ", "TDUPMT" }, isUnique: true, isPrimaryKey: true),
        new JdeIndex("F0018_3", "Index on TDDCTO, TDDOCO, TDSFXO, TDKCOO, TDLNID", new[] { "TDDCTO", "TDDOCO", "TDSFXO", "TDKCOO", "TDLNID" }),
        new JdeIndex("F0018_4", "Index on TDDCTO, TDDOCO, TDKCOO, TDDGL, TDLNID", new[] { "TDDCTO", "TDDOCO", "TDKCOO", "TDDGL", "TDLNID" }),
        new JdeIndex("F0018_5", "Index on TDDOCO, TDDCTO, TDKCOO, TDTXA1, TDEXR1, TDITM, TDUPMT, TDUPMJ", new[] { "TDDOCO", "TDDCTO", "TDKCOO", "TDTXA1", "TDEXR1", "TDITM", "TDUPMT", "TDUPMJ" }),
        new JdeIndex("F0018_6", "Index on TDPROCFL", new[] { "TDPROCFL" }),
        new JdeIndex("F0018_7", "Index on TDCO, TDTXA1, TDEXR1, TDITM, TDDOCO, TDDCTO, TDSFXO", new[] { "TDCO", "TDTXA1", "TDEXR1", "TDITM", "TDDOCO", "TDDCTO", "TDSFXO" })
    };
}
