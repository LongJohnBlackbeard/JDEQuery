...
public class F47027 : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F47027";
    ...
    {
        new JdeIndex("F47027_0", "Primary Key on SZEDOC, SZEDCT, SZEKCO, SZEDLN", new[] { "SZEDOC", "SZEDCT", "SZEKCO", "SZEDLN" }, isUnique: true, isPrimaryKey: true)
    };
}
