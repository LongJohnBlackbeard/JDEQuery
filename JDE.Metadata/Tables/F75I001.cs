...
public class F75I001 : JdeTable
{
    ...
    public static class Columns
    {
        ...
        /// NNYEXU.
        /// </summary>
        public const string NNYEXU = "NNYEXU";
    ...
    /// <inheritdoc />
    public override string TableName => "F75I001";
    ...
    public override IReadOnlyList<IJdeField> Fields { get; } = new List<IJdeField>
    {
        ...
        new JdeField("NNYEXU", "NNYEXU", JdeDataType.Numeric, null, true, true),
    ...
    {
        new JdeIndex("F75I001_0", "Primary Key on NNK74LECO, NNYEXU, NNK74LEDT, NNK74ISPL, NNI75NNED", new[] { "NNK74LECO", "NNYEXU", "NNK74LEDT", "NNK74ISPL", "NNI75NNED" }, isUnique: true, isPrimaryKey: true)
    };
}
