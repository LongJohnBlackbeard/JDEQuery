...
/// F75T0079 - .
/// </summary>
public class F75T0079 : JdeTable
{
    /// <summary>
    ...
    /// <inheritdoc />
    public override string TableName => "F75T0079";
    ...
    {
        new JdeIndex("F75T0079_0", "Primary Key on MDCO, MD75TDSI, MD75TYMD, MD75TFSN", new[] { "MDCO", "MD75TDSI", "MD75TYMD", "MD75TFSN" }, isUnique: true, isPrimaryKey: true)
    };
}
