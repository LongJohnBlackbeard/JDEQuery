...
public class F47131 : JdeTable
{
    ...
    public static class Columns
    {
        ...
        /// SYGANS8.
        /// </summary>
        public const string SYGANS8 = "SYGANS8";
    }

    /// <inheritdoc />
    public override string TableName => "F47131";
    ...
    public override IReadOnlyList<IJdeField> Fields { get; } = new List<IJdeField>
    {
        ...
        new JdeField("SYGANS8", "SYGANS8", JdeDataType.Numeric)
    };

    /// <inheritdoc />
    public override IReadOnlyList<IJdeIndex> Indexes { get; } = new List<IJdeIndex>
    {
        new JdeIndex("F47131_0", "Primary Key on SYEDOC, SYEDCT, SYEKCO", new[] { "SYEDOC", "SYEDCT", "SYEKCO" }, isUnique: true, isPrimaryKey: true)
    };
}
