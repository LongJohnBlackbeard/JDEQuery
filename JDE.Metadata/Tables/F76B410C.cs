...
/// F76B410C - .
/// </summary>
public class F76B410C : JdeTable
{
    /// <summary>
    ...
    public static class Columns
    {
        ...
        /// SHBRXIR.
        /// </summary>
        public const string SHBRXIR = "SHBRXIR";

        /// <summary>
        /// SHBBCR.
        /// </summary>
        public const string SHBBCR = "SHBBCR";

        /// <summary>
        /// SHBIRT.
        /// </summary>
        public const string SHBIRT = "SHBIRT";

        /// <summary>
        /// SHBRCS.
        /// </summary>
        public const string SHBRCS = "SHBRCS";
    ...
    /// <inheritdoc />
    public override string TableName => "F76B410C";
    ...
    public override IReadOnlyList<IJdeField> Fields { get; } = new List<IJdeField>
    {
        ...
        new JdeField("SHBRXIR", "SHBRXIR", JdeDataType.Numeric),
        new JdeField("SHBBCR", "SHBBCR", JdeDataType.Numeric),
        new JdeField("SHBIRT", "SHBIRT", JdeDataType.Numeric),
        new JdeField("SHBRCS", "SHBRCS", JdeDataType.String, 2),
    ...
    {
        new JdeIndex("F76B410C_0", "Primary Key on SHBRNFK", new[] { "SHBRNFK" }, isUnique: true, isPrimaryKey: true)
    };
}
