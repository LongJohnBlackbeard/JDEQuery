...
public class F08101 : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F08101";
    ...
    {
        new JdeIndex("F08101_0", "Primary Key on HPFY, HPHMCU, HPPOS", new[] { "HPFY", "HPHMCU", "HPPOS" }, isUnique: true, isPrimaryKey: true),
        new JdeIndex("F08101_2", "Index on HPFY, HPPOS, HPHMCU", new[] { "HPFY", "HPPOS", "HPHMCU" }),
        new JdeIndex("F08101_3", "Index on HPHMCU, HPPOS, SYS_NC00036$", new[] { "HPHMCU", "HPPOS", "SYS_NC00036$" }),
        new JdeIndex("F08101_4", "Index on HPFY, HPHMCU, HPJBCD, HPJBST", new[] { "HPFY", "HPHMCU", "HPJBCD", "HPJBST" }),
        new JdeIndex("F08101_5", "Index on SYS_NC00036$, HPPPOS, HPPMCU, HPPOS, HPHMCU", new[] { "SYS_NC00036$", "HPPPOS", "HPPMCU", "HPPOS", "HPHMCU" }),
        new JdeIndex("F08101_6", "Index on SYS_NC00036$, HPPOS, HPHMCU, HPPPOS", new[] { "SYS_NC00036$", "HPPOS", "HPHMCU", "HPPPOS" }),
        new JdeIndex("F08101_7", "Index on SYS_NC00036$, HPPPOS, HPHMCU, HPPOS", new[] { "SYS_NC00036$", "HPPPOS", "HPHMCU", "HPPOS" }),
        new JdeIndex("F08101_8", "Index on HPPOS", new[] { "HPPOS" })
    };
}
