...
public class F4611T1 : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F4611T1";
    ...
    {
        new JdeIndex("F4611T1_0", "Primary Key on R2SGBT, R2SGSQ", new[] { "R2SGBT", "R2SGSQ" }, isUnique: true, isPrimaryKey: true),
        new JdeIndex("F4611T1_2", "Index on R2RQBT, R2RQSQ", new[] { "R2RQBT", "R2RQSQ" })
    };
}
