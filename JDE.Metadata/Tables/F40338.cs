...
public class F40338 : JdeTable
{
    ...
    public static class Columns
    {
        ...
        /// PTCS38.
        /// </summary>
        public const string PTCS38 = "PTCS38";
        ...
        /// PTIT38.
        /// </summary>
        public const string PTIT38 = "PTIT38";
    ...
    /// <inheritdoc />
    public override string TableName => "F40338";
    ...
    public override IReadOnlyList<IJdeField> Fields { get; } = new List<IJdeField>
    {
        ...
        new JdeField("PTCS38", "PTCS38", JdeDataType.String, 16, true, true),
        new JdeField("PTITM", "PTITM", JdeDataType.Numeric, null, true, true),
        new JdeField("PTIT38", "PTIT38", JdeDataType.String, 16, true, true),
        ...
        new JdeField("PTOSEQ", "PTOSEQ", JdeDataType.Numeric, null, true, true),
    ...
    {
        new JdeIndex("F40338_0", "Primary Key on PTAN8, PTCS38, PTITM, PTIT38, PTEXDJ, PTUOM, PTMXQ, PTOSEQ", new[] { "PTAN8", "PTCS38", "PTITM", "PTIT38", "PTEXDJ", "PTUOM", "PTMXQ", "PTOSEQ" }, isUnique: true, isPrimaryKey: true)
    };
}
