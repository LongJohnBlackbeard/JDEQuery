...
public class F4011ZT : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F4011ZT";
    ...
    {
        new JdeIndex("F4011ZT_0", "Primary Key on UZEDOC, UZEDCT, UZEKCO, UZEDLN", new[] { "UZEDOC", "UZEDCT", "UZEKCO", "UZEDLN" }, isUnique: true, isPrimaryKey: true)
    };
}
