...
public class F060116 : JdeTable
{
    ...
    public static class Columns
    {
        ...
        /// YALDID.
        /// </summary>
        public const string YALDID = "YALDID";

        /// <summary>
        /// YATTAR.
        /// </summary>
        public const string YATTAR = "YATTAR";
    }

    /// <inheritdoc />
    public override string TableName => "F060116";
    ...
    public override IReadOnlyList<IJdeField> Fields { get; } = new List<IJdeField>
    {
        ...
        new JdeField("YALDID", "YALDID", JdeDataType.String, 10),
        new JdeField("YATTAR", "YATTAR", JdeDataType.String, 2)
    };

    /// <inheritdoc />
    public override IReadOnlyList<IJdeIndex> Indexes { get; } = new List<IJdeIndex>
    {
        new JdeIndex("F060116_0", "Primary Key on YAAN8", new[] { "YAAN8" }, isUnique: true, isPrimaryKey: true),
        new JdeIndex("F060116_10", "Index on YATINC, YAANPA, YANRVW", new[] { "YATINC", "YAANPA", "YANRVW" }),
        new JdeIndex("F060116_11", "Unique Index on YAHMCU, YAMAIL, YAAN8", new[] { "YAHMCU", "YAMAIL", "YAAN8" }, isUnique: true),
        new JdeIndex("F060116_12", "Unique Index on YAANPA, YAAN8", new[] { "YAANPA", "YAAN8" }, isUnique: true),
        new JdeIndex("F060116_13", "Unique Index on YAAN8, YAANPA", new[] { "YAAN8", "YAANPA" }, isUnique: true),
        new JdeIndex("F060116_14", "Index on YAAN8, YAJBCD, YAJBST", new[] { "YAAN8", "YAJBCD", "YAJBST" }),
        new JdeIndex("F060116_15", "Index on YAOEMP", new[] { "YAOEMP" }),
        new JdeIndex("F060116_17", "Index on YAHMCO, YAUN, YAHMCU, YAAN8", new[] { "YAHMCO", "YAUN", "YAHMCU", "YAAN8" }),
        new JdeIndex("F060116_2", "Index on YASSN", new[] { "YASSN" }),
        new JdeIndex("F060116_5", "Index on YAHMCU, YAJBCD, SYS_NC00212$, YAALPH", new[] { "YAHMCU", "YAJBCD", "SYS_NC00212$", "YAALPH" }),
        new JdeIndex("F060116_6", "Index on YAJBCD, SYS_NC00212$, YAALPH", new[] { "YAJBCD", "SYS_NC00212$", "YAALPH" }),
        new JdeIndex("F060116_7", "Index on YAUSR, YAUFLG", new[] { "YAUSR", "YAUFLG" }),
        new JdeIndex("F060116_8", "Index on YANRVW, YAANPA, YATINC", new[] { "YANRVW", "YAANPA", "YATINC" }),
        new JdeIndex("F060116_9", "Index on YAANPA, YATINC, YANRVW", new[] { "YAANPA", "YATINC", "YANRVW" })
    };
}
