...
/// F74U4051 - .
/// </summary>
public class F74U4051 : JdeTable
{
    /// <summary>
    ...
    /// <inheritdoc />
    public override string TableName => "F74U4051";
    ...
    {
        new JdeIndex("F74U4051_0", "Primary Key on HMU74ICR", new[] { "HMU74ICR" }, isUnique: true, isPrimaryKey: true),
        new JdeIndex("F74U4051_2", "Index on HMGPBT, HMGPTN", new[] { "HMGPBT", "HMGPTN" }),
        new JdeIndex("F74U4051_3", "Index on HMU74PEED", new[] { "HMU74PEED" })
    };
}
