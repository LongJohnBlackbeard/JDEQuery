...
public class F4106NC : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F4106NC";
    ...
    {
        new JdeIndex("F4106NC_0", "Primary Key on SZEDUS, SZEDBT, SZEDTN, SZEDLN", new[] { "SZEDUS", "SZEDBT", "SZEDTN", "SZEDLN" }, isUnique: true, isPrimaryKey: true)
    };
}
