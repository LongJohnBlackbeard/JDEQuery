...
public class F47047T : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F47047T";
    ...
    {
        new JdeIndex("F47047T_0", "Primary Key on UZEDOC, UZEDCT, UZEKCO, UZEDLN", new[] { "UZEDOC", "UZEDCT", "UZEKCO", "UZEDLN" }, isUnique: true, isPrimaryKey: true)
    };
}
