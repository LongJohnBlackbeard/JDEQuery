...
public class F3102 : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F3102";
    ...
    {
        new JdeIndex("F3102_0", "Primary Key on IGDOCO, IGITM, IGCOST, IGPART, IGMCU", new[] { "IGDOCO", "IGITM", "IGCOST", "IGPART", "IGMCU" }, isUnique: true, isPrimaryKey: true),
        new JdeIndex("F3102_1", "Index on IGDOCO, IGPART, IGITM, IGCOST", new[] { "IGDOCO", "IGPART", "IGITM", "IGCOST" }),
        new JdeIndex("F3102_2", "Index on IGDOCO, IGITM, IGCOST", new[] { "IGDOCO", "IGITM", "IGCOST" })
    };
}
