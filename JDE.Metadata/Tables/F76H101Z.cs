...
/// F76H101Z - .
/// </summary>
public class F76H101Z : JdeTable
{
    /// <summary>
    ...
    /// <inheritdoc />
    public override string TableName => "F76H101Z";
    ...
    {
        new JdeIndex("F76H101Z_0", "Primary Key on AHEDUS, AHEDBT, AHEDTN, AHEDLN", new[] { "AHEDUS", "AHEDBT", "AHEDTN", "AHEDLN" }, isUnique: true, isPrimaryKey: true)
    };
}
