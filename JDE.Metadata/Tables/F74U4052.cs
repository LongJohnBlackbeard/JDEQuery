...
/// F74U4052 - .
/// </summary>
public class F74U4052 : JdeTable
{
    /// <summary>
    ...
    /// <inheritdoc />
    public override string TableName => "F74U4052";
    ...
    {
        new JdeIndex("F74U4052_0", "Primary Key on SMU74ICR, SMU74LAN8", new[] { "SMU74ICR", "SMU74LAN8" }, isUnique: true, isPrimaryKey: true)
    };
}
