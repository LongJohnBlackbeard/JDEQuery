...
public class F47092 : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F47092";
    ...
    {
        new JdeIndex("F47092_0", "Primary Key on SZEDOC, SZEDCT, SZEKCO, SZEDLN", new[] { "SZEDOC", "SZEDCT", "SZEKCO", "SZEDLN" }, isUnique: true, isPrimaryKey: true)
    };
}
