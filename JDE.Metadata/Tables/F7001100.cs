...
/// F7001100 - .
/// </summary>
public class F7001100 : JdeTable
{
    /// <summary>
    ...
    /// <inheritdoc />
    public override string TableName => "F7001100";
    ...
    {
        new JdeIndex("F7001100_0", "Primary Key on LAAN8, LALCTR, LAK70ADSTR", new[] { "LAAN8", "LALCTR", "LAK70ADSTR" }, isUnique: true, isPrimaryKey: true)
    };
}
