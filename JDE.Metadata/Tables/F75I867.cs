...
public class F75I867 : JdeTable
{
    ...
    public static class Columns
    {
        ...
        /// RGRTN.
        /// </summary>
        public const string RGRTN = "RGRTN";
    ...
    /// <inheritdoc />
    public override string TableName => "F75I867";
    ...
    {
        new JdeField("RGRTN", "RGRTN", JdeDataType.Numeric, null, true, true),
        ...
        new JdeField("RGEFTJ", "RGEFTJ", JdeDataType.Numeric),
    ...
    {
        new JdeIndex("F75I867_0", "Primary Key on RGRTN", new[] { "RGRTN" }, isUnique: true, isPrimaryKey: true)
    };
}
