...
/// F76AUI24 - .
/// </summary>
public class F76AUI24 : JdeTable
{
    /// <summary>
    ...
    public static class Columns
    {
        ...
        /// TICTID.
        /// </summary>
        public const string TICTID = "TICTID";
    ...
    /// <inheritdoc />
    public override string TableName => "F76AUI24";
    ...
    public override IReadOnlyList<IJdeField> Fields { get; } = new List<IJdeField>
    {
        ...
        new JdeField("TICTID", "TICTID", JdeDataType.String, 30, true, true),
    ...
    {
        new JdeIndex("F76AUI24_0", "Primary Key on TICTID, TIJOBS, TIKCO, TIDCT, TIDOC, TISFX, TIDCTM, TIDOCM, TIATXC", new[] { "TICTID", "TIJOBS", "TIKCO", "TIDCT", "TIDOC", "TISFX", "TIDCTM", "TIDOCM", "TIATXC" }, isUnique: true, isPrimaryKey: true),
        new JdeIndex("F76AUI24_2", "Index on TICTID, TIJOBS", new[] { "TICTID", "TIJOBS" }),
        new JdeIndex("F76AUI24_3", "Index on TICTID, TIJOBS, TIKCO, TIDCT, TIDOC, TIDCTM, TIDOCM, TIATXC", new[] { "TICTID", "TIJOBS", "TIKCO", "TIDCT", "TIDOC", "TIDCTM", "TIDOCM", "TIATXC" })
    };
}
