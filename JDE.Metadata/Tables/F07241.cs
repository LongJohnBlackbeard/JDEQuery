...
public class F07241 : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F07241";
    ...
    {
        new JdeIndex("F07241_0", "Primary Key on YSGICU, YSPRTR, YSUKID", new[] { "YSGICU", "YSPRTR", "YSUKID" }, isUnique: true, isPrimaryKey: true),
        new JdeIndex("F07241_2", "Index on YSPRTR, YSGICU", new[] { "YSPRTR", "YSGICU" })
    };
}
