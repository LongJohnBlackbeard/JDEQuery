...
public class F39063 : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F39063";
    ...
    {
        new JdeIndex("F39063_0", "Primary Key on SUCRCD, SUSVYR, SUPNC, SUITPL, SUITM, SUCO, SUMCU, SUQRCT", new[] { "SUCRCD", "SUSVYR", "SUPNC", "SUITPL", "SUITM", "SUCO", "SUMCU", "SUQRCT" }, isUnique: true, isPrimaryKey: true)
    };
}
