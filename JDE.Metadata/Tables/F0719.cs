...
public class F0719 : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F0719";
    ...
    {
        new JdeIndex("F0719_0", "Primary Key on Y$AN8, Y$CKCN, Y$PPED, Y$PDBA, Y$UKID", new[] { "Y$AN8", "Y$CKCN", "Y$PPED", "Y$PDBA", "Y$UKID" }, isUnique: true, isPrimaryKey: true),
        new JdeIndex("F0719_2", "Index on Y$AN8, Y$PDBA", new[] { "Y$AN8", "Y$PDBA" }),
        new JdeIndex("F0719_3", "Index on Y$AN8, Y$CKCN, Y$PDBA, Y$WANO", new[] { "Y$AN8", "Y$CKCN", "Y$PDBA", "Y$WANO" })
    };
}
