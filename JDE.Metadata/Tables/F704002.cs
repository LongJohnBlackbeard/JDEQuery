...
public class F704002 : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F704002";
    ...
    {
        new JdeIndex("F704002_0", "Primary Key on PFK70BTXC, PFPYID, PFDCTM, PFDOCM, PFOKCO, PFODCT, PFODOC, PFOSFX, PFKCO, PFDCT, PFDOC, PFSFX, PFSFXE", new[] { "PFK70BTXC", "PFPYID", "PFDCTM", "PFDOCM", "PFOKCO", "PFODCT", "PFODOC", "PFOSFX", "PFKCO", "PFDCT", "PFDOC", "PFSFX", "PFSFXE" }, isUnique: true, isPrimaryKey: true),
        new JdeIndex("F704002_3", "Index on PFK70BTXC, PFKCO, PFDCT, PFDOC, PFSFX, PFSFXE", new[] { "PFK70BTXC", "PFKCO", "PFDCT", "PFDOC", "PFSFX", "PFSFXE" }),
        new JdeIndex("F704002_4", "Index on PFK70BTXC, PFOKCO, PFODCT, PFODOC, PFOSFX", new[] { "PFK70BTXC", "PFOKCO", "PFODCT", "PFODOC", "PFOSFX" }),
        new JdeIndex("F704002_5", "Index on PFK70BTXC, PFPYID", new[] { "PFK70BTXC", "PFPYID" }),
        new JdeIndex("F704002_6", "Index on PFPYID", new[] { "PFPYID" })
    };
}
