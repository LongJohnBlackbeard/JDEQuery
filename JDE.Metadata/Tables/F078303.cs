...
public class F078303 : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F078303";
    ...
    {
        new JdeIndex("F078303_0", "Primary Key on YFUKID", new[] { "YFUKID" }, isUnique: true, isPrimaryKey: true)
    };
}
