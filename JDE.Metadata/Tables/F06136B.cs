...
public class F06136B : JdeTable
{
    ...
    public static class Columns
    {
        ...
        /// YZINTEGER.
        /// </summary>
        public const string YZINTEGER = "YZINTEGER";

        /// <summary>
        /// YZTXOF.
        /// </summary>
        public const string YZTXOF = "YZTXOF";

        /// <summary>
        /// YZRTAM.
        /// </summary>
        public const string YZRTAM = "YZRTAM";
        ...
        /// YZMATH01.
        /// </summary>
        public const string YZMATH01 = "YZMATH01";

        /// <summary>
        /// YZMATH02.
        /// </summary>
        public const string YZMATH02 = "YZMATH02";

        /// <summary>
        /// YZMATH03.
        /// </summary>
        public const string YZMATH03 = "YZMATH03";

        /// <summary>
        /// YZINT01.
        /// </summary>
        public const string YZINT01 = "YZINT01";

        /// <summary>
        /// YZINT02.
        /// </summary>
        public const string YZINT02 = "YZINT02";

        /// <summary>
        /// YZINT03.
        /// </summary>
        public const string YZINT03 = "YZINT03";
        ...
        /// YZDESC02.
        /// </summary>
        public const string YZDESC02 = "YZDESC02";

        /// <summary>
        /// YZDESC3.
        /// </summary>
        public const string YZDESC3 = "YZDESC3";
    ...
    /// <inheritdoc />
    public override string TableName => "F06136B";
    ...
    public override IReadOnlyList<IJdeField> Fields { get; } = new List<IJdeField>
    {
        ...
        new JdeField("YZINTEGER", "YZINTEGER", JdeDataType.Numeric, null, true, true),
        new JdeField("YZTXOF", "YZTXOF", JdeDataType.String, 2),
        new JdeField("YZRTAM", "YZRTAM", JdeDataType.Numeric),
        ...
        new JdeField("YZMATH01", "YZMATH01", JdeDataType.Numeric),
        new JdeField("YZMATH02", "YZMATH02", JdeDataType.Numeric),
        new JdeField("YZMATH03", "YZMATH03", JdeDataType.Numeric),
        new JdeField("YZINT01", "YZINT01", JdeDataType.Numeric),
        new JdeField("YZINT02", "YZINT02", JdeDataType.Numeric),
        new JdeField("YZINT03", "YZINT03", JdeDataType.Numeric),
        new JdeField("YZDESC", "YZDESC", JdeDataType.String, 60),
        new JdeField("YZDESC02", "YZDESC02", JdeDataType.String, 90),
        new JdeField("YZDESC3", "YZDESC3", JdeDataType.String, 60),
    ...
    {
        new JdeIndex("F06136B_0", "Primary Key on YZAN8, YZTHTY, YZTARA, YZPTAX, YZDTEY, YZTAXX, YZHMCO, YZSCDC, YZINTEGER", new[] { "YZAN8", "YZTHTY", "YZTARA", "YZPTAX", "YZDTEY", "YZTAXX", "YZHMCO", "YZSCDC", "YZINTEGER" }, isUnique: true, isPrimaryKey: true)
    };
}
