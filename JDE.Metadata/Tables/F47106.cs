...
public class F47106 : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F47106";
    ...
    {
        new JdeIndex("F47106_0", "Primary Key on SYEDOC, SYEDCT, SYEKCO", new[] { "SYEDOC", "SYEDCT", "SYEKCO" }, isUnique: true, isPrimaryKey: true)
    };
}
