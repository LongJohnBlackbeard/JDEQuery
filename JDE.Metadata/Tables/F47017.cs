...
public class F47017 : JdeTable
{
    ...
    public static class Columns
    {
        ...
        /// SZCRAM.
        /// </summary>
        public const string SZCRAM = "SZCRAM";
    ...
    /// <inheritdoc />
    public override string TableName => "F47017";
    ...
    public override IReadOnlyList<IJdeField> Fields { get; } = new List<IJdeField>
    {
        ...
        new JdeField("SZCRAM", "SZCRAM", JdeDataType.Numeric),
    ...
    {
        new JdeIndex("F47017_0", "Primary Key on SZEDOC, SZEDCT, SZEKCO, SZEDLN", new[] { "SZEDOC", "SZEDCT", "SZEKCO", "SZEDLN" }, isUnique: true, isPrimaryKey: true)
    };
}
