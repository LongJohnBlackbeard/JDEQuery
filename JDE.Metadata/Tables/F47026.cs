...
public class F47026 : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F47026";
    ...
    {
        new JdeIndex("F47026_0", "Primary Key on SYEDOC, SYEDCT, SYEKCO", new[] { "SYEDOC", "SYEDCT", "SYEKCO" }, isUnique: true, isPrimaryKey: true)
    };
}
