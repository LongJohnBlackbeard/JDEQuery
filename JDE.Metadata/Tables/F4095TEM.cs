...
/// F4095TEM - .
/// </summary>
public class F4095TEM : JdeTable
{
    /// <summary>
    ...
    /// <inheritdoc />
    public override string TableName => "F4095TEM";
    ...
    public override IReadOnlyList<IJdeField> Fields { get; } = new List<IJdeField>
    {
        ...
        new JdeField("MLMCU", "MLMCU", JdeDataType.String, 24, true, true),
        new JdeField("MLOBJ", "MLOBJ", JdeDataType.String, 12, true, true),
        new JdeField("MLSUB", "MLSUB", JdeDataType.String, 16, true, true)
    };

    /// <inheritdoc />
    public override IReadOnlyList<IJdeIndex> Indexes { get; } = new List<IJdeIndex>
    {
        new JdeIndex("F4095TEM_0", "Primary Key on MLANUM, MLCO, MLDCTO, MLDCT, MLGLPT, MLCOST, MLMCU, MLOBJ, MLSUB", new[] { "MLANUM", "MLCO", "MLDCTO", "MLDCT", "MLGLPT", "MLCOST", "MLMCU", "MLOBJ", "MLSUB" }, isUnique: true, isPrimaryKey: true)
    };
}
