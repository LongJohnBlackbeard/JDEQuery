...
public class F42119 : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F42119";
    ...
    {
        new JdeIndex("F42119_0", "Primary Key on SDDOCO, SDDCTO, SDKCOO, SDLNID", new[] { "SDDOCO", "SDDCTO", "SDKCOO", "SDLNID" }, isUnique: true, isPrimaryKey: true),
        new JdeIndex("F42119_10", "Index on SDDOCO, SDSO16", new[] { "SDDOCO", "SDSO16" }),
        new JdeIndex("F42119_11", "Index on SDDOCO, SDDCTO, SDKCOO, SDKITID, SDLNID", new[] { "SDDOCO", "SDDCTO", "SDKCOO", "SDKITID", "SDLNID" }),
        new JdeIndex("F42119_12", "Index on SDTRDJ, SDAN8, SDITM, SDUPRC, SDUNCS, SDAEXP, SDECST, SDDOCO, SDMCU, SDUOM4, SDCMCO, SDKCOO, SDKTLN, SDUORG, SDLTTR, SDDCTO", new[] { "SDTRDJ", "SDAN8", "SDITM", "SDUPRC", "SDUNCS", "SDAEXP", "SDECST", "SDDOCO", "SDMCU", "SDUOM4", "SDCMCO", "SDKCOO", "SDKTLN", "SDUORG", "SDLTTR", "SDDCTO" }),
        new JdeIndex("F42119_13", "Index on SDAN8, SDITM, SYS_NC00269$, SYS_NC00270$", new[] { "SDAN8", "SDITM", "SYS_NC00269$", "SYS_NC00270$" }),
        new JdeIndex("F42119_2", "Index on SDITM, SDMCU, SDDRQJ", new[] { "SDITM", "SDMCU", "SDDRQJ" }),
        new JdeIndex("F42119_3", "Index on SDDCTO, SDNXTR, SDLNTY", new[] { "SDDCTO", "SDNXTR", "SDLNTY" }),
        new JdeIndex("F42119_4", "Index on SDOORN, SDOCTO, SDOKCO", new[] { "SDOORN", "SDOCTO", "SDOKCO" }),
        new JdeIndex("F42119_8", "Index on SDAN8, SDTRDJ", new[] { "SDAN8", "SDTRDJ" }),
        new JdeIndex("F42119_9", "Index on SDSHAN", new[] { "SDSHAN" })
    };
}
