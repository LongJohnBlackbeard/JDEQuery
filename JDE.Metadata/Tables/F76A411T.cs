...
/// F76A411T - .
/// </summary>
public class F76A411T : JdeTable
{
    /// <summary>
    ...
    /// <inheritdoc />
    public override string TableName => "F76A411T";
    ...
    {
        new JdeIndex("F76A411T_0", "Primary Key on B1DOC, B1DCT, B1KCO, B1SFX, B1SFXE", new[] { "B1DOC", "B1DCT", "B1KCO", "B1SFX", "B1SFXE" }, isUnique: true, isPrimaryKey: true)
    };
}
