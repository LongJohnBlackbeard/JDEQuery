...
public class F3908 : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F3908";
    ...
    {
        new JdeIndex("F3908_0", "Primary Key on CSCRCD, CSCO, CSITPL, CSITM, CSEFTE", new[] { "CSCRCD", "CSCO", "CSITPL", "CSITM", "CSEFTE" }, isUnique: true, isPrimaryKey: true)
    };
}
