...
public class F1201P : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F1201P";
    ...
    {
        new JdeIndex("F1201P_0", "Primary Key on FANUMB", new[] { "FANUMB" }, isUnique: true, isPrimaryKey: true)
    };
}
