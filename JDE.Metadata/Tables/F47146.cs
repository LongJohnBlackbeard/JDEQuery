...
public class F47146 : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F47146";
    ...
    {
        new JdeIndex("F47146_0", "Primary Key on SYEDOC, SYEDCT, SYEKCO", new[] { "SYEDOC", "SYEDCT", "SYEKCO" }, isUnique: true, isPrimaryKey: true)
    };
}
