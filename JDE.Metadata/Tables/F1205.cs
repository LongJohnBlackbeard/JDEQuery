...
public class F1205 : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F1205";
    ...
    {
        new JdeIndex("F1205_0", "Primary Key on FTNUMB, FTDTEJ, FTTDAY", new[] { "FTNUMB", "FTDTEJ", "FTTDAY" }, isUnique: true, isPrimaryKey: true)
    };
}
