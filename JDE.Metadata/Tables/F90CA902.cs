...
/// F90CA902 - .
/// </summary>
public class F90CA902 : JdeTable
{
    /// <summary>
    ...
    public static class Columns
    {
        ...
        /// EEAN8.
        /// </summary>
        public const string EEAN8 = "EEAN8";

        /// <summary>
        /// EEPELNID.
        /// </summary>
        public const string EEPELNID = "EEPELNID";

        /// <summary>
        /// EEPESEQ.
        /// </summary>
        public const string EEPESEQ = "EEPESEQ";
    ...
    /// <inheritdoc />
    public override string TableName => "F90CA902";
    ...
    {
        new JdeField("EEAN8", "EEAN8", JdeDataType.Numeric, null, true, true),
        new JdeField("EEPELNID", "EEPELNID", JdeDataType.Numeric, null, true, true),
        new JdeField("EEPESEQ", "EEPESEQ", JdeDataType.Numeric, null, true, true),
    ...
    {
        new JdeIndex("F90CA902_0", "Primary Key on EEAN8, EEPELNID, EEPESEQ", new[] { "EEAN8", "EEPELNID", "EEPESEQ" }, isUnique: true, isPrimaryKey: true)
    };
}
