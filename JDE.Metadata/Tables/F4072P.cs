...
public class F4072P : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F4072P";
    ...
    {
        new JdeIndex("F4072P_0", "Primary Key on ADITM, ADAST, ADAN8, ADIGID, ADCGID, ADOGID, ADCRCD, ADUOM, ADMNQ, ADEXDJ, ADTDAY, ADUKID", new[] { "ADITM", "ADAST", "ADAN8", "ADIGID", "ADCGID", "ADOGID", "ADCRCD", "ADUOM", "ADMNQ", "ADEXDJ", "ADTDAY", "ADUKID" }, isUnique: true, isPrimaryKey: true),
        new JdeIndex("F4072P_2", "Index on ADAST, ADITM, ADCRCD, ADUOM, ADMNQ, ADEXDJ, ADIGID, ADCGID", new[] { "ADAST", "ADITM", "ADCRCD", "ADUOM", "ADMNQ", "ADEXDJ", "ADIGID", "ADCGID" }),
        new JdeIndex("F4072P_3", "Index on ADAST, ADATID", new[] { "ADAST", "ADATID" }),
        new JdeIndex("F4072P_4", "Index on ADAST, ADITM, ADAN8, ADIGID, ADOGID, ADCGID, ADCRCD, ADUOM, SYS_NC00039$, ADEXDJ", new[] { "ADAST", "ADITM", "ADAN8", "ADIGID", "ADOGID", "ADCGID", "ADCRCD", "ADUOM", "SYS_NC00039$", "ADEXDJ" }),
        new JdeIndex("F4072P_5", "Index on ADAST, ADITM, ADAN8, ADIGID, ADCGID, ADOGID, ADCRCD, ADUOM, ADMNQ, ADEXDJ, ADPID", new[] { "ADAST", "ADITM", "ADAN8", "ADIGID", "ADCGID", "ADOGID", "ADCRCD", "ADUOM", "ADMNQ", "ADEXDJ", "ADPID" }),
        new JdeIndex("F4072P_6", "Index on ADBKTPID, SYS_NC00039$", new[] { "ADBKTPID", "SYS_NC00039$" }),
        new JdeIndex("F4072P_7", "Index on ADAN8", new[] { "ADAN8" })
    };
}
