...
public class F76A19P : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F76A19P";
    ...
    {
        new JdeIndex("F76A19P_0", "Primary Key on TIKCO, TIDCT, TIDOC, TISFX, TIDCTM, TIDOCM, TIATXC", new[] { "TIKCO", "TIDCT", "TIDOC", "TISFX", "TIDCTM", "TIDOCM", "TIATXC" }, isUnique: true, isPrimaryKey: true)
    };
}
