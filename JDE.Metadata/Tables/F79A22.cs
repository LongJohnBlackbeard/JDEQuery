...
public class F79A22 : JdeTable
{
    ...
    public static class Columns
    {
        ...
        /// GTLNIX.
        /// </summary>
        public const string GTLNIX = "GTLNIX";
    ...
    /// <inheritdoc />
    public override string TableName => "F79A22";
    ...
    public override IReadOnlyList<IJdeField> Fields { get; } = new List<IJdeField>
    {
        ...
        new JdeField("GTLNIX", "GTLNIX", JdeDataType.Numeric, null, true, true),
    ...
    {
        new JdeIndex("F79A22_0", "Primary Key on GTUKID, GTLNIX, GT79AGETY", new[] { "GTUKID", "GTLNIX", "GT79AGETY" }, isUnique: true, isPrimaryKey: true)
    };
}
