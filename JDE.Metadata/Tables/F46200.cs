...
public class F46200 : JdeTable
{
    ...
    public static class Columns
    {
        ...
        /// BRDQCO.
        /// </summary>
        public const string BRDQCO = "BRDQCO";
    }

    /// <inheritdoc />
    public override string TableName => "F46200";
    ...
    public override IReadOnlyList<IJdeField> Fields { get; } = new List<IJdeField>
    {
        ...
        new JdeField("BRDQCO", "BRDQCO", JdeDataType.Numeric)
    };

    /// <inheritdoc />
    public override IReadOnlyList<IJdeIndex> Indexes { get; } = new List<IJdeIndex>
    {
        new JdeIndex("F46200_0", "Primary Key on BRMCU, BRRQBT, BRRQSQ", new[] { "BRMCU", "BRRQBT", "BRRQSQ" }, isUnique: true, isPrimaryKey: true),
        new JdeIndex("F46200_2", "Index on BRMCU, BRBRBT, BRBRSN, BRCNPR", new[] { "BRMCU", "BRBRBT", "BRBRSN", "BRCNPR" }),
        new JdeIndex("F46200_3", "Index on BRMCU, BRDOCO, BRDCTO, BRKCOO, BRLNID", new[] { "BRMCU", "BRDOCO", "BRDCTO", "BRKCOO", "BRLNID" }),
        new JdeIndex("F46200_4", "Index on BRMCU, BRUKID", new[] { "BRMCU", "BRUKID" })
    };
}
