...
public class F078306 : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F078306";
    ...
    {
        new JdeIndex("F078306_0", "Primary Key on YFUKID", new[] { "YFUKID" }, isUnique: true, isPrimaryKey: true)
    };
}
