...
/// F4600TP1 - .
/// </summary>
public class F4600TP1 : JdeTable
{
    /// <summary>
    ...
    /// <inheritdoc />
    public override string TableName => "F4600TP1";
    ...
    {
        new JdeIndex("F4600TP1_0", "Primary Key on R1RQBT, R1RQSQ", new[] { "R1RQBT", "R1RQSQ" }, isUnique: true, isPrimaryKey: true)
    };
}
