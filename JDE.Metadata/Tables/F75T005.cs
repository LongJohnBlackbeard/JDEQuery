...
public class F75T005 : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F75T005";
    ...
    {
        new JdeIndex("F75T005_0", "Primary Key on TD75TTNF, TD75TRAS, TD75TYMH, TD75TVTT, TD75TLID", new[] { "TD75TTNF", "TD75TRAS", "TD75TYMH", "TD75TVTT", "TD75TLID" }, isUnique: true, isPrimaryKey: true),
        new JdeIndex("F75T005_2", "Index on TDKCOO, TDDCTO, TDDOCO, TDLNID", new[] { "TDKCOO", "TDDCTO", "TDDOCO", "TDLNID" })
    };
}
