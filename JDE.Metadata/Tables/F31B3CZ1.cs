...
/// F31B3CZ1 - .
/// </summary>
public class F31B3CZ1 : JdeTable
{
    /// <summary>
    ...
    public static class Columns
    {
        ...
        /// SZWCOST.
        /// </summary>
        public const string SZWCOST = "SZWCOST";
    ...
    /// <inheritdoc />
    public override string TableName => "F31B3CZ1";
    ...
    public override IReadOnlyList<IJdeField> Fields { get; } = new List<IJdeField>
    {
        ...
        new JdeField("SZWCOST", "SZWCOST", JdeDataType.String, 24),
    ...
    {
        new JdeIndex("F31B3CZ1_0", "Primary Key on SZEDUS, SZEDBT, SZEDTN, SZEDLN", new[] { "SZEDUS", "SZEDBT", "SZEDTN", "SZEDLN" }, isUnique: true, isPrimaryKey: true),
        new JdeIndex("F31B3CZ1_11", "Index on SZEDUS, SZEDBT, SZEDTN", new[] { "SZEDUS", "SZEDBT", "SZEDTN" }),
        new JdeIndex("F31B3CZ1_13", "Index on SZEDBT, SZEDTN, SZWAPRN, SZWCOST", new[] { "SZEDBT", "SZEDTN", "SZWAPRN", "SZWCOST" }),
        new JdeIndex("F31B3CZ1_14", "Index on SZEDUS, SZEDBT, SZEDTN, SYS_NC00032$", new[] { "SZEDUS", "SZEDBT", "SZEDTN", "SYS_NC00032$" }),
        new JdeIndex("F31B3CZ1_15", "Index on SZWAPRN, SZEDLN", new[] { "SZWAPRN", "SZEDLN" }),
        new JdeIndex("F31B3CZ1_8", "Index on SZEDUS, SZEDBT, SZEDTN, SZEDSP", new[] { "SZEDUS", "SZEDBT", "SZEDTN", "SZEDSP" }),
        new JdeIndex("F31B3CZ1_9", "Index on SZEDUS, SZEDBT, SZEDSP", new[] { "SZEDUS", "SZEDBT", "SZEDSP" })
    };
}
