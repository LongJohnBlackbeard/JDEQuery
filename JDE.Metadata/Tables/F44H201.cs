...
public class F44H201 : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F44H201";
    ...
    {
        new JdeIndex("F44H201_0", "Primary Key on LMHBMCUS, LMHBLOT", new[] { "LMHBMCUS", "LMHBLOT" }, isUnique: true, isPrimaryKey: true),
        new JdeIndex("F44H201_2", "Index on LMHBMCUS, LMHBPLAN, LMHBELEV", new[] { "LMHBMCUS", "LMHBPLAN", "LMHBELEV" })
    };
}
