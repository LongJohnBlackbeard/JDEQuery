...
public class F47091 : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F47091";
    ...
    {
        new JdeIndex("F47091_0", "Primary Key on SYEDOC, SYEDCT, SYEKCO", new[] { "SYEDOC", "SYEDCT", "SYEKCO" }, isUnique: true, isPrimaryKey: true)
    };
}
