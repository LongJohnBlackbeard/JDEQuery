...
public class F1204P : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F1204P";
    ...
    {
        new JdeIndex("F1204P_0", "Primary Key on FMNNBR", new[] { "FMNNBR" }, isUnique: true, isPrimaryKey: true)
    };
}
