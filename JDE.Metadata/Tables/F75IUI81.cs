...
/// F75IUI81 - .
/// </summary>
public class F75IUI81 : JdeTable
{
    /// <summary>
    ...
    public static class Columns
    {
        ...
        /// WFYTYP.
        /// </summary>
        public const string WFYTYP = "WFYTYP";
        ...
        /// WFI75ORST.
        /// </summary>
        public const string WFI75ORST = "WFI75ORST";
        ...
        /// WFI75IPOS.
        /// </summary>
        public const string WFI75IPOS = "WFI75IPOS";
    }

    /// <inheritdoc />
    public override string TableName => "F75IUI81";
    ...
    public override IReadOnlyList<IJdeField> Fields { get; } = new List<IJdeField>
    {
        ...
        new JdeField("WFYTYP", "WFYTYP", JdeDataType.String, 2),
        ...
        new JdeField("WFI75ORST", "WFI75ORST", JdeDataType.String, 6),
        ...
        new JdeField("WFI75IPOS", "WFI75IPOS", JdeDataType.String, 4)
    };

    /// <inheritdoc />
    public override IReadOnlyList<IJdeIndex> Indexes { get; } = new List<IJdeIndex>
    {
        new JdeIndex("F75IUI81_0", "Primary Key on WFKCO, WFDOC, WFDCT, WFSFX, WFSFXE, WFUSER, WFJOBS", new[] { "WFKCO", "WFDOC", "WFDCT", "WFSFX", "WFSFXE", "WFUSER", "WFJOBS" }, isUnique: true, isPrimaryKey: true)
    };
}
