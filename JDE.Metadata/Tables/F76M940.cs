...
public class F76M940 : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F76M940";
    ...
    {
        new JdeIndex("F76M940_0", "Primary Key on APPYID, APRC5", new[] { "APPYID", "APRC5" }, isUnique: true, isPrimaryKey: true),
        new JdeIndex("F76M940_2", "Index on APM76JEKCO, APM76JEDCT, APM76JEDOC, APM76JELN, APM76JEDGJ, APM76JELT, APM76EXTL", new[] { "APM76JEKCO", "APM76JEDCT", "APM76JEDOC", "APM76JELN", "APM76JEDGJ", "APM76JELT", "APM76EXTL" }),
        new JdeIndex("F76M940_3", "Index on APDOC, APDCT, APKCO, APSFX, APSFXE", new[] { "APDOC", "APDCT", "APKCO", "APSFX", "APSFXE" })
    };
}
