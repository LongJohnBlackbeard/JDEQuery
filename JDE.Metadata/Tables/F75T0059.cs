...
/// F75T0059 - .
/// </summary>
public class F75T0059 : JdeTable
{
    /// <summary>
    ...
    /// <inheritdoc />
    public override string TableName => "F75T0059";
    ...
    {
        new JdeIndex("F75T0059_0", "Primary Key on TD75TTNF, TD75TRAS, TD75TLID, TD75TYMH, TD75TVTT", new[] { "TD75TTNF", "TD75TRAS", "TD75TLID", "TD75TYMH", "TD75TVTT" }, isUnique: true, isPrimaryKey: true),
        new JdeIndex("F75T0059_2", "Index on TDKCOO, TDDCTO, TDDOCO, TDLNID", new[] { "TDKCOO", "TDDCTO", "TDDOCO", "TDLNID" })
    };
}
