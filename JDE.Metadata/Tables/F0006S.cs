...
public class F0006S : JdeTable
{
    ...
    public static class Columns
    {
        ...
        /// MCSEFT.
        /// </summary>
        public const string MCSEFT = "MCSEFT";

        /// <summary>
        /// MCSVER.
        /// </summary>
        public const string MCSVER = "MCSVER";
        ...
        /// MCFFU1.
        /// </summary>
        public const string MCFFU1 = "MCFFU1";

        /// <summary>
        /// MCFFU3.
        /// </summary>
        public const string MCFFU3 = "MCFFU3";

        /// <summary>
        /// MCFFU4.
        /// </summary>
        public const string MCFFU4 = "MCFFU4";
    ...
    /// <inheritdoc />
    public override string TableName => "F0006S";
    ...
    {
        new JdeField("MCSEFT", "MCSEFT", JdeDataType.Numeric, null, true, true),
        new JdeField("MCSVER", "MCSVER", JdeDataType.String, 20, true, true),
        ...
        new JdeField("MCFFU1", "MCFFU1", JdeDataType.String, 2),
        new JdeField("MCFFU3", "MCFFU3", JdeDataType.String, 20),
        new JdeField("MCFFU4", "MCFFU4", JdeDataType.Numeric),
    ...
    {
        new JdeIndex("F0006S_0", "Primary Key on MCSEFT, MCSVER, MCMCU", new[] { "MCSEFT", "MCSVER", "MCMCU" }, isUnique: true, isPrimaryKey: true)
    };
}
