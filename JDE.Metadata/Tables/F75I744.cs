...
public class F75I744 : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F75I744";
    ...
    {
        new JdeIndex("F75I744_0", "Primary Key on PFPYID, PFRC5", new[] { "PFPYID", "PFRC5" }, isUnique: true, isPrimaryKey: true)
    };
}
