...
public class F31172S : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F31172S";
    ...
    {
        new JdeIndex("F31172S_0", "Primary Key on WSDOCO, WSOPSQ, WSOPSC, WSMCU", new[] { "WSDOCO", "WSOPSQ", "WSOPSC", "WSMCU" }, isUnique: true, isPrimaryKey: true)
    };
}
