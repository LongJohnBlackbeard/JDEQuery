...
public class F079440 : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F079440";
    ...
    {
        new JdeIndex("F079440_0", "Primary Key on PWAN8, PWDWK, PWPRTR", new[] { "PWAN8", "PWDWK", "PWPRTR" }, isUnique: true, isPrimaryKey: true),
        new JdeIndex("F079440_2", "Index on PWAN8, PWCKCN", new[] { "PWAN8", "PWCKCN" })
    };
}
