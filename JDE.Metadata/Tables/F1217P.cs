...
public class F1217P : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F1217P";
    ...
    {
        new JdeIndex("F1217P_0", "Primary Key on WRNUMB", new[] { "WRNUMB" }, isUnique: true, isPrimaryKey: true),
        new JdeIndex("F1217P_2", "Index on WRKCOO, WRDOCO, WRDCTO, WRLNID", new[] { "WRKCOO", "WRDOCO", "WRDCTO", "WRLNID" })
    };
}
