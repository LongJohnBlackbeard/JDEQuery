...
/// F7420034 - .
/// </summary>
public class F7420034 : JdeTable
{
    /// <summary>
    ...
    /// <inheritdoc />
    public override string TableName => "F7420034";
    ...
    {
        new JdeIndex("F7420034_0", "Primary Key on PIKCO, PIDCT, PIDOC, PISEQ", new[] { "PIKCO", "PIDCT", "PIDOC", "PISEQ" }, isUnique: true, isPrimaryKey: true)
    };
}
