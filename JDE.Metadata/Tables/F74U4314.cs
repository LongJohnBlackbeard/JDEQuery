...
/// F74U4314 - .
/// </summary>
public class F74U4314 : JdeTable
{
    /// <summary>
    ...
    /// <inheritdoc />
    public override string TableName => "F74U4314";
    ...
    {
        new JdeIndex("F74U4314_0", "Primary Key on SDKCOO, SDDOCO, SDDCTO, SDSFXO, SD74URLN", new[] { "SDKCOO", "SDDOCO", "SDDCTO", "SDSFXO", "SD74URLN" }, isUnique: true, isPrimaryKey: true),
        new JdeIndex("F74U4314_2", "Unique Index on SDKCOO, SDDOCO, SDDCTO, SDSFXO, SDEFTE", new[] { "SDKCOO", "SDDOCO", "SDDCTO", "SDSFXO", "SDEFTE" }, isUnique: true)
    };
}
