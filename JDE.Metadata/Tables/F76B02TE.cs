...
/// F76B02TE - .
/// </summary>
public class F76B02TE : JdeTable
{
    /// <summary>
    ...
    public static class Columns
    {
        ...
        /// FHSEQ.
        /// </summary>
        public const string FHSEQ = "FHSEQ";
    ...
    /// <inheritdoc />
    public override string TableName => "F76B02TE";
    ...
    public override IReadOnlyList<IJdeField> Fields { get; } = new List<IJdeField>
    {
        ...
        new JdeField("FHSEQ", "FHSEQ", JdeDataType.Numeric, null, true, true),
    ...
    {
        new JdeIndex("F76B02TE_0", "Primary Key on FHBNNF, FHBSER, FHN001, FHDCT, FHSEQ", new[] { "FHBNNF", "FHBSER", "FHN001", "FHDCT", "FHSEQ" }, isUnique: true, isPrimaryKey: true),
        new JdeIndex("F76B02TE_2", "Index on FHB76ELN", new[] { "FHB76ELN" }),
        new JdeIndex("F76B02TE_3", "Index on FHB76ERN", new[] { "FHB76ERN" }),
        new JdeIndex("F76B02TE_4", "Index on FHBNNF, FHBSER, FHN001, FHDCT, SYS_NC00031$", new[] { "FHBNNF", "FHBSER", "FHN001", "FHDCT", "SYS_NC00031$" })
    };
}
