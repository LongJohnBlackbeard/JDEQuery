...
public class F40338R : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F40338R";
    ...
    public override IReadOnlyList<IJdeField> Fields { get; } = new List<IJdeField>
    {
        ...
        new JdeField("PTCS38", "PTCS38", JdeDataType.String, 16),
        new JdeField("PTITM", "PTITM", JdeDataType.Numeric),
        new JdeField("PTIT38", "PTIT38", JdeDataType.String, 16),
    ...
    {
        new JdeIndex("F40338R_0", "Primary Key on PTUKID", new[] { "PTUKID" }, isUnique: true, isPrimaryKey: true),
        new JdeIndex("F40338R_2", "Index on PTAN8, PTCS38, PTITM, PTIT38, PTEXDJ, PTMXQ, PTUOM, PTPTC, PTUPMJ, PTTDAY", new[] { "PTAN8", "PTCS38", "PTITM", "PTIT38", "PTEXDJ", "PTMXQ", "PTUOM", "PTPTC", "PTUPMJ", "PTTDAY" })
    };
}
