...
public class F74H409 : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F74H409";
    ...
    {
        new JdeIndex("F74H409_0", "Primary Key on GLKCO, GLDCT, GLDOC", new[] { "GLKCO", "GLDCT", "GLDOC" }, isUnique: true, isPrimaryKey: true),
        new JdeIndex("F74H409_2", "Index on GLOKCO, GLODCT, GLODOC, GLVOID", new[] { "GLOKCO", "GLODCT", "GLODOC", "GLVOID" })
    };
}
