...
/// F48SUI01 - .
/// </summary>
public class F48SUI01 : JdeTable
{
    /// <summary>
    ...
    /// <inheritdoc />
    public override string TableName => "F48SUI01";
    ...
    {
        new JdeIndex("F48SUI01_0", "Primary Key on WDBCI, WDDGL, WDSBSQ, WDPRSQ, WDSCSQ, WDSLNK, WDCLNK, WDCCOD", new[] { "WDBCI", "WDDGL", "WDSBSQ", "WDPRSQ", "WDSCSQ", "WDSLNK", "WDCLNK", "WDCCOD" }, isUnique: true, isPrimaryKey: true),
        new JdeIndex("F48SUI01_2", "Index on WDDOCZ, WDDCTI, WDKCOI, WDSFX, WDMCU, WDOBJ, WDSUB, WDJBCD", new[] { "WDDOCZ", "WDDCTI", "WDKCOI", "WDSFX", "WDMCU", "WDOBJ", "WDSUB", "WDJBCD" })
    };
}
