...
/// F76A414P - .
/// </summary>
public class F76A414P : JdeTable
{
    /// <summary>
    ...
    /// <inheritdoc />
    public override string TableName => "F76A414P";
    ...
    {
        new JdeIndex("F76A414P_0", "Primary Key on V1PYID, V1RC5", new[] { "V1PYID", "V1RC5" }, isUnique: true, isPrimaryKey: true)
    };
}
