...
public class F76A18P : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F76A18P";
    ...
    {
        new JdeIndex("F76A18P_0", "Primary Key on TOKCOO, TODCTO, TODOCO, TOLNID, TOATXC", new[] { "TOKCOO", "TODCTO", "TODOCO", "TOLNID", "TOATXC" }, isUnique: true, isPrimaryKey: true)
    };
}
