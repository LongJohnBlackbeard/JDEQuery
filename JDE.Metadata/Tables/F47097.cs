...
public class F47097 : JdeTable
{
    ...
    public static class Columns
    {
        ...
        /// SZRQQJ.
        /// </summary>
        public const string SZRQQJ = "SZRQQJ";
    ...
    /// <inheritdoc />
    public override string TableName => "F47097";
    ...
    public override IReadOnlyList<IJdeField> Fields { get; } = new List<IJdeField>
    {
        ...
        new JdeField("SZRQQJ", "SZRQQJ", JdeDataType.Numeric),
    ...
    {
        new JdeIndex("F47097_0", "Primary Key on SZEDOC, SZEDCT, SZEKCO, SZEDLN", new[] { "SZEDOC", "SZEDCT", "SZEKCO", "SZEDLN" }, isUnique: true, isPrimaryKey: true)
    };
}
