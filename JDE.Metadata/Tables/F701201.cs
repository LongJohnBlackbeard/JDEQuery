...
public class F701201 : JdeTable
{
    ...
    public static class Columns
    {
        ...
        /// LAK70NUMB.
        /// </summary>
        public const string LAK70NUMB = "LAK70NUMB";
    ...
    /// <inheritdoc />
    public override string TableName => "F701201";
    ...
    {
        new JdeField("LAK70NUMB", "LAK70NUMB", JdeDataType.Numeric, null, true, true),
    ...
    {
        new JdeIndex("F701201_0", "Primary Key on LALCTR, LAK70ADSTR, LAK70NUMB", new[] { "LALCTR", "LAK70ADSTR", "LAK70NUMB" }, isUnique: true, isPrimaryKey: true)
    };
}
