...
public class F4001Z : JdeTable
{
    ...
    public static class Columns
    {
        ...
        /// SYSUN.
        /// </summary>
        public const string SYSUN = "SYSUN";

        /// <summary>
        /// SYMON.
        /// </summary>
        public const string SYMON = "SYMON";

        /// <summary>
        /// SYTUE.
        /// </summary>
        public const string SYTUE = "SYTUE";

        /// <summary>
        /// SYWED.
        /// </summary>
        public const string SYWED = "SYWED";

        /// <summary>
        /// SYTHR.
        /// </summary>
        public const string SYTHR = "SYTHR";

        /// <summary>
        /// SYFRI.
        /// </summary>
        public const string SYFRI = "SYFRI";

        /// <summary>
        /// SYSAT.
        /// </summary>
        public const string SYSAT = "SYSAT";
    ...
    /// <inheritdoc />
    public override string TableName => "F4001Z";
    ...
    public override IReadOnlyList<IJdeField> Fields { get; } = new List<IJdeField>
    {
        ...
        new JdeField("SYSUN", "SYSUN", JdeDataType.String, 2),
        new JdeField("SYMON", "SYMON", JdeDataType.String, 2),
        new JdeField("SYTUE", "SYTUE", JdeDataType.String, 2),
        new JdeField("SYWED", "SYWED", JdeDataType.String, 2),
        new JdeField("SYTHR", "SYTHR", JdeDataType.String, 2),
        new JdeField("SYFRI", "SYFRI", JdeDataType.String, 2),
        new JdeField("SYSAT", "SYSAT", JdeDataType.String, 2),
    ...
    {
        new JdeIndex("F4001Z_0", "Primary Key on SYEDOC, SYEDCT, SYEKCO", new[] { "SYEDOC", "SYEDCT", "SYEKCO" }, isUnique: true, isPrimaryKey: true)
    };
}
