...
public class F40318R : JdeTable
{
    ...
    public static class Columns
    {
        ...
        /// QCREFC.
        /// </summary>
        public const string QCREFC = "QCREFC";
        ...
        /// QCUK01.
        /// </summary>
        public const string QCUK01 = "QCUK01";
    ...
    /// <inheritdoc />
    public override string TableName => "F40318R";
    ...
    {
        new JdeField("QCUKID", "QCUKID", JdeDataType.Numeric, null, true, true),
        new JdeField("QCREFC", "QCREFC", JdeDataType.Numeric),
        new JdeField("QCAN8", "QCAN8", JdeDataType.Numeric),
        new JdeField("QCCS18", "QCCS18", JdeDataType.String, 16),
        new JdeField("QCITM", "QCITM", JdeDataType.Numeric),
        new JdeField("QCIT18", "QCIT18", JdeDataType.String, 16),
        new JdeField("QCEFTJ", "QCEFTJ", JdeDataType.Numeric),
        new JdeField("QCEXDJ", "QCEXDJ", JdeDataType.Numeric),
        ...
        new JdeField("QCSTAW", "QCSTAW", JdeDataType.String, 2),
        ...
        new JdeField("QCEFFT", "QCEFFT", JdeDataType.Numeric),
        new JdeField("QCQTSN", "QCQTSN", JdeDataType.Numeric),
        new JdeField("QCMCU", "QCMCU", JdeDataType.String, 24),
        new JdeField("QCTSRT", "QCTSRT", JdeDataType.Numeric),
        ...
        new JdeField("QCUK01", "QCUK01", JdeDataType.Numeric),
    ...
    {
        new JdeIndex("F40318R_0", "Primary Key on QCUKID", new[] { "QCUKID" }, isUnique: true, isPrimaryKey: true),
        new JdeIndex("F40318R_2", "Index on QCAN8, QCCS18, QCITM, QCIT18, QCEXDJ, QCMCU, QCEFFT, QCUPMJ, QCTDAY", new[] { "QCAN8", "QCCS18", "QCITM", "QCIT18", "QCEXDJ", "QCMCU", "QCEFFT", "QCUPMJ", "QCTDAY" })
    };
}
