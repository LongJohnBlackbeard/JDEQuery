...
/// F75T005P - .
/// </summary>
public class F75T005P : JdeTable
{
    /// <summary>
    ...
    /// <inheritdoc />
    public override string TableName => "F75T005P";
    ...
    {
        new JdeIndex("F75T005P_0", "Primary Key on TD75TTNF, TD75TRAS, TD75TLID, TD75TVTT, TD75TYMH", new[] { "TD75TTNF", "TD75TRAS", "TD75TLID", "TD75TVTT", "TD75TYMH" }, isUnique: true, isPrimaryKey: true)
    };
}
