...
public class F76A09P : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F76A09P";
    ...
    {
        new JdeIndex("F76A09P_0", "Primary Key on TTDOC, TTDCT, TTKCO, TTDCTM, TTDOCM", new[] { "TTDOC", "TTDCT", "TTKCO", "TTDCTM", "TTDOCM" }, isUnique: true, isPrimaryKey: true)
    };
}
