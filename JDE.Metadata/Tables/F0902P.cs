...
public class F0902P : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F0902P";
    ...
    {
        new JdeIndex("F0902P_0", "Primary Key on GBAID, GBCTRY, GBFY, GBFQ, GBLT, GBSBL, GBSBLT, GBCRCD", new[] { "GBAID", "GBCTRY", "GBFY", "GBFQ", "GBLT", "GBSBL", "GBSBLT", "GBCRCD" }, isUnique: true, isPrimaryKey: true)
    };
}
