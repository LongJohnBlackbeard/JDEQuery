...
public class F47013 : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F47013";
    ...
    {
        new JdeIndex("F47013_0", "Primary Key on SPEDOC, SPEDCT, SPEKCO, SPEDLN, SPEDSQ", new[] { "SPEDOC", "SPEDCT", "SPEKCO", "SPEDLN", "SPEDSQ" }, isUnique: true, isPrimaryKey: true)
    };
}
