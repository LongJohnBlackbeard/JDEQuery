...
public class F47012 : JdeTable
{
    ...
    public static class Columns
    {
        ...
        /// SZCFGFL.
        /// </summary>
        public const string SZCFGFL = "SZCFGFL";
        ...
        /// SZGVEND.
        /// </summary>
        public const string SZGVEND = "SZGVEND";
    ...
    /// <inheritdoc />
    public override string TableName => "F47012";
    ...
    public override IReadOnlyList<IJdeField> Fields { get; } = new List<IJdeField>
    {
        ...
        new JdeField("SZCFGFL", "SZCFGFL", JdeDataType.String, 2),
        ...
        new JdeField("SZGVEND", "SZGVEND", JdeDataType.Numeric),
    ...
    {
        new JdeIndex("F47012_0", "Primary Key on SZEDOC, SZEDCT, SZEKCO, SZEDLN", new[] { "SZEDOC", "SZEDCT", "SZEKCO", "SZEDLN" }, isUnique: true, isPrimaryKey: true),
        new JdeIndex("F47012_2", "Index on SZEKCO, SZEDCT, SZEDBT", new[] { "SZEKCO", "SZEDCT", "SZEDBT" }),
        new JdeIndex("F47012_3", "Index on SZEKCO, SZEDCT, SZEDOC", new[] { "SZEKCO", "SZEDCT", "SZEDOC" })
    };
}
