...
public class F0411 : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F0411";
    ...
    {
        new JdeIndex("F0411_0", "Primary Key on RPDOC, RPDCT, RPKCO, RPSFX, RPSFXE", new[] { "RPDOC", "RPDCT", "RPKCO", "RPSFX", "RPSFXE" }, isUnique: true, isPrimaryKey: true),
        new JdeIndex("F0411_10", "Index on RPSNTO, RPAN8, SYS_NC00149$", new[] { "RPSNTO", "RPAN8", "SYS_NC00149$" }),
        new JdeIndex("F0411_11", "Index on RPPYE, RPDCT, RPDOC, RPKCO, RPSFX, RPSFXE", new[] { "RPPYE", "RPDCT", "RPDOC", "RPKCO", "RPSFX", "RPSFXE" }),
        new JdeIndex("F0411_12", "Index on RPPWPG, RPAN8, RPPST", new[] { "RPPWPG", "RPAN8", "RPPST" }),
        new JdeIndex("F0411_13", "Index on RPNETTCID, RPNETDOC, RPNETRC5", new[] { "RPNETTCID", "RPNETDOC", "RPNETRC5" }),
        new JdeIndex("F0411_14", "Index on RPNETTCID, RPNETDOC, RPNETRC5, RPVOD", new[] { "RPNETTCID", "RPNETDOC", "RPNETRC5", "RPVOD" }),
        new JdeIndex("F0411_15", "Index on RPCNTRTID, RPWVID, RPPYE, RPSEQN, RPRP1", new[] { "RPCNTRTID", "RPWVID", "RPPYE", "RPSEQN", "RPRP1" }),
        new JdeIndex("F0411_2", "Index on RPDOC, RPDCT, RPKCO", new[] { "RPDOC", "RPDCT", "RPKCO" }),
        new JdeIndex("F0411_3", "Index on RPICUT, RPICU, RPKCO, RPDCT, RPDOC, RPCO, RPGLC", new[] { "RPICUT", "RPICU", "RPKCO", "RPDCT", "RPDOC", "RPCO", "RPGLC" }),
        new JdeIndex("F0411_4", "Index on RPICUT, RPICU, RPCO, RPGLC, RPPN, RPFY, RPCTRY", new[] { "RPICUT", "RPICU", "RPCO", "RPGLC", "RPPN", "RPFY", "RPCTRY" }),
        new JdeIndex("F0411_5", "Index on RPICU, RPICUT, RPPOST", new[] { "RPICU", "RPICUT", "RPPOST" }),
        new JdeIndex("F0411_6", "Index on RPAN8, RPVINV, SYS_NC00148$", new[] { "RPAN8", "RPVINV", "SYS_NC00148$" }),
        new JdeIndex("F0411_7", "Index on RPAN8, RPDDJ, RPDCT, RPDOC, RPKCO, RPSFX, RPSFXE", new[] { "RPAN8", "RPDDJ", "RPDCT", "RPDOC", "RPKCO", "RPSFX", "RPSFXE" }),
        new JdeIndex("F0411_8", "Index on RPAN8, RPDCT, RPDOC, RPKCO, RPSFX, RPSFXE", new[] { "RPAN8", "RPDCT", "RPDOC", "RPKCO", "RPSFX", "RPSFXE" }),
        new JdeIndex("F0411_9", "Index on RPAN8, RPPO, RPPDCT, RPPKCO, RPDOC, RPDCT, RPKCO", new[] { "RPAN8", "RPPO", "RPPDCT", "RPPKCO", "RPDOC", "RPDCT", "RPKCO" })
    };
}
