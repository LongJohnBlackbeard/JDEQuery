...
public class FCW15 : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "FCW15";
    ...
    {
        new JdeIndex("FCW15_0", "Primary Key on WFITM, WFEV01, WFMMCU", new[] { "WFITM", "WFEV01", "WFMMCU" }, isUnique: true, isPrimaryKey: true)
    };
}
