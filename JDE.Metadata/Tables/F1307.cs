...
public class F1307 : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F1307";
    ...
    {
        new JdeIndex("F1307_0", "Primary Key on F1TREC, F1NUMR, F1EFTB, F1BEGT, F1EWST, F1DOCO", new[] { "F1TREC", "F1NUMR", "F1EFTB", "F1BEGT", "F1EWST", "F1DOCO" }, isUnique: true, isPrimaryKey: true),
        new JdeIndex("F1307_2", "Index on F1EWST, F1TREC, F1NUMR, F1EFTB, F1BEGT", new[] { "F1EWST", "F1TREC", "F1NUMR", "F1EFTB", "F1BEGT" }),
        new JdeIndex("F1307_3", "Index on F1TREC, F1DOCO, SYS_NC00023$, SYS_NC00024$", new[] { "F1TREC", "F1DOCO", "SYS_NC00023$", "SYS_NC00024$" }),
        new JdeIndex("F1307_4", "Index on F1EWST, F1TREC, F1DOCO, F1EFTB, F1BEGT", new[] { "F1EWST", "F1TREC", "F1DOCO", "F1EFTB", "F1BEGT" })
    };
}
