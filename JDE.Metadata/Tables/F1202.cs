...
public class F1202 : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F1202";
    ...
    {
        new JdeIndex("F1202_0", "Primary Key on FLAID, FLCTRY, FLFY, FLFQ, FLNUMB, FLSBL, FLSBLT, FLLT", new[] { "FLAID", "FLCTRY", "FLFY", "FLFQ", "FLNUMB", "FLSBL", "FLSBLT", "FLLT" }, isUnique: true, isPrimaryKey: true),
        new JdeIndex("F1202_2", "Index on FLNUMB, FLCTRY, FLFY, FLLT, FLOBJ, FLFQ, FLSUB", new[] { "FLNUMB", "FLCTRY", "FLFY", "FLLT", "FLOBJ", "FLFQ", "FLSUB" }),
        new JdeIndex("F1202_3", "Index on FLNUMB, FLCTRY, FLFY, FLFQ, FLLT, FLSUB, FLOBJ", new[] { "FLNUMB", "FLCTRY", "FLFY", "FLFQ", "FLLT", "FLSUB", "FLOBJ" }),
        new JdeIndex("F1202_4", "Index on FLNUMB, FLMCU, FLOBJ, FLSUB, FLLT, FLCTRY, FLFY, FLFQ, FLSBL, FLSBLT", new[] { "FLNUMB", "FLMCU", "FLOBJ", "FLSUB", "FLLT", "FLCTRY", "FLFY", "FLFQ", "FLSBL", "FLSBLT" }),
        new JdeIndex("F1202_5", "Index on FLNUMB, FLLT, FLCHCD, FLCTRY, FLFY, FLSBL, FLSBLT", new[] { "FLNUMB", "FLLT", "FLCHCD", "FLCTRY", "FLFY", "FLSBL", "FLSBLT" }),
        new JdeIndex("F1202_6", "Index on FLAID, FLCTRY, FLFY, FLFQ, FLNUMB, FLLT, FLSBLT, FLSBL", new[] { "FLAID", "FLCTRY", "FLFY", "FLFQ", "FLNUMB", "FLLT", "FLSBLT", "FLSBL" }),
        new JdeIndex("F1202_8", "Index on FLMCU, FLOBJ, FLSUB, FLCTRY, FLFY", new[] { "FLMCU", "FLOBJ", "FLSUB", "FLCTRY", "FLFY" }),
        new JdeIndex("F1202_9", "Index on FLNUMB, FLLT, FLCTRY, FLFY, FLSBL, FLSBLT", new[] { "FLNUMB", "FLLT", "FLCTRY", "FLFY", "FLSBL", "FLSBLT" })
    };
}
