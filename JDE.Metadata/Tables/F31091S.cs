...
public class F31091S : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F31091S";
    ...
    {
        new JdeIndex("F31091S_0", "Primary Key on IQDOCO, IQDCTO, IQMMCU, IQITM, IQSESD, IQSHFT, IQOPSQ", new[] { "IQDOCO", "IQDCTO", "IQMMCU", "IQITM", "IQSESD", "IQSHFT", "IQOPSQ" }, isUnique: true, isPrimaryKey: true),
        new JdeIndex("F31091S_2", "Index on IQMMCU, IQLINE, IQSESD, IQSHFT, IQOPSQ, IQWR01, IQWR02, IQWR03", new[] { "IQMMCU", "IQLINE", "IQSESD", "IQSHFT", "IQOPSQ", "IQWR01", "IQWR02", "IQWR03" }),
        new JdeIndex("F31091S_3", "Index on IQMMCU, IQDOCO, IQSESD, IQSHFT", new[] { "IQMMCU", "IQDOCO", "IQSESD", "IQSHFT" }),
        new JdeIndex("F31091S_4", "Index on IQMMCU, IQLINE, IQLITM, IQDOCO, IQSESD", new[] { "IQMMCU", "IQLINE", "IQLITM", "IQDOCO", "IQSESD" }),
        new JdeIndex("F31091S_5", "Index on IQMMCU, IQLINE, IQDCTO, IQLITM, IQDOCO, IQSESD", new[] { "IQMMCU", "IQLINE", "IQDCTO", "IQLITM", "IQDOCO", "IQSESD" }),
        new JdeIndex("F31091S_6", "Index on IQMMCU, IQLINE, IQDCTO, IQLITM, IQDOCO, IQSHFT, IQSESD", new[] { "IQMMCU", "IQLINE", "IQDCTO", "IQLITM", "IQDOCO", "IQSHFT", "IQSESD" }),
        new JdeIndex("F31091S_7", "Index on IQMMCU, IQLINE, IQSHFT, IQLITM, IQDOCO, IQSESD", new[] { "IQMMCU", "IQLINE", "IQSHFT", "IQLITM", "IQDOCO", "IQSESD" }),
        new JdeIndex("F31091S_8", "Index on IQMMCU, IQLINE, IQDCTO, IQSHFT, IQLITM, IQDOCO, IQSESD", new[] { "IQMMCU", "IQLINE", "IQDCTO", "IQSHFT", "IQLITM", "IQDOCO", "IQSESD" })
    };
}
