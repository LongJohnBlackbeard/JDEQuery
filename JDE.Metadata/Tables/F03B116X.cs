...
/// F03B116X - .
/// </summary>
public class F03B116X : JdeTable
{
    /// <summary>
    ...
    /// <inheritdoc />
    public override string TableName => "F03B116X";
    ...
    {
        new JdeIndex("F03B116X_0", "Primary Key on ILUSER, ILUKID, ILKCO, ILDOC, ILDCT, ILDTAI", new[] { "ILUSER", "ILUKID", "ILKCO", "ILDOC", "ILDCT", "ILDTAI" }, isUnique: true, isPrimaryKey: true)
    };
}
