...
/// F75I395B - .
/// </summary>
public class F75I395B : JdeTable
{
    /// <summary>
    ...
    /// <inheritdoc />
    public override string TableName => "F75I395B";
    ...
    {
        new JdeIndex("F75I395B_0", "Primary Key on ERSTKT, ERITM, ERKIT, ERITMR, ERSTRX", new[] { "ERSTKT", "ERITM", "ERKIT", "ERITMR", "ERSTRX" }, isUnique: true, isPrimaryKey: true)
    };
}
