...
public class F078312 : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F078312";
    ...
    {
        new JdeIndex("F078312_0", "Primary Key on YFUKID", new[] { "YFUKID" }, isUnique: true, isPrimaryKey: true)
    };
}
