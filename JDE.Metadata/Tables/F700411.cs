...
public class F700411 : JdeTable
{
    ...
    public static class Columns
    {
        ...
        /// LAKCO.
        /// </summary>
        public const string LAKCO = "LAKCO";

        /// <summary>
        /// LADOC.
        /// </summary>
        public const string LADOC = "LADOC";

        /// <summary>
        /// LADCT.
        /// </summary>
        public const string LADCT = "LADCT";

        /// <summary>
        /// LASFX.
        /// </summary>
        public const string LASFX = "LASFX";

        /// <summary>
        /// LASFXE.
        /// </summary>
        public const string LASFXE = "LASFXE";
    ...
    /// <inheritdoc />
    public override string TableName => "F700411";
    ...
    {
        new JdeField("LAKCO", "LAKCO", JdeDataType.String, 10, true, true),
        new JdeField("LADOC", "LADOC", JdeDataType.Numeric, null, true, true),
        new JdeField("LADCT", "LADCT", JdeDataType.String, 4, true, true),
        new JdeField("LASFX", "LASFX", JdeDataType.String, 6, true, true),
        new JdeField("LASFXE", "LASFXE", JdeDataType.Numeric, null, true, true),
    ...
    {
        new JdeIndex("F700411_0", "Primary Key on LAKCO, LADOC, LADCT, LASFX, LASFXE, LALCTR, LAK70ADSTR", new[] { "LAKCO", "LADOC", "LADCT", "LASFX", "LASFXE", "LALCTR", "LAK70ADSTR" }, isUnique: true, isPrimaryKey: true)
    };
}
