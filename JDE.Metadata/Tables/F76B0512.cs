...
/// F76B0512 - .
/// </summary>
public class F76B0512 : JdeTable
{
    /// <summary>
    ...
    public static class Columns
    {
        ...
        /// PDB76CRTY.
        /// </summary>
        public const string PDB76CRTY = "PDB76CRTY";

        /// <summary>
        /// PDB76CRDT.
        /// </summary>
        public const string PDB76CRDT = "PDB76CRDT";
    ...
    /// <inheritdoc />
    public override string TableName => "F76B0512";
    ...
    public override IReadOnlyList<IJdeField> Fields { get; } = new List<IJdeField>
    {
        ...
        new JdeField("PDB76CRTY", "PDB76CRTY", JdeDataType.String, 2),
        new JdeField("PDB76CRDT", "PDB76CRDT", JdeDataType.String, 2),
    ...
    {
        new JdeIndex("F76B0512_0", "Primary Key on PDJOBS, PDB76BLCK, PDB76SBPR, PDB76BSEQ, PDB76RECD, PDUSEQ", new[] { "PDJOBS", "PDB76BLCK", "PDB76SBPR", "PDB76BSEQ", "PDB76RECD", "PDUSEQ" }, isUnique: true, isPrimaryKey: true)
    };
}
