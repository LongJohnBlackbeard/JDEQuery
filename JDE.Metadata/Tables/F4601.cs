...
public class F4601 : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F4601";
    ...
    {
        new JdeIndex("F4601_0", "Primary Key on THPTSK", new[] { "THPTSK" }, isUnique: true, isPrimaryKey: true)
    };
}
