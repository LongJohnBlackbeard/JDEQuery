...
/// F47092TX - .
/// </summary>
public class F47092TX : JdeTable
{
    /// <summary>
    ...
    /// <inheritdoc />
    public override string TableName => "F47092TX";
    ...
    {
        new JdeIndex("F47092TX_0", "Primary Key on DTEDOC, DTEDCT, DTEKCO, DTEDLN", new[] { "DTEDOC", "DTEDCT", "DTEKCO", "DTEDLN" }, isUnique: true, isPrimaryKey: true)
    };
}
