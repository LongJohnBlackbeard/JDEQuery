...
/// F05153WF - .
/// </summary>
public class F05153WF : JdeTable
{
    /// <summary>
    ...
    /// <inheritdoc />
    public override string TableName => "F05153WF";
    ...
    {
        new JdeIndex("F05153WF_0", "Primary Key on WFJOBS, WFAN8, WFCMPE, WFCMPC", new[] { "WFJOBS", "WFAN8", "WFCMPE", "WFCMPC" }, isUnique: true, isPrimaryKey: true)
    };
}
