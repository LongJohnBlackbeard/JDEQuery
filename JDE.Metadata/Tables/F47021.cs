...
public class F47021 : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F47021";
    ...
    {
        new JdeIndex("F47021_0", "Primary Key on SYEDOC, SYEDCT, SYEKCO", new[] { "SYEDOC", "SYEDCT", "SYEKCO" }, isUnique: true, isPrimaryKey: true)
    };
}
