...
public class F79A42 : JdeTable
{
    ...
    public static class Columns
    {
        ...
        /// KPACTN.
        /// </summary>
        public const string KPACTN = "KPACTN";
    ...
    /// <inheritdoc />
    public override string TableName => "F79A42";
    ...
    public override IReadOnlyList<IJdeField> Fields { get; } = new List<IJdeField>
    {
        ...
        new JdeField("KPACTN", "KPACTN", JdeDataType.String, 2, true, true),
        ...
        new JdeField("KPUPMJ", "KPUPMJ", JdeDataType.Numeric, null, true, true),
        new JdeField("KPTDAY", "KPTDAY", JdeDataType.Numeric, null, true, true)
    };

    /// <inheritdoc />
    public override IReadOnlyList<IJdeIndex> Indexes { get; } = new List<IJdeIndex>
    {
        new JdeIndex("F79A42_0", "Primary Key on KP79AGKPID, KPUPMJ, KPTDAY, KPACTN", new[] { "KP79AGKPID", "KPUPMJ", "KPTDAY", "KPACTN" }, isUnique: true, isPrimaryKey: true),
        new JdeIndex("F79A42_2", "Unique Index on KP79AGKPCD, KPUPMJ, KPTDAY, KPACTN", new[] { "KP79AGKPCD", "KPUPMJ", "KPTDAY", "KPACTN" }, isUnique: true)
    };
}
