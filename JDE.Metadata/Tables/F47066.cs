...
public class F47066 : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F47066";
    ...
    {
        new JdeIndex("F47066_0", "Primary Key on MJEDOC, MJEDCT, MJEKCO", new[] { "MJEDOC", "MJEDCT", "MJEKCO" }, isUnique: true, isPrimaryKey: true)
    };
}
