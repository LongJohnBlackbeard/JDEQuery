...
public class F76A23P : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F76A23P";
    ...
    {
        new JdeIndex("F76A23P_0", "Primary Key on IWKCO, IWDCT, IWDOC, IWPNO, IWLNID", new[] { "IWKCO", "IWDCT", "IWDOC", "IWPNO", "IWLNID" }, isUnique: true, isPrimaryKey: true)
    };
}
