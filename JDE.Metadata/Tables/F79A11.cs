...
public class F79A11 : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F79A11";
    ...
    {
        new JdeIndex("F79A11_0", "Primary Key on GRUKID", new[] { "GRUKID" }, isUnique: true, isPrimaryKey: true),
        new JdeIndex("F79A11_10", "Index on GR79AGESID, GR79AGCUM, GRITM, GRMCU", new[] { "GR79AGESID", "GR79AGCUM", "GRITM", "GRMCU" }),
        new JdeIndex("F79A11_11", "Index on GRMMCU, GRITM, GR79AGESID, GR79AGCUM", new[] { "GRMMCU", "GRITM", "GR79AGESID", "GR79AGCUM" }),
        new JdeIndex("F79A11_12", "Index on GRKCO, GRDOC, GRDCT, GRSFX, GRLNID", new[] { "GRKCO", "GRDOC", "GRDCT", "GRSFX", "GRLNID" }),
        new JdeIndex("F79A11_13", "Index on GRAN8, GR79ADGHG, GR79AGESID, GR79AEMSC, GRRE", new[] { "GRAN8", "GR79ADGHG", "GR79AGESID", "GR79AEMSC", "GRRE" }),
        new JdeIndex("F79A11_14", "Index on GRMMCU, GR79ADGHG, GR79AGESID, GR79AEMSC, GRRE", new[] { "GRMMCU", "GR79ADGHG", "GR79AGESID", "GR79AEMSC", "GRRE" }),
        new JdeIndex("F79A11_15", "Index on GRAN8, GRMMCU, GR79ADGHG, GR79AGESID, GR79AEMSC, GRRE", new[] { "GRAN8", "GRMMCU", "GR79ADGHG", "GR79AGESID", "GR79AEMSC", "GRRE" }),
        new JdeIndex("F79A11_16", "Index on GR79AGESID, GRRE", new[] { "GR79AGESID", "GRRE" }),
        new JdeIndex("F79A11_2", "Index on GRKCO, GRDCT, GRDOC, GRSFX, GRSFXE, GRLNID, GR79ADGHG", new[] { "GRKCO", "GRDCT", "GRDOC", "GRSFX", "GRSFXE", "GRLNID", "GR79ADGHG" }),
        new JdeIndex("F79A11_3", "Index on GRCTR, GRADDS, GRCOUN", new[] { "GRCTR", "GRADDS", "GRCOUN" }),
        new JdeIndex("F79A11_4", "Index on GRASII", new[] { "GRASII" }),
        new JdeIndex("F79A11_5", "Index on GRMMCU, GR79ADGHG, GRRE", new[] { "GRMMCU", "GR79ADGHG", "GRRE" }),
        new JdeIndex("F79A11_6", "Index on GR79AGESID, GR79AEMSC, GR79ADGHG, GRRE", new[] { "GR79AGESID", "GR79AEMSC", "GR79ADGHG", "GRRE" }),
        new JdeIndex("F79A11_7", "Index on GR79ASRC, GR79AEMSC, GR79ADGHG", new[] { "GR79ASRC", "GR79AEMSC", "GR79ADGHG" }),
        new JdeIndex("F79A11_8", "Index on GRMCU, GR79ADGHG", new[] { "GRMCU", "GR79ADGHG" }),
        new JdeIndex("F79A11_9", "Index on GR79AGBNO", new[] { "GR79AGBNO" })
    };
}
