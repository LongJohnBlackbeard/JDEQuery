...
public class F40312R : JdeTable
{
    ...
    public static class Columns
    {
        ...
        /// P2UKID.
        /// </summary>
        public const string P2UKID = "P2UKID";

        /// <summary>
        /// P2REFC.
        /// </summary>
        public const string P2REFC = "P2REFC";
    ...
    /// <inheritdoc />
    public override string TableName => "F40312R";
    ...
    {
        new JdeField("P2UKID", "P2UKID", JdeDataType.Numeric, null, true, true),
        new JdeField("P2REFC", "P2REFC", JdeDataType.Numeric),
        new JdeField("P2AN8", "P2AN8", JdeDataType.Numeric),
        new JdeField("P2CS12", "P2CS12", JdeDataType.String, 16),
        new JdeField("P2ITM", "P2ITM", JdeDataType.Numeric),
        new JdeField("P2IT12", "P2IT12", JdeDataType.String, 16),
        new JdeField("P2EFTJ", "P2EFTJ", JdeDataType.Numeric),
        new JdeField("P2EXDJ", "P2EXDJ", JdeDataType.Numeric),
        new JdeField("P2MNQ", "P2MNQ", JdeDataType.Numeric),
        new JdeField("P2MXQ", "P2MXQ", JdeDataType.Numeric),
        new JdeField("P2UOM", "P2UOM", JdeDataType.String, 4),
    ...
    {
        new JdeIndex("F40312R_0", "Primary Key on P2UKID", new[] { "P2UKID" }, isUnique: true, isPrimaryKey: true),
        new JdeIndex("F40312R_2", "Index on P2AN8, P2CS12, P2ITM, P2IT12, P2EXDJ, P2MXQ, P2UOM, P2UPC2, P2UPMJ, P2TDAY", new[] { "P2AN8", "P2CS12", "P2ITM", "P2IT12", "P2EXDJ", "P2MXQ", "P2UOM", "P2UPC2", "P2UPMJ", "P2TDAY" })
    };
}
