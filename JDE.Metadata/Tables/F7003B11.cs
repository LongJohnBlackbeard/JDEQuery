...
/// F7003B11 - .
/// </summary>
public class F7003B11 : JdeTable
{
    /// <summary>
    ...
    /// <inheritdoc />
    public override string TableName => "F7003B11";
    ...
    {
        new JdeIndex("F7003B11_0", "Primary Key on LADOC, LADCT, LAKCO, LASFX, LALCTR, LAK70ADSTR", new[] { "LADOC", "LADCT", "LAKCO", "LASFX", "LALCTR", "LAK70ADSTR" }, isUnique: true, isPrimaryKey: true)
    };
}
