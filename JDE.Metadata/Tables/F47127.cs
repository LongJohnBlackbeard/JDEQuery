...
public class F47127 : JdeTable
{
    ...
    public static class Columns
    {
        ...
        /// MJCTWT.
        /// </summary>
        public const string MJCTWT = "MJCTWT";

        /// <summary>
        /// MJCWUM.
        /// </summary>
        public const string MJCWUM = "MJCWUM";
    ...
    /// <inheritdoc />
    public override string TableName => "F47127";
    ...
    public override IReadOnlyList<IJdeField> Fields { get; } = new List<IJdeField>
    {
        ...
        new JdeField("MJCTWT", "MJCTWT", JdeDataType.Numeric),
        new JdeField("MJCWUM", "MJCWUM", JdeDataType.String, 4),
    ...
    {
        new JdeIndex("F47127_0", "Primary Key on MJEDOC, MJEDCT, MJEKCO, MJEDLN", new[] { "MJEDOC", "MJEDCT", "MJEKCO", "MJEDLN" }, isUnique: true, isPrimaryKey: true)
    };
}
