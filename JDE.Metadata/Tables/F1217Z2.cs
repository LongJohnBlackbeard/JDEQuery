...
public class F1217Z2 : JdeTable
{
    ...
    public static class Columns
    {
        ...
        /// WRLATT.
        /// </summary>
        public const string WRLATT = "WRLATT";

        /// <summary>
        /// WRLONG.
        /// </summary>
        public const string WRLONG = "WRLONG";
    }

    /// <inheritdoc />
    public override string TableName => "F1217Z2";
    ...
    public override IReadOnlyList<IJdeField> Fields { get; } = new List<IJdeField>
    {
        ...
        new JdeField("WRLATT", "WRLATT", JdeDataType.String, 50),
        new JdeField("WRLONG", "WRLONG", JdeDataType.String, 50)
    };

    /// <inheritdoc />
    public override IReadOnlyList<IJdeIndex> Indexes { get; } = new List<IJdeIndex>
    {
        new JdeIndex("F1217Z2_0", "Primary Key on WREDUS, WREDBT, WREDTN, WREDLN", new[] { "WREDUS", "WREDBT", "WREDTN", "WREDLN" }, isUnique: true, isPrimaryKey: true)
    };
}
