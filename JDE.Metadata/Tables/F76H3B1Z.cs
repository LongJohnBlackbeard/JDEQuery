...
/// F76H3B1Z - .
/// </summary>
public class F76H3B1Z : JdeTable
{
    /// <summary>
    ...
    /// <inheritdoc />
    public override string TableName => "F76H3B1Z";
    ...
    {
        new JdeField("ZTEDUS", "ZTEDUS", JdeDataType.String, 20, true, true),
        new JdeField("ZTEDTN", "ZTEDTN", JdeDataType.String, 44, true, true),
        new JdeField("ZTEDBT", "ZTEDBT", JdeDataType.String, 30, true, true),
    ...
    {
        new JdeIndex("F76H3B1Z_0", "Primary Key on ZTEDUS, ZTEDTN, ZTEDBT", new[] { "ZTEDUS", "ZTEDTN", "ZTEDBT" }, isUnique: true, isPrimaryKey: true)
    };
}
