...
public class F39064 : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F39064";
    ...
    {
        new JdeIndex("F39064_0", "Primary Key on DSCRCD, DSSVYR, DSPNC, DSDCT, DSITPL, DSITM, DSCO, DSMCU, DSTNTP", new[] { "DSCRCD", "DSSVYR", "DSPNC", "DSDCT", "DSITPL", "DSITM", "DSCO", "DSMCU", "DSTNTP" }, isUnique: true, isPrimaryKey: true),
        new JdeIndex("F39064_2", "Index on DSSVYR, DSPNC, DSITPL, DSITM, DSCO, DSMCU, DSDCT, DSTNTP", new[] { "DSSVYR", "DSPNC", "DSITPL", "DSITM", "DSCO", "DSMCU", "DSDCT", "DSTNTP" })
    };
}
