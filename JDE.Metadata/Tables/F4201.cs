...
public class F4201 : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F4201";
    ...
    {
        new JdeIndex("F4201_0", "Primary Key on SHDOCO, SHDCTO, SHKCOO", new[] { "SHDOCO", "SHDCTO", "SHKCOO" }, isUnique: true, isPrimaryKey: true),
        new JdeIndex("F4201_10", "Index on SHAN8, SYS_NC00134$, SYS_NC00135$", new[] { "SHAN8", "SYS_NC00134$", "SYS_NC00135$" }),
        new JdeIndex("F4201_11", "Index on SHDOCO, SHDCTO", new[] { "SHDOCO", "SHDCTO" }),
        new JdeIndex("F4201_2", "Index on SHVR01, SHAN8", new[] { "SHVR01", "SHAN8" }),
        new JdeIndex("F4201_3", "Index on SHOPPID, SHOTIND", new[] { "SHOPPID", "SHOTIND" }),
        new JdeIndex("F4201_4", "Index on SHAN8, SHOTIND, SHCCIDLN", new[] { "SHAN8", "SHOTIND", "SHCCIDLN" }),
        new JdeIndex("F4201_5", "Index on SHSHAN, SHOTIND, SHSHCCIDLN", new[] { "SHSHAN", "SHOTIND", "SHSHCCIDLN" }),
        new JdeIndex("F4201_6", "Index on SHCO, SHAN8, SHOTIND", new[] { "SHCO", "SHAN8", "SHOTIND" }),
        new JdeIndex("F4201_7", "Index on SHCO, SHSHAN, SHOTIND", new[] { "SHCO", "SHSHAN", "SHOTIND" }),
        new JdeIndex("F4201_8", "Index on SHKCOO", new[] { "SHKCOO" }),
        new JdeIndex("F4201_9", "Index on SHDCTO", new[] { "SHDCTO" })
    };
}
