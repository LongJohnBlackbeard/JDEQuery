...
public class F3111S : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F3111S";
    ...
    {
        new JdeIndex("F3111S_0", "Primary Key on WMUKID", new[] { "WMUKID" }, isUnique: true, isPrimaryKey: true)
    };
}
