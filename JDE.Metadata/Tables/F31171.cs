...
public class F31171 : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F31171";
    ...
    {
        new JdeIndex("F31171_0", "Primary Key on WSUKID", new[] { "WSUKID" }, isUnique: true, isPrimaryKey: true)
    };
}
