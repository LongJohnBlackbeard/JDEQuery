...
public class F76A21 : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F76A21";
    ...
    {
        new JdeIndex("F76A21_0", "Primary Key on IHKCO, IHDCT, IHDOC", new[] { "IHKCO", "IHDCT", "IHDOC" }, isUnique: true, isPrimaryKey: true)
    };
}
