...
public class F06136 : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F06136";
    ...
    public override IReadOnlyList<IJdeField> Fields { get; } = new List<IJdeField>
    {
        ...
        new JdeField("YZWST", "YZWST", JdeDataType.Numeric),
        new JdeField("YZWCNT", "YZWCNT", JdeDataType.Numeric),
        new JdeField("YZWCTY", "YZWCTY", JdeDataType.Numeric),
    ...
    {
        new JdeIndex("F06136_0", "Primary Key on YZAN8, YZTHTY, YZTARA, YZPTAX, YZDTEY, YZTAXX, YZHMCO", new[] { "YZAN8", "YZTHTY", "YZTARA", "YZPTAX", "YZDTEY", "YZTAXX", "YZHMCO" }, isUnique: true, isPrimaryKey: true),
        new JdeIndex("F06136_10", "Index on YZAN8, YZTARA, YZPTAX, YZDTEY, YZTAXX, YZHMCO", new[] { "YZAN8", "YZTARA", "YZPTAX", "YZDTEY", "YZTAXX", "YZHMCO" }),
        new JdeIndex("F06136_11", "Index on YZDTEY, YZHMCO, YZTARA, YZPTAX, YZAN8", new[] { "YZDTEY", "YZHMCO", "YZTARA", "YZPTAX", "YZAN8" }),
        new JdeIndex("F06136_12", "Index on YZAN8, YZTHTY, YZDTEY, YZHMCO, YZTAXX, YZTARA, YZPTAX", new[] { "YZAN8", "YZTHTY", "YZDTEY", "YZHMCO", "YZTAXX", "YZTARA", "YZPTAX" }),
        new JdeIndex("F06136_13", "Index on YZDTEY, YZTHTY, YZHMCO, YZAN8", new[] { "YZDTEY", "YZTHTY", "YZHMCO", "YZAN8" }),
        new JdeIndex("F06136_2", "Index on YZAN8, YZDTEY, YZTHTY, YZTAXX, YZPTAX", new[] { "YZAN8", "YZDTEY", "YZTHTY", "YZTAXX", "YZPTAX" }),
        new JdeIndex("F06136_3", "Index on YZDTEY, YZHMCO, YZTHTY, YZTARA, YZTAXX, YZAN8", new[] { "YZDTEY", "YZHMCO", "YZTHTY", "YZTARA", "YZTAXX", "YZAN8" }),
        new JdeIndex("F06136_4", "Index on YZAN8, YZDTEY, YZPTAX", new[] { "YZAN8", "YZDTEY", "YZPTAX" }),
        new JdeIndex("F06136_5", "Index on YZAN8, YZDTEY, YZTHTY, YZTARA, YZPTAX, YZHMCO", new[] { "YZAN8", "YZDTEY", "YZTHTY", "YZTARA", "YZPTAX", "YZHMCO" }),
        new JdeIndex("F06136_6", "Index on YZDTEY, YZTHTY, YZTARA, YZPTAX, YZAN8", new[] { "YZDTEY", "YZTHTY", "YZTARA", "YZPTAX", "YZAN8" }),
        new JdeIndex("F06136_7", "Index on YZDTEY, YZHMCO, YZTAXX, YZTHTY, YZPTAX", new[] { "YZDTEY", "YZHMCO", "YZTAXX", "YZTHTY", "YZPTAX" }),
        new JdeIndex("F06136_8", "Index on YZDTEY, YZTAXX, YZTHTY, YZPTAX, YZAN8", new[] { "YZDTEY", "YZTAXX", "YZTHTY", "YZPTAX", "YZAN8" }),
        new JdeIndex("F06136_9", "Index on YZDTEY, YZCTRY, YZTARA, YZPTAX, YZTAXX", new[] { "YZDTEY", "YZCTRY", "YZTARA", "YZPTAX", "YZTAXX" })
    };
}
