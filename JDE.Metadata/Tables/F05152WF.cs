...
/// F05152WF - .
/// </summary>
public class F05152WF : JdeTable
{
    /// <summary>
    ...
    public static class Columns
    {
        ...
        /// WFRELVANCE.
        /// </summary>
        public const string WFRELVANCE = "WFRELVANCE";
    ...
    /// <inheritdoc />
    public override string TableName => "F05152WF";
    ...
    public override IReadOnlyList<IJdeField> Fields { get; } = new List<IJdeField>
    {
        ...
        new JdeField("WFRELVANCE", "WFRELVANCE", JdeDataType.Numeric),
    ...
    {
        new JdeIndex("F05152WF_0", "Primary Key on WFJOBS, WFAN8", new[] { "WFJOBS", "WFAN8" }, isUnique: true, isPrimaryKey: true)
    };
}
