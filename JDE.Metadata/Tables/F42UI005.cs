...
/// F42UI005 - .
/// </summary>
public class F42UI005 : JdeTable
{
    /// <summary>
    ...
    /// <inheritdoc />
    public override string TableName => "F42UI005";
    ...
    {
        new JdeIndex("F42UI005_0", "Primary Key on SCDOCO, SCDCTO, SCKCOO, SCLNID, SCSLSP, SCCMLN, SCJOBS, SCCTID", new[] { "SCDOCO", "SCDCTO", "SCKCOO", "SCLNID", "SCSLSP", "SCCMLN", "SCJOBS", "SCCTID" }, isUnique: true, isPrimaryKey: true),
        new JdeIndex("F42UI005_2", "Index on SCKCOO, SCDOCO, SCDCTO, SCLNID", new[] { "SCKCOO", "SCDOCO", "SCDCTO", "SCLNID" })
    };
}
