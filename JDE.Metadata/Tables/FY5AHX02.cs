...
/// FY5AHX02 - .
/// </summary>
public class FY5AHX02 : JdeTable
{
    /// <summary>
    ...
    /// <inheritdoc />
    public override string TableName => "FY5AHX02";
    ...
    {
        new JdeIndex("FY5AHX02_0", "Primary Key on DIMNI, DISELN", new[] { "DIMNI", "DISELN" }, isUnique: true, isPrimaryKey: true),
        new JdeIndex("FY5AHX02_2", "Index on DIJTOE, DIMNI, DISLTY", new[] { "DIJTOE", "DIMNI", "DISLTY" }),
        new JdeIndex("FY5AHX02_3", "Index on DIMNI, DIMTOE, DISLTY", new[] { "DIMNI", "DIMTOE", "DISLTY" }),
        new JdeIndex("FY5AHX02_4", "Index on DIMNI, DISLTY", new[] { "DIMNI", "DISLTY" }),
        new JdeIndex("FY5AHX02_5", "Index on DIOPKY, DIVER, DIMNI, DISLTY", new[] { "DIOPKY", "DIVER", "DIMNI", "DISLTY" }),
        new JdeIndex("FY5AHX02_6", "Index on DIOBNM, DIVER, DIMNI, DISLTY", new[] { "DIOBNM", "DIVER", "DIMNI", "DISLTY" })
    };
}
