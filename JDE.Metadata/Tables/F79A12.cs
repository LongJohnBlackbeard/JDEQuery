...
public class F79A12 : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F79A12";
    ...
    {
        new JdeIndex("F79A12_0", "Primary Key on GRUKID, GRLNIX", new[] { "GRUKID", "GRLNIX" }, isUnique: true, isPrimaryKey: true),
        new JdeIndex("F79A12_2", "Index on GRKCO, GRDCT, GRDOC, GRSFX, GRSFXE, GR79ADGHG", new[] { "GRKCO", "GRDCT", "GRDOC", "GRSFX", "GRSFXE", "GR79ADGHG" }),
        new JdeIndex("F79A12_3", "Index on GRCTR, GRADDS, GRCOUN", new[] { "GRCTR", "GRADDS", "GRCOUN" }),
        new JdeIndex("F79A12_4", "Index on GRUPMJ, GRTDAY", new[] { "GRUPMJ", "GRTDAY" }),
        new JdeIndex("F79A12_5", "Index on GR79AGBNO", new[] { "GR79AGBNO" })
    };
}
