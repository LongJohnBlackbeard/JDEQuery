...
/// FY5AHX06 - .
/// </summary>
public class FY5AHX06 : JdeTable
{
    /// <summary>
    ...
    /// <inheritdoc />
    public override string TableName => "FY5AHX06";
    ...
    {
        new JdeIndex("FY5AHX06_0", "Primary Key on DIRLTYPE, DIFRMREL, DITHRREL, DIPARNTTSK, DICHILDTSK, DIPRSSEQ", new[] { "DIRLTYPE", "DIFRMREL", "DITHRREL", "DIPARNTTSK", "DICHILDTSK", "DIPRSSEQ" }, isUnique: true, isPrimaryKey: true),
        new JdeIndex("FY5AHX06_2", "Index on DICHILDTSK", new[] { "DICHILDTSK" }),
        new JdeIndex("FY5AHX06_3", "Index on DIRLTYPE, DIFRMREL, DITHRREL, DIPARNTTSK, DIPRSSEQ", new[] { "DIRLTYPE", "DIFRMREL", "DITHRREL", "DIPARNTTSK", "DIPRSSEQ" }),
        new JdeIndex("FY5AHX06_4", "Index on DIRLTYPE, DIPARNTTSK, DICHILDTSK, DIPRSSEQ, DIFRMREL, DITHRREL", new[] { "DIRLTYPE", "DIPARNTTSK", "DICHILDTSK", "DIPRSSEQ", "DIFRMREL", "DITHRREL" }),
        new JdeIndex("FY5AHX06_5", "Index on DIRULEID", new[] { "DIRULEID" }),
        new JdeIndex("FY5AHX06_6", "Index on DIPARNTTSK", new[] { "DIPARNTTSK" }),
        new JdeIndex("FY5AHX06_7", "Index on DIRLTYPE, DICHILDTSK, DIFRMREL, DITHRREL", new[] { "DIRLTYPE", "DICHILDTSK", "DIFRMREL", "DITHRREL" }),
        new JdeIndex("FY5AHX06_8", "Index on DIRELACTIVE, DIPARNTTSK, DICHILDTSK, DIRLTYPE, DIFRMREL, DITHRREL", new[] { "DIRELACTIVE", "DIPARNTTSK", "DICHILDTSK", "DIRLTYPE", "DIFRMREL", "DITHRREL" })
    };
}
