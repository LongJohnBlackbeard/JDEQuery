...
public class F47132T : JdeTable
{
    ...
    public static class Columns
    {
        ...
        /// UZGANS8.
        /// </summary>
        public const string UZGANS8 = "UZGANS8";
    }

    /// <inheritdoc />
    public override string TableName => "F47132T";
    ...
    public override IReadOnlyList<IJdeField> Fields { get; } = new List<IJdeField>
    {
        ...
        new JdeField("UZGANS8", "UZGANS8", JdeDataType.Numeric)
    };

    /// <inheritdoc />
    public override IReadOnlyList<IJdeIndex> Indexes { get; } = new List<IJdeIndex>
    {
        new JdeIndex("F47132T_0", "Primary Key on UZEDOC, UZEDCT, UZEKCO, UZEDLN", new[] { "UZEDOC", "UZEDCT", "UZEKCO", "UZEDLN" }, isUnique: true, isPrimaryKey: true)
    };
}
