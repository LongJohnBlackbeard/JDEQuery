...
/// F76A021P - .
/// </summary>
public class F76A021P : JdeTable
{
    /// <summary>
    ...
    /// <inheritdoc />
    public override string TableName => "F76A021P";
    ...
    {
        new JdeIndex("F76A021P_0", "Primary Key on DLJOBS, DLCTID, DLDOC, DLDCT, DLKCO, DLSEQ", new[] { "DLJOBS", "DLCTID", "DLDOC", "DLDCT", "DLKCO", "DLSEQ" }, isUnique: true, isPrimaryKey: true)
    };
}
