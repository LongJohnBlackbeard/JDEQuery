...
public class F1306 : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F1306";
    ...
    {
        new JdeIndex("F1306_0", "Primary Key on F5NUMB, F5SBL, F5SBLT", new[] { "F5NUMB", "F5SBL", "F5SBLT" }, isUnique: true, isPrimaryKey: true)
    };
}
