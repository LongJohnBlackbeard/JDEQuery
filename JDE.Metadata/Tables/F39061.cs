...
public class F39061 : JdeTable
{
    ...
    public static class Columns
    {
        ...
        /// SOINAC.
        /// </summary>
        public const string SOINAC = "SOINAC";

        /// <summary>
        /// SOITRA.
        /// </summary>
        public const string SOITRA = "SOITRA";

        /// <summary>
        /// SOINNS.
        /// </summary>
        public const string SOINNS = "SOINNS";

        /// <summary>
        /// SOCRAL.
        /// </summary>
        public const string SOCRAL = "SOCRAL";
    ...
    /// <inheritdoc />
    public override string TableName => "F39061";
    ...
    public override IReadOnlyList<IJdeField> Fields { get; } = new List<IJdeField>
    {
        ...
        new JdeField("SOINAC", "SOINAC", JdeDataType.String, 2),
        new JdeField("SOITRA", "SOITRA", JdeDataType.String, 2),
        new JdeField("SOINNS", "SOINNS", JdeDataType.String, 2),
        new JdeField("SOCRAL", "SOCRAL", JdeDataType.Numeric),
    ...
    {
        new JdeIndex("F39061_0", "Primary Key on SOCRCD, SOSVVM, SOSVYR, SOPNC, SOITPL, SOITM, SOCO, SOMCU", new[] { "SOCRCD", "SOSVVM", "SOSVYR", "SOPNC", "SOITPL", "SOITM", "SOCO", "SOMCU" }, isUnique: true, isPrimaryKey: true),
        new JdeIndex("F39061_2", "Index on SOCO, SOSVYR, SOPNC", new[] { "SOCO", "SOSVYR", "SOPNC" })
    };
}
