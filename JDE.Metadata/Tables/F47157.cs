...
public class F47157 : JdeTable
{
    ...
    public static class Columns
    {
        ...
        /// SZPUOM.
        /// </summary>
        public const string SZPUOM = "SZPUOM";

        /// <summary>
        /// SZRLQT.
        /// </summary>
        public const string SZRLQT = "SZRLQT";
    ...
    /// <inheritdoc />
    public override string TableName => "F47157";
    ...
    public override IReadOnlyList<IJdeField> Fields { get; } = new List<IJdeField>
    {
        ...
        new JdeField("SZPUOM", "SZPUOM", JdeDataType.String, 4),
        new JdeField("SZRLQT", "SZRLQT", JdeDataType.Numeric),
    ...
    {
        new JdeIndex("F47157_0", "Primary Key on SZEDOC, SZEDCT, SZEKCO, SZEDLN", new[] { "SZEDOC", "SZEDCT", "SZEKCO", "SZEDLN" }, isUnique: true, isPrimaryKey: true),
        new JdeIndex("F47157_2", "Index on SZDOCO, SZDCTO, SZKCOO, SZSFXO, SZLNID", new[] { "SZDOCO", "SZDCTO", "SZKCOO", "SZSFXO", "SZLNID" })
    };
}
