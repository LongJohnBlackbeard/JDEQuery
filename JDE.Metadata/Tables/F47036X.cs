...
public class F47036X : JdeTable
{
    ...
    /// <inheritdoc />
    public override string TableName => "F47036X";
    ...
    {
        new JdeIndex("F47036X_0", "Primary Key on STEDOC, STEDCT, STEKCO", new[] { "STEDOC", "STEDCT", "STEKCO" }, isUnique: true, isPrimaryKey: true)
    };
}
